...
ALTER TABLE "charge_usage_based_run_detailed_line" ADD COLUMN "corrects_run_id" character(26) NULL, ADD CONSTRAINT "cub_run_corrected_detailed_lines" FOREIGN KEY ("corrects_run_id") REFERENCES "charge_usage_based_runs" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
...
-- modify "charge_usage_based_run_detailed_line" table
ALTER TABLE "charge_usage_based_run_detailed_line" ADD COLUMN "pricer_reference_id" character varying;
