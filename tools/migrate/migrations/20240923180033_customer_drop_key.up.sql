...
-- atlas:nolint DS103
ALTER TABLE "customers" DROP COLUMN "key";
-- modify "customer_subjects" table
-- atlas:nolint MF103
ALTER TABLE "customer_subjects" DROP CONSTRAINT "customer_subjects_customers_subjects", ADD COLUMN "namespace" character varying NOT NULL, ADD
