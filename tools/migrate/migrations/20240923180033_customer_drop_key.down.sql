...
ALTER TABLE "customer_subjects" DROP CONSTRAINT "customer_subjects_customers_subjects", DROP COLUMN "namespace", ADD
...
-- atlas:nolint MF103
ALTER TABLE "customers" ADD COLUMN "key" character varying NOT NULL;
