...
CREATE TABLE "charge_credit_realizations" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "charge_credit_realizations_charge_standard_invoice_realizations" FOREIGN KEY ("std_realization_id") REFERENCES "charge_standard_invoice_realizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL,
...
-- create index "charge_credit_realizations_std_realization_id_key" to table: "charge_credit_realizations"
CREATE UNIQUE INDEX "charge_credit_realizations_std_realization_id_key" ON "charge_credit_realizations" ("std_realization_id");
