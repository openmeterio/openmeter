...
ALTER TABLE "billing_invoice_lines" ADD COLUMN "billing_invoice_line_standard_invoice_realizations" character(26) NULL, ADD COLUMN "charge_id" character(26) NULL;
...
-- create "charge_standard_invoice_realizations" table
CREATE TABLE "charge_standard_invoice_realizations" (
  "id" character(26) NOT NULL,
  "namespace" character varying NOT NULL,
...
-- create index "chargestandardinvoicerealization_annotations" to table: "charge_standard_invoice_realizations"
CREATE INDEX "chargestandardinvoicerealization_annotations" ON "charge_standard_invoice_realizations" USING gin ("annotations");
-- create index "chargestandardinvoicerealization_id" to table: "charge_standard_invoice_realizations"
CREATE UNIQUE INDEX "chargestandardinvoicerealization_id" ON "charge_standard_invoice_realizations" ("id");
-- create index "chargestandardinvoicerealization_namespace" to table: "charge_standard_invoice_realizations"
CREATE INDEX "chargestandardinvoicerealization_namespace" ON "charge_standard_invoice_realizations" ("namespace");
-- create index "chargestandardinvoicerealization_namespace_charge_id_line_id" to table: "charge_standard_invoice_realizations"
CREATE UNIQUE INDEX "chargestandardinvoicerealization_namespace_charge_id_line_id" ON "charge_standard_invoice_realizations" ("namespace", "charge_id", "line_id");
...
-- modify "billing_invoice_lines" table
ALTER TABLE "billing_invoice_lines" ADD CONSTRAINT "billing_invoice_lines_charge_standard_invoice_realizations_stan" FOREIGN KEY ("billing_invoice_line_standard_invoice_realizations") REFERENCES "charge_standard_invoice_realizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "billing_invoice_lines_charges_billing_invoice_lines" FOREIGN KEY ("charge_id") REFERENCES "charges" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
-- modify "billing_invoice_split_line_groups" table
...
-- modify "charge_standard_invoice_realizations" table
ALTER TABLE "charge_standard_invoice_realizations" ADD CONSTRAINT "charge_standard_invoice_realizations_billing_invoice_lines_bill" FOREIGN KEY ("line_id") REFERENCES "billing_invoice_lines" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, ADD CONSTRAINT "charge_standard_invoice_realizations_charges_standard_invoice_r" FOREIGN KEY ("charge_id") REFERENCES "charges" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;
