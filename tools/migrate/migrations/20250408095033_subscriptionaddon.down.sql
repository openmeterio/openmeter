...
-- reverse: create index "subscriptionaddonratecard_namespace_key_deleted_at" to table: "subscription_addon_rate_cards"
DROP INDEX "subscriptionaddonratecard_namespace_key_deleted_at";
