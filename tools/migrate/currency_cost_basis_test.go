...
func TestCurrencyCostBasisEffectiveToMigrationPreservesRows(t *testing.T) {
	...
	up := readMigration(t, "20260626133809_add_currency_cost_basis_effective_to.up.sql")
	...
	down := readMigration(t, "20260626133809_add_currency_cost_basis_effective_to.down.sql")
