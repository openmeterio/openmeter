...
type CreditEntryFunc func(context.Context, *db.CreditEntryMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f CreditEntryFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.CreditEntryMutation); ok {
		return f(ctx, mv)
	}
