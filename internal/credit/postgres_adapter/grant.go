...
import (
	...
	"github.com/openmeterio/openmeter/internal/credit/postgres_adapter/ent/db"
	db_grant "github.com/openmeterio/openmeter/internal/credit/postgres_adapter/ent/db/grant"
...
func (g *grantDBADapter) VoidGrant(ctx context.Context, grantID credit.NamespacedGrantID) error {
	// TODO: transaction and locking
...
func (g *grantDBADapter) GetGrant(ctx context.Context, grantID credit.NamespacedGrantID) (credit.Grant, error) {
