...
export class OpenMeter {
    ...
    public async ingestEvents(event: components['schemas']['Event'], opts?: RequestInit) {
    ...
    public async getMetersById(path: operations["getMetersById"]["parameters"]["path"], opts?: RequestInit) {
    ...
    public async getValuesByMeterId(path: operations["getValuesByMeterId"]["parameters"]["path"], query: operations["getValuesByMeterId"]["parameters"]["query"], opts?: RequestInit) {
