...
func (s SubscriptionSpec) MaterializeRateCardCurrencies(defaultCurrency currencies.CurrencyReference) error {
...
func (s *SubscriptionItemSpec) MaterializeRateCardCurrency(defaultCurrency currencies.CurrencyReference) error {
	if s.RateCard == nil {
	...
	return s.RateCard.ChangeMeta(func(meta productcatalog.RateCardMeta) (productcatalog.RateCardMeta, error) {
		meta.Currency = lo.ToPtr(defaultCurrency.Clone())
		return meta, nil
	})
}
...
func (s *SubscriptionSpec) Apply(applies AppliesToSpec, context ApplyContext) error {
	...
	if err := s.MaterializeRateCardCurrencies(currencies.NewCurrencyReference(s.InvoiceCurrency)); err != nil {
