...
func materializeAddonRateCardCurrency(item *subscription.SubscriptionItemSpec, addonCurrency currencies.CurrencyReference, subscriptionCurrency currencyx.Code) error {
	if addonCurrency.IsFiat() && addonCurrency.GetCode() == subscriptionCurrency {
		return nil
	}
