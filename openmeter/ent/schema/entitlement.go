...
func (Entitlement) Fields() []ent.Field {
	return []ent.Field{
		...
		// Opportunistic balance calculations compare this before and after their
		// unlocked work so an invalidation cannot be followed by a stale insert.
		field.Uint64("balance_snapshot_invalidation_version").Default(0),
