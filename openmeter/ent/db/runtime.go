...
func init() {
	...
	billinginvoiceDescCurrency := billinginvoiceFields[6].Descriptor()
	...
	billinginvoiceDescProviderConfig := billinginvoiceFields[10].Descriptor()
	...
	billinginvoiceDescProviderReference := billinginvoiceFields[12].Descriptor()
