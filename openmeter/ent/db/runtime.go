...
func init() {
	...
	currencycostbasiseffectivefromMixin := schema.CurrencyCostBasisEffectiveFrom{}.Mixin()
	currencycostbasiseffectivefromMixinFields0 := currencycostbasiseffectivefromMixin[0].Fields()
	_ = currencycostbasiseffectivefromMixinFields0
	currencycostbasiseffectivefromMixinFields1 := currencycostbasiseffectivefromMixin[1].Fields()
	_ = currencycostbasiseffectivefromMixinFields1
	currencycostbasiseffectivefromFields := schema.CurrencyCostBasisEffectiveFrom{}.Fields()
	_ = currencycostbasiseffectivefromFields
	// currencycostbasiseffectivefromDescCreatedAt is the schema descriptor for created_at field.
	currencycostbasiseffectivefromDescCreatedAt := currencycostbasiseffectivefromMixinFields1[0].Descriptor()
	// currencycostbasiseffectivefrom.DefaultCreatedAt holds the default value on creation for the created_at field.
	currencycostbasiseffectivefrom.DefaultCreatedAt = currencycostbasiseffectivefromDescCreatedAt.Default.(func() time.Time)
	// currencycostbasiseffectivefromDescID is the schema descriptor for id field.
	currencycostbasiseffectivefromDescID := currencycostbasiseffectivefromMixinFields0[0].Descriptor()
	// currencycostbasiseffectivefrom.DefaultID holds the default value on creation for the id field.
	currencycostbasiseffectivefrom.DefaultID = currencycostbasiseffectivefromDescID.Default.(func() string)
