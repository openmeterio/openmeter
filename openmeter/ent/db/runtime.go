...
func init() {
	...
	// addonDescCustomCurrencyID is the schema descriptor for custom_currency_id field.
	addonDescCustomCurrencyID := addonFields[2].Descriptor()
	// addon.CustomCurrencyIDValidator is a validator for the "custom_currency_id" field. It is called by the builders before save.
	addon.CustomCurrencyIDValidator = addonDescCustomCurrencyID.Validators[0].(func(string) error)
	// addonDescAnnotations is the schema descriptor for annotations field.
	addonDescAnnotations := addonFields[6].Descriptor()
	...
	addonratecardDescTaxConfig := addonratecardFields[4].Descriptor()
	...
	addonratecardDescPrice := addonratecardFields[6].Descriptor()
	...
	addonratecardDescCurrencyCode := addonratecardFields[7].Descriptor()
	...
	// addonratecardDescCustomCurrencyID is the schema descriptor for custom_currency_id field.
	addonratecardDescCustomCurrencyID := addonratecardFields[8].Descriptor()
	// addonratecard.CustomCurrencyIDValidator is a validator for the "custom_currency_id" field. It is called by the builders before save.
	addonratecard.CustomCurrencyIDValidator = addonratecardDescCustomCurrencyID.Validators[0].(func(string) error)
	// addonratecardDescDiscounts is the schema descriptor for discounts field.
	addonratecardDescDiscounts := addonratecardFields[9].Descriptor()
	...
	addonratecardDescUnitConfig := addonratecardFields[10].Descriptor()
	addonratecard.ValueScanner.UnitConfig = addonratecardDescUnitConfig.ValueScanner.(field.TypeValueScanner[*unitconfig.UnitConfig])
	...
	billinginvoiceDescCurrency := billinginvoiceFields[16].Descriptor()
	...
	billinginvoiceDescSchemaLevel := billinginvoiceFields[28].Descriptor()
	...
	billinginvoicelineDescRatecardDiscounts := billinginvoicelineFields[10].Descriptor()
	...
	billinginvoicesplitlinegroupDescRatecardDiscounts := billinginvoicesplitlinegroupFields[4].Descriptor()
	...
	billinginvoicesplitlinegroupDescPrice := billinginvoicesplitlinegroupFields[6].Descriptor()
	...
	billinginvoiceusagebasedlineconfig.ValueScanner.UnitConfig = billinginvoiceusagebasedlineconfigDescUnitConfig.ValueScanner.(field.TypeValueScanner[*unitconfig.UnitConfig])
	...
	billingstandardinvoicedetailedlineDescChildUniqueReferenceID := billingstandardinvoicedetailedlineMixinFields0[5].Descriptor()
	...
	billingstandardinvoicedetailedlineDescNamespace := billingstandardinvoicedetailedlineMixinFields0[13].Descriptor()
	...
	billingstandardinvoicedetailedlineDescCreatedAt := billingstandardinvoicedetailedlineMixinFields0[15].Descriptor()
	...
	billingstandardinvoicedetailedlineDescUpdatedAt := billingstandardinvoicedetailedlineMixinFields0[16].Descriptor()
	...
	billingstandardinvoicedetailedlineDescID := billingstandardinvoicedetailedlineMixinFields0[12].Descriptor()
	...
	chargecreditpurchase.ValueScanner.SubscriptionPlan = chargecreditpurchaseDescSubscriptionPlan.ValueScanner.(field.TypeValueScanner[*planhistory.PlanVersion])
	...
	chargeflatfee.ValueScanner.SubscriptionPlan = chargeflatfeeDescSubscriptionPlan.ValueScanner.(field.TypeValueScanner[*planhistory.PlanVersion])
	...
	chargeflatfeeoverrideMixinFields1 := chargeflatfeeoverrideMixin[1].Fields()
	_ = chargeflatfeeoverrideMixinFields1
	chargeflatfeeoverrideFields := schema.ChargeFlatFeeOverride{}.Fields()
	_ = chargeflatfeeoverrideFields
	// chargeflatfeeoverrideDescNamespace is the schema descriptor for namespace field.
	chargeflatfeeoverrideDescNamespace := chargeflatfeeoverrideMixinFields0[0].Descriptor()
	// chargeflatfeeoverride.NamespaceValidator is a validator for the "namespace" field. It is called by the builders before save.
	chargeflatfeeoverride.NamespaceValidator = chargeflatfeeoverrideDescNamespace.Validators[0].(func(string) error)
	// chargeflatfeeoverrideDescName is the schema descriptor for name field.
	chargeflatfeeoverrideDescName := chargeflatfeeoverrideFields[1].Descriptor()
	// chargeflatfeeoverride.NameValidator is a validator for the "name" field. It is called by the builders before save.
	chargeflatfeeoverride.NameValidator = chargeflatfeeoverrideDescName.Validators[0].(func(string) error)
	// chargeflatfeeoverrideDescMetadata is the schema descriptor for metadata field.
	...
	chargeflatfeeoverride.DefaultID = chargeflatfeeoverrideDescID.Default.(func() string)
	chargeflatfeerunMixin := schema.ChargeFlatFeeRun{}.Mixin()
	chargeflatfeerunMixinFields0 := chargeflatfeerunMixin[0].Fields()
	_ = chargeflatfeerunMixinFields0
	chargeflatfeerunMixinFields1 := chargeflatfeerunMixin[1].Fields()
	_ = chargeflatfeerunMixinFields1
	chargeflatfeerunMixinFields2 := chargeflatfeerunMixin[2].Fields()
	_ = chargeflatfeerunMixinFields2
	chargeflatfeerunFields := schema.ChargeFlatFeeRun{}.Fields()
	_ = chargeflatfeerunFields
	// chargeflatfeerunDescNamespace is the schema descriptor for namespace field.
	chargeflatfeerunDescNamespace := chargeflatfeerunMixinFields0[0].Descriptor()
	// chargeflatfeerun.NamespaceValidator is a validator for the "namespace" field. It is called by the builders before save.
	chargeflatfeerun.NamespaceValidator = chargeflatfeerunDescNamespace.Validators[0].(func(string) error)
	// chargeflatfeerunDescCreatedAt is the schema descriptor for created_at field.
	chargeflatfeerunDescCreatedAt := chargeflatfeerunMixinFields2[0].Descriptor()
	// chargeflatfeerun.DefaultCreatedAt holds the default value on creation for the created_at field.
	chargeflatfeerun.DefaultCreatedAt = chargeflatfeerunDescCreatedAt.Default.(func() time.Time)
	// chargeflatfeerunDescUpdatedAt is the schema descriptor for updated_at field.
	chargeflatfeerunDescUpdatedAt := chargeflatfeerunMixinFields2[1].Descriptor()
	// chargeflatfeerun.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	...
	chargeflatfeerun.DefaultID = chargeflatfeerunDescID.Default.(func() string)
	chargeflatfeeruncreditallocationsMixin := schema.ChargeFlatFeeRunCreditAllocations{}.Mixin()
	chargeflatfeeruncreditallocationsMixinFields0 := chargeflatfeeruncreditallocationsMixin[0].Fields()
	_ = chargeflatfeeruncreditallocationsMixinFields0
	chargeflatfeeruncreditallocationsFields := schema.ChargeFlatFeeRunCreditAllocations{}.Fields()
	_ = chargeflatfeeruncreditallocationsFields
	// chargeflatfeeruncreditallocationsDescLineID is the schema descriptor for line_id field.
	chargeflatfeeruncreditallocationsDescLineID := chargeflatfeeruncreditallocationsMixinFields0[0].Descriptor()
	// chargeflatfeeruncreditallocations.LineIDValidator is a validator for the "line_id" field. It is called by the builders before save.
	chargeflatfeeruncreditallocations.LineIDValidator = chargeflatfeeruncreditallocationsDescLineID.Validators[0].(func(string) error)
	// chargeflatfeeruncreditallocationsDescLedgerTransactionGroupID is the schema descriptor for ledger_transaction_group_id field.
	chargeflatfeeruncreditallocationsDescLedgerTransactionGroupID := chargeflatfeeruncreditallocationsMixinFields0[4].Descriptor()
	// chargeflatfeeruncreditallocations.LedgerTransactionGroupIDValidator is a validator for the "ledger_transaction_group_id" field. It is called by the builders before save.
	chargeflatfeeruncreditallocations.LedgerTransactionGroupIDValidator = chargeflatfeeruncreditallocationsDescLedgerTransactionGroupID.Validators[0].(func(string) error)
	// chargeflatfeeruncreditallocationsDescCorrectsRealizationID is the schema descriptor for corrects_realization_id field.
	chargeflatfeeruncreditallocationsDescCorrectsRealizationID := chargeflatfeeruncreditallocationsMixinFields0[7].Descriptor()
	// chargeflatfeeruncreditallocations.CorrectsRealizationIDValidator is a validator for the "corrects_realization_id" field. It is called by the builders before save.
	chargeflatfeeruncreditallocations.CorrectsRealizationIDValidator = chargeflatfeeruncreditallocationsDescCorrectsRealizationID.Validators[0].(func(string) error)
	// chargeflatfeeruncreditallocationsDescNamespace is the schema descriptor for namespace field.
	chargeflatfeeruncreditallocationsDescNamespace := chargeflatfeeruncreditallocationsMixinFields0[8].Descriptor()
	// chargeflatfeeruncreditallocations.NamespaceValidator is a validator for the "namespace" field. It is called by the builders before save.
	chargeflatfeeruncreditallocations.NamespaceValidator = chargeflatfeeruncreditallocationsDescNamespace.Validators[0].(func(string) error)
	// chargeflatfeeruncreditallocationsDescCreatedAt is the schema descriptor for created_at field.
	chargeflatfeeruncreditallocationsDescCreatedAt := chargeflatfeeruncreditallocationsMixinFields0[10].Descriptor()
	// chargeflatfeeruncreditallocations.DefaultCreatedAt holds the default value on creation for the created_at field.
	chargeflatfeeruncreditallocations.DefaultCreatedAt = chargeflatfeeruncreditallocationsDescCreatedAt.Default.(func() time.Time)
	// chargeflatfeeruncreditallocationsDescUpdatedAt is the schema descriptor for updated_at field.
	chargeflatfeeruncreditallocationsDescUpdatedAt := chargeflatfeeruncreditallocationsMixinFields0[11].Descriptor()
	// chargeflatfeeruncreditallocations.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	chargeflatfeeruncreditallocations.DefaultUpdatedAt = chargeflatfeeruncreditallocationsDescUpdatedAt.Default.(func() time.Time)
	// chargeflatfeeruncreditallocations.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	chargeflatfeeruncreditallocations.UpdateDefaultUpdatedAt = chargeflatfeeruncreditallocationsDescUpdatedAt.UpdateDefault.(func() time.Time)
	// chargeflatfeeruncreditallocationsDescID is the schema descriptor for id field.
	chargeflatfeeruncreditallocationsDescID := chargeflatfeeruncreditallocationsMixinFields0[9].Descriptor()
	// chargeflatfeeruncreditallocations.DefaultID holds the default value on creation for the id field.
	chargeflatfeeruncreditallocations.DefaultID = chargeflatfeeruncreditallocationsDescID.Default.(func() string)
	chargeflatfeerundetailedlineMixin := schema.ChargeFlatFeeRunDetailedLine{}.Mixin()
	chargeflatfeerundetailedlineMixinFields0 := chargeflatfeerundetailedlineMixin[0].Fields()
	_ = chargeflatfeerundetailedlineMixinFields0
	chargeflatfeerundetailedlineFields := schema.ChargeFlatFeeRunDetailedLine{}.Fields()
	_ = chargeflatfeerundetailedlineFields
	// chargeflatfeerundetailedlineDescChildUniqueReferenceID is the schema descriptor for child_unique_reference_id field.
	chargeflatfeerundetailedlineDescChildUniqueReferenceID := chargeflatfeerundetailedlineMixinFields0[6].Descriptor()
	// chargeflatfeerundetailedline.ChildUniqueReferenceIDValidator is a validator for the "child_unique_reference_id" field. It is called by the builders before save.
	chargeflatfeerundetailedline.ChildUniqueReferenceIDValidator = chargeflatfeerundetailedlineDescChildUniqueReferenceID.Validators[0].(func(string) error)
	// chargeflatfeerundetailedlineDescNamespace is the schema descriptor for namespace field.
	chargeflatfeerundetailedlineDescNamespace := chargeflatfeerundetailedlineMixinFields0[14].Descriptor()
	// chargeflatfeerundetailedline.NamespaceValidator is a validator for the "namespace" field. It is called by the builders before save.
	chargeflatfeerundetailedline.NamespaceValidator = chargeflatfeerundetailedlineDescNamespace.Validators[0].(func(string) error)
	// chargeflatfeerundetailedlineDescCreatedAt is the schema descriptor for created_at field.
	chargeflatfeerundetailedlineDescCreatedAt := chargeflatfeerundetailedlineMixinFields0[16].Descriptor()
	// chargeflatfeerundetailedline.DefaultCreatedAt holds the default value on creation for the created_at field.
	chargeflatfeerundetailedline.DefaultCreatedAt = chargeflatfeerundetailedlineDescCreatedAt.Default.(func() time.Time)
	// chargeflatfeerundetailedlineDescUpdatedAt is the schema descriptor for updated_at field.
	chargeflatfeerundetailedlineDescUpdatedAt := chargeflatfeerundetailedlineMixinFields0[17].Descriptor()
	// chargeflatfeerundetailedline.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	chargeflatfeerundetailedline.DefaultUpdatedAt = chargeflatfeerundetailedlineDescUpdatedAt.Default.(func() time.Time)
	...
	chargeflatfeerundetailedlineDescID := chargeflatfeerundetailedlineMixinFields0[13].Descriptor()
	// chargeflatfeerundetailedline.DefaultID holds the default value on creation for the id field.
	chargeflatfeerundetailedline.DefaultID = chargeflatfeerundetailedlineDescID.Default.(func() string)
	chargeflatfeeruninvoicedusageMixin := schema.ChargeFlatFeeRunInvoicedUsage{}.Mixin()
	chargeflatfeeruninvoicedusageMixinFields0 := chargeflatfeeruninvoicedusageMixin[0].Fields()
	...
	chargeflatfeerunpaymentFields := schema.ChargeFlatFeeRunPayment{}.Fields()
	_ = chargeflatfeerunpaymentFields
	// chargeflatfeerunpaymentDescAuthorizedTransactionGroupID is the schema descriptor for authorized_transaction_group_id field.
	chargeflatfeerunpaymentDescAuthorizedTransactionGroupID := chargeflatfeerunpaymentMixinFields0[6].Descriptor()
	// chargeflatfeerunpayment.AuthorizedTransactionGroupIDValidator is a validator for the "authorized_transaction_group_id" field. It is called by the builders before save.
	chargeflatfeerunpayment.AuthorizedTransactionGroupIDValidator = chargeflatfeerunpaymentDescAuthorizedTransactionGroupID.Validators[0].(func(string) error)
	// chargeflatfeerunpaymentDescSettledTransactionGroupID is the schema descriptor for settled_transaction_group_id field.
	chargeflatfeerunpaymentDescSettledTransactionGroupID := chargeflatfeerunpaymentMixinFields0[8].Descriptor()
	// chargeflatfeerunpayment.SettledTransactionGroupIDValidator is a validator for the "settled_transaction_group_id" field. It is called by the builders before save.
	chargeflatfeerunpayment.SettledTransactionGroupIDValidator = chargeflatfeerunpaymentDescSettledTransactionGroupID.Validators[0].(func(string) error)
	// chargeflatfeerunpaymentDescNamespace is the schema descriptor for namespace field.
	chargeflatfeerunpaymentDescNamespace := chargeflatfeerunpaymentMixinFields0[10].Descriptor()
	// chargeflatfeerunpayment.NamespaceValidator is a validator for the "namespace" field. It is called by the builders before save.
	chargeflatfeerunpayment.NamespaceValidator = chargeflatfeerunpaymentDescNamespace.Validators[0].(func(string) error)
	// chargeflatfeerunpaymentDescCreatedAt is the schema descriptor for created_at field.
	chargeflatfeerunpaymentDescCreatedAt := chargeflatfeerunpaymentMixinFields0[12].Descriptor()
	// chargeflatfeerunpayment.DefaultCreatedAt holds the default value on creation for the created_at field.
	chargeflatfeerunpayment.DefaultCreatedAt = chargeflatfeerunpaymentDescCreatedAt.Default.(func() time.Time)
	// chargeflatfeerunpaymentDescUpdatedAt is the schema descriptor for updated_at field.
	chargeflatfeerunpaymentDescUpdatedAt := chargeflatfeerunpaymentMixinFields0[13].Descriptor()
	// chargeflatfeerunpayment.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	chargeflatfeerunpayment.DefaultUpdatedAt = chargeflatfeerunpaymentDescUpdatedAt.Default.(func() time.Time)
	// chargeflatfeerunpayment.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	chargeflatfeerunpayment.UpdateDefaultUpdatedAt = chargeflatfeerunpaymentDescUpdatedAt.UpdateDefault.(func() time.Time)
	// chargeflatfeerunpaymentDescID is the schema descriptor for id field.
	chargeflatfeerunpaymentDescID := chargeflatfeerunpaymentMixinFields0[11].Descriptor()
	// chargeflatfeerunpayment.DefaultID holds the default value on creation for the id field.
	chargeflatfeerunpayment.DefaultID = chargeflatfeerunpaymentDescID.Default.(func() string)
	...
	chargeusagebased.ValueScanner.SubscriptionPlan = chargeusagebasedDescSubscriptionPlan.ValueScanner.(field.TypeValueScanner[*planhistory.PlanVersion])
	...
	chargeusagebasedDescFeatureID := chargeusagebasedFields[5].Descriptor()
	...
	chargeusagebasedoverrideMixinFields1 := chargeusagebasedoverrideMixin[1].Fields()
	_ = chargeusagebasedoverrideMixinFields1
	chargeusagebasedoverrideFields := schema.ChargeUsageBasedOverride{}.Fields()
	_ = chargeusagebasedoverrideFields
	// chargeusagebasedoverrideDescNamespace is the schema descriptor for namespace field.
	chargeusagebasedoverrideDescNamespace := chargeusagebasedoverrideMixinFields0[0].Descriptor()
	// chargeusagebasedoverride.NamespaceValidator is a validator for the "namespace" field. It is called by the builders before save.
	chargeusagebasedoverride.NamespaceValidator = chargeusagebasedoverrideDescNamespace.Validators[0].(func(string) error)
	// chargeusagebasedoverrideDescName is the schema descriptor for name field.
	chargeusagebasedoverrideDescName := chargeusagebasedoverrideFields[1].Descriptor()
	// chargeusagebasedoverride.NameValidator is a validator for the "name" field. It is called by the builders before save.
	chargeusagebasedoverride.NameValidator = chargeusagebasedoverrideDescName.Validators[0].(func(string) error)
	// chargeusagebasedoverrideDescMetadata is the schema descriptor for metadata field.
	...
	chargeusagebasedoverride.ValueScanner.UnitConfig = chargeusagebasedoverrideDescUnitConfig.ValueScanner.(field.TypeValueScanner[*unitconfig.UnitConfig])
	...
	chargeusagebasedoverride.DefaultID = chargeusagebasedoverrideDescID.Default.(func() string)
	...
	// chargeusagebasedruncreditallocationsDescCorrectsRealizationID is the schema descriptor for corrects_realization_id field.
	chargeusagebasedruncreditallocationsDescCorrectsRealizationID := chargeusagebasedruncreditallocationsMixinFields0[7].Descriptor()
	// chargeusagebasedruncreditallocations.CorrectsRealizationIDValidator is a validator for the "corrects_realization_id" field. It is called by the builders before save.
	chargeusagebasedruncreditallocations.CorrectsRealizationIDValidator = chargeusagebasedruncreditallocationsDescCorrectsRealizationID.Validators[0].(func(string) error)
	// chargeusagebasedruncreditallocationsDescNamespace is the schema descriptor for namespace field.
	chargeusagebasedruncreditallocationsDescNamespace := chargeusagebasedruncreditallocationsMixinFields0[8].Descriptor()
	...
	chargeusagebasedruncreditallocationsDescCreatedAt := chargeusagebasedruncreditallocationsMixinFields0[10].Descriptor()
	...
	chargeusagebasedruncreditallocationsDescUpdatedAt := chargeusagebasedruncreditallocationsMixinFields0[11].Descriptor()
	...
	chargeusagebasedrundetailedlineDescChildUniqueReferenceID := chargeusagebasedrundetailedlineMixinFields0[6].Descriptor()
	...
	chargeusagebasedrundetailedlineDescNamespace := chargeusagebasedrundetailedlineMixinFields0[14].Descriptor()
	...
	chargeusagebasedrundetailedlineDescCreatedAt := chargeusagebasedrundetailedlineMixinFields0[16].Descriptor()
	...
	chargeusagebasedrundetailedlineDescUpdatedAt := chargeusagebasedrundetailedlineMixinFields0[17].Descriptor()
	...
	chargeusagebasedrundetailedlineDescID := chargeusagebasedrundetailedlineMixinFields0[13].Descriptor()
	...
	chargessearchv1DescCustomerID := chargessearchv1Fields[4].Descriptor()
	...
	chargessearchv1DescFiatCurrencyCode := chargessearchv1Fields[13].Descriptor()
	...
	chargessearchv1.ValueScanner.SubscriptionPlan = chargessearchv1DescSubscriptionPlan.ValueScanner.(field.TypeValueScanner[*planhistory.PlanVersion])
	...
	// creditrealizationlineageDescChargeID is the schema descriptor for charge_id field.
	creditrealizationlineageDescChargeID := creditrealizationlineageFields[0].Descriptor()
	// creditrealizationlineage.ChargeIDValidator is a validator for the "charge_id" field. It is called by the builders before save.
	creditrealizationlineage.ChargeIDValidator = creditrealizationlineageDescChargeID.Validators[0].(func(string) error)
	// creditrealizationlineageDescRootRealizationID is the schema descriptor for root_realization_id field.
	creditrealizationlineageDescRootRealizationID := creditrealizationlineageFields[1].Descriptor()
	...
	creditrealizationlineageDescCustomerID := creditrealizationlineageFields[2].Descriptor()
	...
	// planDescCustomCurrencyID is the schema descriptor for custom_currency_id field.
	planDescCustomCurrencyID := planFields[2].Descriptor()
	// plan.CustomCurrencyIDValidator is a validator for the "custom_currency_id" field. It is called by the builders before save.
	plan.CustomCurrencyIDValidator = planDescCustomCurrencyID.Validators[0].(func(string) error)
	// planDescProRatingConfig is the schema descriptor for pro_rating_config field.
	planDescProRatingConfig := planFields[4].Descriptor()
	...
	planratecardDescTaxConfig := planratecardFields[4].Descriptor()
	...
	planratecardDescPrice := planratecardFields[6].Descriptor()
	...
	planratecardDescCurrencyCode := planratecardFields[7].Descriptor()
	...
	// planratecardDescCustomCurrencyID is the schema descriptor for custom_currency_id field.
	planratecardDescCustomCurrencyID := planratecardFields[8].Descriptor()
	// planratecard.CustomCurrencyIDValidator is a validator for the "custom_currency_id" field. It is called by the builders before save.
	planratecard.CustomCurrencyIDValidator = planratecardDescCustomCurrencyID.Validators[0].(func(string) error)
	// planratecardDescDiscounts is the schema descriptor for discounts field.
	planratecardDescDiscounts := planratecardFields[9].Descriptor()
	...
	planratecardDescUnitConfig := planratecardFields[10].Descriptor()
	planratecard.ValueScanner.UnitConfig = planratecardDescUnitConfig.ValueScanner.(field.TypeValueScanner[*unitconfig.UnitConfig])
	...
	// subscriptionDescPlanHistory is the schema descriptor for plan_history field.
	subscriptionDescPlanHistory := subscriptionFields[3].Descriptor()
	subscription.ValueScanner.PlanHistory = subscriptionDescPlanHistory.ValueScanner.(field.TypeValueScanner[planhistory.History])
	...
	subscriptionDescInvoiceCurrency := subscriptionFields[5].Descriptor()
	...
	subscriptionDescProRatingConfig := subscriptionFields[9].Descriptor()
	...
	// subscriptionitemDescCurrency is the schema descriptor for currency field.
	subscriptionitemDescCurrency := subscriptionitemFields[16].Descriptor()
	// subscriptionitem.CurrencyValidator is a validator for the "currency" field. It is called by the builders before save.
	subscriptionitem.CurrencyValidator = func() func(string) error {
		validators := subscriptionitemDescCurrency.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
			validators[2].(func(string) error),
	...
	subscriptionitem.ValueScanner.UnitConfig = subscriptionitemDescUnitConfig.ValueScanner.(field.TypeValueScanner[*unitconfig.UnitConfig])
