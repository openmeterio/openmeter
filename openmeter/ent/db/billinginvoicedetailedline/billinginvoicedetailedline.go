...
const (
	// Label holds the string label denoting the billinginvoicedetailedline type in the database.
	Label = "billing_invoice_detailed_line"
	...
	// Table holds the table name of the billinginvoicedetailedline in the database.
	Table = "billing_invoice_detailed_lines"
	// InvoiceTable is the table that holds the invoice relation/edge.
	InvoiceTable = "billing_invoice_detailed_lines"
	...
	ParentLineTable = "billing_invoice_detailed_lines"
	// ParentLineInverseTable is the table name for the BillingInvoiceLine entity.
	// It exists in this package in order to avoid circular dependency with the "billinginvoiceline" package.
	ParentLineInverseTable = "billing_invoice_lines"
	...
	AmountDiscountsTable = "billing_invoice_detailed_line_amount_discounts"
	// AmountDiscountsInverseTable is the table name for the BillingInvoiceDetailedLineAmountDiscount entity.
	// It exists in this package in order to avoid circular dependency with the "billinginvoicedetailedlineamountdiscount" package.
	AmountDiscountsInverseTable = "billing_invoice_detailed_line_amount_discounts"
	// AmountDiscountsColumn is the table column denoting the amount_discounts relation/edge.
	AmountDiscountsColumn = "line_id"
)

// Columns holds all SQL columns for billinginvoicedetailedline fields.
var Columns = []string{
	FieldID,
	FieldAnnotations,
	FieldNamespace,
...
func CategoryValidator(c billing.DetailedLineCategory) error {
	...
	case "regular", "commitment":
		return nil
	default:
		return fmt.Errorf("billinginvoicedetailedline: invalid enum value for category field: %q", c)
	}
}
...
func PaymentTermValidator(pt productcatalog.PaymentTermType) error {
	...
	case "in_advance", "in_arrears":
		return nil
	default:
		return fmt.Errorf("billinginvoicedetailedline: invalid enum value for payment_term field: %q", pt)
	}
}

// OrderOption defines the ordering options for the BillingInvoiceDetailedLine queries.
...
func newParentLineStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(ParentLineInverseTable, FieldID),
