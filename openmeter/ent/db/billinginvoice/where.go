...
func TaxProviderConfigIsNil() predicate.BillingInvoice {
	return predicate.BillingInvoice(sql.FieldIsNull(FieldTaxProviderConfig))
}

// TaxProviderConfigNotNil applies the NotNil predicate on the "tax_provider_config" field.
func TaxProviderConfigNotNil() predicate.BillingInvoice {
	return predicate.BillingInvoice(sql.FieldNotNull(FieldTaxProviderConfig))
}
...
func InvoicingProviderConfigIsNil() predicate.BillingInvoice {
	return predicate.BillingInvoice(sql.FieldIsNull(FieldInvoicingProviderConfig))
}

// InvoicingProviderConfigNotNil applies the NotNil predicate on the "invoicing_provider_config" field.
func InvoicingProviderConfigNotNil() predicate.BillingInvoice {
	return predicate.BillingInvoice(sql.FieldNotNull(FieldInvoicingProviderConfig))
}
...
func PaymentProviderConfigIsNil() predicate.BillingInvoice {
	return predicate.BillingInvoice(sql.FieldIsNull(FieldPaymentProviderConfig))
}

// PaymentProviderConfigNotNil applies the NotNil predicate on the "payment_provider_config" field.
func PaymentProviderConfigNotNil() predicate.BillingInvoice {
	return predicate.BillingInvoice(sql.FieldNotNull(FieldPaymentProviderConfig))
}
