...
const (
	...
	// FieldCustomerSubjectKeys holds the string denoting the customer_subject_keys field in the database.
	FieldCustomerSubjectKeys = "customer_subject_keys"
