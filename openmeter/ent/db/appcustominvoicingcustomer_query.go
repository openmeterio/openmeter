...
func (_g *AppCustomInvoicingCustomerGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*AppCustomInvoicingCustomerQuery, *AppCustomInvoicingCustomerGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *AppCustomInvoicingCustomerGroupBy) sqlScan(ctx context.Context, root *AppCustomInvoicingCustomerQuery, v any) error {
...
func (_s *AppCustomInvoicingCustomerSelect) Aggregate(fns ...AggregateFunc) *AppCustomInvoicingCustomerSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *AppCustomInvoicingCustomerSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*AppCustomInvoicingCustomerQuery, *AppCustomInvoicingCustomerSelect](ctx, _s.AppCustomInvoicingCustomerQuery, _s, _s.inters, v)
}

func (_s *AppCustomInvoicingCustomerSelect) sqlScan(ctx context.Context, root *AppCustomInvoicingCustomerQuery, v any) error {
