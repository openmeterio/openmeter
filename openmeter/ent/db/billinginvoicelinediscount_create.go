...
func (_c *BillingInvoiceLineDiscountCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if billinginvoicelinediscount.DefaultCreatedAt == nil {
			return fmt.Errorf("db: uninitialized billinginvoicelinediscount.DefaultCreatedAt (forgotten import db/runtime?)")
		}
		v := billinginvoicelinediscount.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if billinginvoicelinediscount.DefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized billinginvoicelinediscount.DefaultUpdatedAt (forgotten import db/runtime?)")
		}
		v := billinginvoicelinediscount.DefaultUpdatedAt()
		_c.mutation.SetUpdatedAt(v)
	}
	if _, ok := _c.mutation.ID(); !ok {
		if billinginvoicelinediscount.DefaultID == nil {
			return fmt.Errorf("db: uninitialized billinginvoicelinediscount.DefaultID (forgotten import db/runtime?)")
		}
