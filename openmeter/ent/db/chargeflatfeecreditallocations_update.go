...
func (_u *ChargeFlatFeeCreditAllocationsUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if chargeflatfeecreditallocations.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized chargeflatfeecreditallocations.UpdateDefaultUpdatedAt (forgotten import db/runtime?)")
		}
...
// defaults sets the default values of the builder before save.
func (_u *ChargeFlatFeeCreditAllocationsUpdateOne) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if chargeflatfeecreditallocations.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized chargeflatfeecreditallocations.UpdateDefaultUpdatedAt (forgotten import db/runtime?)")
		}
