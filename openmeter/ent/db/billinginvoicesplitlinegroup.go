...
type BillingInvoiceSplitLineGroupEdges struct {
	...
	// UsageBasedLineConfig holds the value of the usage_based_line_config edge.
	UsageBasedLineConfig []*BillingInvoiceUsageBasedLineConfig `json:"usage_based_line_config,omitempty"`
...
// UsageBasedLineConfigOrErr returns the UsageBasedLineConfig value or an error if the edge
// was not loaded in eager-loading.
func (e BillingInvoiceSplitLineGroupEdges) UsageBasedLineConfigOrErr() ([]*BillingInvoiceUsageBasedLineConfig, error) {
	if e.loadedTypes[1] {
		return e.UsageBasedLineConfig, nil
	}
	return nil, &NotLoadedError{edge: "usage_based_line_config"}
}
...
// QueryUsageBasedLineConfig queries the "usage_based_line_config" edge of the BillingInvoiceSplitLineGroup entity.
func (_m *BillingInvoiceSplitLineGroup) QueryUsageBasedLineConfig() *BillingInvoiceUsageBasedLineConfigQuery {
	return NewBillingInvoiceSplitLineGroupClient(_m.config).QueryUsageBasedLineConfig(_m)
}
