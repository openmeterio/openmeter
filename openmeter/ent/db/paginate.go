...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AppStripeInvoiceSyncOpQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AppStripeInvoiceSyncOp], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AppStripeInvoiceSyncOp]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AppStripeInvoiceSyncOp, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AppStripeInvoiceSyncOp] = (*AppStripeInvoiceSyncOpQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *AppStripeInvoiceSyncPlanQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*AppStripeInvoiceSyncPlan], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*AppStripeInvoiceSyncPlan]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*AppStripeInvoiceSyncPlan, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*AppStripeInvoiceSyncPlan] = (*AppStripeInvoiceSyncPlanQuery)(nil)
