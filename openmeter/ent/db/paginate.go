...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *ChargeUsageBasedDetailedLineQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.Result[*ChargeUsageBasedDetailedLine], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.Result[*ChargeUsageBasedDetailedLine]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*ChargeUsageBasedDetailedLine, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*ChargeUsageBasedDetailedLine] = (*ChargeUsageBasedDetailedLineQuery)(nil)
