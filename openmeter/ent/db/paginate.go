...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *BillingInvoiceDetailedLineQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.PagedResponse[*BillingInvoiceDetailedLine], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.PagedResponse[*BillingInvoiceDetailedLine]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*BillingInvoiceDetailedLine, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*BillingInvoiceDetailedLine] = (*BillingInvoiceDetailedLineQuery)(nil)

// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (_m *BillingInvoiceDetailedLineAmountDiscountQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.PagedResponse[*BillingInvoiceDetailedLineAmountDiscount], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.PagedResponse[*BillingInvoiceDetailedLineAmountDiscount]{
		Page: page,
	}
	...
	if count == 0 {
		// Items should be [] not null.
		pagedResponse.Items = make([]*BillingInvoiceDetailedLineAmountDiscount, 0)
		return pagedResponse, nil
	}
...
// type check
var _ pagination.Paginator[*BillingInvoiceDetailedLineAmountDiscount] = (*BillingInvoiceDetailedLineAmountDiscountQuery)(nil)
