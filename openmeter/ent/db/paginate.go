...
// Paginate runs the query and returns a paginated response.
// If page is its 0 value then it will return all the items and populate the response page accordingly.
func (rc *RateCardQuery) Paginate(ctx context.Context, page pagination.Page) (pagination.PagedResponse[*RateCard], error) {
	// Get the limit and offset
	limit, offset := page.Limit(), page.Offset()
	...
	pagedResponse := pagination.PagedResponse[*RateCard]{
		Page: page,
	}
...
// type check
var _ pagination.Paginator[*RateCard] = (*RateCardQuery)(nil)
