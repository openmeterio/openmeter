...
func (_q *SubjectQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SubjectQuery) FirstIDX(ctx context.Context) string {
...
func (_q *SubjectQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SubjectQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *SubjectQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *SubjectQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(subject.FieldNamespace).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
...
func (_q *SubjectQuery) ForUpdate(opts ...sql.LockOption) *SubjectQuery {
...
func (_q *SubjectQuery) ForShare(opts ...sql.LockOption) *SubjectQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
