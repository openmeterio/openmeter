...
const (
	// Label holds the string label denoting the chargeusagebaseddetailedline type in the database.
	Label = "charge_usage_based_detailed_line"
	...
	// Table holds the table name of the chargeusagebaseddetailedline in the database.
	Table = "charge_usage_based_detailed_line"
	// ChargeTable is the table that holds the charge relation/edge.
	ChargeTable = "charge_usage_based_detailed_line"
	...
	RunTable = "charge_usage_based_detailed_line"
	...
	TaxCodeTable = "charge_usage_based_detailed_line"
...
// Columns holds all SQL columns for chargeusagebaseddetailedline fields.
var Columns = []string{
	FieldID,
	FieldCurrency,
	FieldTaxConfig,
...
func TaxBehaviorValidator(tb productcatalog.TaxBehavior) error {
	...
	case "inclusive", "exclusive":
		return nil
	default:
		return fmt.Errorf("chargeusagebaseddetailedline: invalid enum value for tax_behavior field: %q", tb)
	}
}
...
func CategoryValidator(c stddetailedline.Category) error {
	...
	case "regular", "commitment":
		return nil
	default:
		return fmt.Errorf("chargeusagebaseddetailedline: invalid enum value for category field: %q", c)
	}
}
...
func PaymentTermValidator(pt productcatalog.PaymentTermType) error {
	...
	case "in_advance", "in_arrears":
		return nil
	default:
		return fmt.Errorf("chargeusagebaseddetailedline: invalid enum value for payment_term field: %q", pt)
	}
}

// OrderOption defines the ordering options for the ChargeUsageBasedDetailedLine queries.
