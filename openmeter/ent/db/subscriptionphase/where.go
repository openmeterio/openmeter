...
func HasBillingGatheringInvoiceLines() predicate.SubscriptionPhase {
	return predicate.SubscriptionPhase(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBillingGatheringInvoiceLinesWith(preds ...predicate.BillingGatheringInvoiceLine) predicate.SubscriptionPhase {
	return predicate.SubscriptionPhase(func(s *sql.Selector) {
