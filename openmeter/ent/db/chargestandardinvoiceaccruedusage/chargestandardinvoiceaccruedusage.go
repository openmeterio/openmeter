...
const (
	// Label holds the string label denoting the chargestandardinvoiceaccruedusage type in the database.
	Label = "charge_standard_invoice_accrued_usage"
	...
	// Table holds the table name of the chargestandardinvoiceaccruedusage in the database.
	Table = "charge_standard_invoice_accrued_usages"
	// BillingInvoiceLineTable is the table that holds the billing_invoice_line relation/edge.
	BillingInvoiceLineTable = "charge_standard_invoice_accrued_usages"
	...
	FlatFeeTable = "charge_standard_invoice_accrued_usages"
...
// Columns holds all SQL columns for chargestandardinvoiceaccruedusage fields.
var Columns = []string{
	FieldID,
	FieldNamespace,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the ChargeStandardInvoiceAccruedUsage queries.
