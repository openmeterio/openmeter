...
func (_c *CustomerCreate) AddBillingSplitLineGroupIDs(ids ...string) *CustomerCreate {
...
func (_c *CustomerCreate) AddBillingSplitLineGroups(v ...*BillingInvoiceSplitLineGroup) *CustomerCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
