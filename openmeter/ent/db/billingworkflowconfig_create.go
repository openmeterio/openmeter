...
func (_c *BillingWorkflowConfigCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if billingworkflowconfig.DefaultCreatedAt == nil {
			return fmt.Errorf("db: uninitialized billingworkflowconfig.DefaultCreatedAt (forgotten import db/runtime?)")
		}
		v := billingworkflowconfig.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if billingworkflowconfig.DefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized billingworkflowconfig.DefaultUpdatedAt (forgotten import db/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if billingworkflowconfig.DefaultID == nil {
			return fmt.Errorf("db: uninitialized billingworkflowconfig.DefaultID (forgotten import db/runtime?)")
		}
