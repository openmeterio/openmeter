...
const (
	// Label holds the string label denoting the chargeflatfeerunoveragecreditallocations type in the database.
	Label = "charge_flat_fee_run_overage_credit_allocations"
	...
	// Table holds the table name of the chargeflatfeerunoveragecreditallocations in the database.
	Table = "charge_flat_fee_run_overage_credit_allocations"
	// AllocationTable is the table that holds the allocation relation/edge.
	AllocationTable = "charge_flat_fee_run_overage_credit_allocations"
	...
	CorrectionsTable = "charge_flat_fee_run_overage_credit_allocations"
	...
	RunTable = "charge_flat_fee_run_overage_credit_allocations"
	...
	BillingInvoiceLineTable = "charge_flat_fee_run_overage_credit_allocations"
...
// Columns holds all SQL columns for chargeflatfeerunoveragecreditallocations fields.
var Columns = []string{
	FieldID,
	FieldLineID,
	FieldAmount,
...
func TypeValidator(_type creditrealization.Type) error {
	...
	case "allocation", "correction":
		return nil
	default:
		return fmt.Errorf("chargeflatfeerunoveragecreditallocations: invalid enum value for type field: %q", _type)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeeRunOverageCreditAllocations queries.
