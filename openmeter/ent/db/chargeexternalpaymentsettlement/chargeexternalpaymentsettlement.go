...
const (
	// Label holds the string label denoting the chargeexternalpaymentsettlement type in the database.
	Label = "charge_external_payment_settlement"
	...
	// EdgeChargeCreditPurchase holds the string denoting the charge_credit_purchase edge name in mutations.
	EdgeChargeCreditPurchase = "charge_credit_purchase"
...
func StatusValidator(s charges.PaymentSettlementStatus) error {
	...
	case "authorized", "settled":
		return nil
	default:
		return fmt.Errorf("chargeexternalpaymentsettlement: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ChargeExternalPaymentSettlement queries.
...
// ByChargeCreditPurchaseField orders the results by charge_credit_purchase field.
func ByChargeCreditPurchaseField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newChargeCreditPurchaseStep(), sql.OrderByField(field, opts...))
	}
}
func newChargeCreditPurchaseStep() *sqlgraph.Step {
