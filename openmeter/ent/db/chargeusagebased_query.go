...
// Where adds a new predicate for the ChargeUsageBasedQuery builder.
func (_q *ChargeUsageBasedQuery) Where(ps ...predicate.ChargeUsageBased) *ChargeUsageBasedQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *ChargeUsageBasedQuery) Limit(limit int) *ChargeUsageBasedQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *ChargeUsageBasedQuery) Offset(offset int) *ChargeUsageBasedQuery {
...
func (_q *ChargeUsageBasedQuery) Unique(unique bool) *ChargeUsageBasedQuery {
	_q.ctx.Unique = &unique
	return _q
}

// Order specifies how the records should be ordered.
func (_q *ChargeUsageBasedQuery) Order(o ...chargeusagebased.OrderOption) *ChargeUsageBasedQuery {
	_q.order = append(_q.order, o...)
	return _q
}

// QueryRuns chains the current query on the "runs" edge.
func (_q *ChargeUsageBasedQuery) QueryRuns() *ChargeUsageBasedRunsQuery {
...
func (_q *ChargeUsageBasedQuery) QueryDetailedLines() *ChargeUsageBasedRunDetailedLineQuery {
...
func (_q *ChargeUsageBasedQuery) QueryCharge() *ChargeQuery {
...
func (_q *ChargeUsageBasedQuery) QuerySubscription() *SubscriptionQuery {
...
func (_q *ChargeUsageBasedQuery) QuerySubscriptionPhase() *SubscriptionPhaseQuery {
...
func (_q *ChargeUsageBasedQuery) QuerySubscriptionItem() *SubscriptionItemQuery {
...
func (_q *ChargeUsageBasedQuery) QueryCustomer() *CustomerQuery {
...
func (_q *ChargeUsageBasedQuery) QueryFeature() *FeatureQuery {
...
func (_q *ChargeUsageBasedQuery) First(ctx context.Context) (*ChargeUsageBased, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{chargeusagebased.Label}
	}
	return nodes[0], nil
}

// FirstX is like First, but panics if an error occurs.
func (_q *ChargeUsageBasedQuery) FirstX(ctx context.Context) *ChargeUsageBased {
...
// FirstID returns the first ChargeUsageBased ID from the query.
// Returns a *NotFoundError when no ChargeUsageBased ID was found.
func (_q *ChargeUsageBasedQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChargeUsageBasedQuery) FirstIDX(ctx context.Context) string {
...
// Only returns a single ChargeUsageBased entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one ChargeUsageBased entity is found.
// Returns a *NotFoundError when no ChargeUsageBased entities are found.
func (_q *ChargeUsageBasedQuery) Only(ctx context.Context) (*ChargeUsageBased, error) {
	...
	case 0:
		return nil, &NotFoundError{chargeusagebased.Label}
	default:
		return nil, &NotSingularError{chargeusagebased.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (_q *ChargeUsageBasedQuery) OnlyX(ctx context.Context) *ChargeUsageBased {
...
// OnlyID is like Only, but returns the only ChargeUsageBased ID in the query.
// Returns a *NotSingularError when more than one ChargeUsageBased ID is found.
// Returns a *NotFoundError when no entities are found.
func (_q *ChargeUsageBasedQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	...
	case 0:
		err = &NotFoundError{chargeusagebased.Label}
	default:
		err = &NotSingularError{chargeusagebased.Label}
	}
	return
}

// OnlyIDX is like OnlyID, but panics if an error occurs.
func (_q *ChargeUsageBasedQuery) OnlyIDX(ctx context.Context) string {
...
// All executes the query and returns a list of ChargeUsageBaseds.
func (_q *ChargeUsageBasedQuery) All(ctx context.Context) ([]*ChargeUsageBased, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*ChargeUsageBased, *ChargeUsageBasedQuery]()
	return withInterceptors[[]*ChargeUsageBased](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *ChargeUsageBasedQuery) AllX(ctx context.Context) []*ChargeUsageBased {
...
// IDs executes the query and returns a list of ChargeUsageBased IDs.
func (_q *ChargeUsageBasedQuery) IDs(ctx context.Context) (ids []string, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(chargeusagebased.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ChargeUsageBasedQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChargeUsageBasedQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*ChargeUsageBasedQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *ChargeUsageBasedQuery) CountX(ctx context.Context) int {
...
func (_q *ChargeUsageBasedQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *ChargeUsageBasedQuery) ExistX(ctx context.Context) bool {
...
// Clone returns a duplicate of the ChargeUsageBasedQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (_q *ChargeUsageBasedQuery) Clone() *ChargeUsageBasedQuery {
	if _q == nil {
		return nil
	}
...
func (_q *ChargeUsageBasedQuery) WithRuns(opts ...func(*ChargeUsageBasedRunsQuery)) *ChargeUsageBasedQuery {
	query := (&ChargeUsageBasedRunsClient{config: _q.config}).Query()
...
func (_q *ChargeUsageBasedQuery) WithDetailedLines(opts ...func(*ChargeUsageBasedRunDetailedLineQuery)) *ChargeUsageBasedQuery {
	query := (&ChargeUsageBasedRunDetailedLineClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedQuery) WithCharge(opts ...func(*ChargeQuery)) *ChargeUsageBasedQuery {
	query := (&ChargeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedQuery) WithSubscription(opts ...func(*SubscriptionQuery)) *ChargeUsageBasedQuery {
	query := (&SubscriptionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedQuery) WithSubscriptionPhase(opts ...func(*SubscriptionPhaseQuery)) *ChargeUsageBasedQuery {
	query := (&SubscriptionPhaseClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedQuery) WithSubscriptionItem(opts ...func(*SubscriptionItemQuery)) *ChargeUsageBasedQuery {
	query := (&SubscriptionItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedQuery) WithCustomer(opts ...func(*CustomerQuery)) *ChargeUsageBasedQuery {
	query := (&CustomerClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedQuery) WithFeature(opts ...func(*FeatureQuery)) *ChargeUsageBasedQuery {
	query := (&FeatureClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//	}
//
//	client.ChargeUsageBased.Query().
//		GroupBy(chargeusagebased.FieldCustomerID).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
func (_q *ChargeUsageBasedQuery) GroupBy(field string, fields ...string) *ChargeUsageBasedGroupBy {
	_q.ctx.Fields = append([]string{field}, fields...)
	grbuild := &ChargeUsageBasedGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = chargeusagebased.Label
...
//
//	client.ChargeUsageBased.Query().
//		Select(chargeusagebased.FieldCustomerID).
//		Scan(ctx, &v)
func (_q *ChargeUsageBasedQuery) Select(fields ...string) *ChargeUsageBasedSelect {
	_q.ctx.Fields = append(_q.ctx.Fields, fields...)
	sbuild := &ChargeUsageBasedSelect{ChargeUsageBasedQuery: _q}
	sbuild.label = chargeusagebased.Label
	sbuild.flds, sbuild.scan = &_q.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a ChargeUsageBasedSelect configured with the given aggregations.
func (_q *ChargeUsageBasedQuery) Aggregate(fns ...AggregateFunc) *ChargeUsageBasedSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *ChargeUsageBasedQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ChargeUsageBasedQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChargeUsageBased, error) {
	var (
	...
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*ChargeUsageBased).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &ChargeUsageBased{config: _q.config}
	...
	if query := _q.withDetailedLines; query != nil {
		if err := _q.loadDetailedLines(ctx, query, nodes,
			func(n *ChargeUsageBased) { n.Edges.DetailedLines = []*ChargeUsageBasedRunDetailedLine{} },
			func(n *ChargeUsageBased, e *ChargeUsageBasedRunDetailedLine) {
	...
	if query := _q.withSubscription; query != nil {
		if err := _q.loadSubscription(ctx, query, nodes, nil,
			func(n *ChargeUsageBased, e *Subscription) { n.Edges.Subscription = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSubscriptionPhase; query != nil {
		if err := _q.loadSubscriptionPhase(ctx, query, nodes, nil,
			func(n *ChargeUsageBased, e *SubscriptionPhase) { n.Edges.SubscriptionPhase = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSubscriptionItem; query != nil {
		if err := _q.loadSubscriptionItem(ctx, query, nodes, nil,
			func(n *ChargeUsageBased, e *SubscriptionItem) { n.Edges.SubscriptionItem = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCustomer; query != nil {
		if err := _q.loadCustomer(ctx, query, nodes, nil,
			func(n *ChargeUsageBased, e *Customer) { n.Edges.Customer = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ChargeUsageBasedQuery) loadRuns(ctx context.Context, query *ChargeUsageBasedRunsQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *ChargeUsageBasedRuns)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chargeusagebasedruns.FieldChargeID)
	}
	query.Where(predicate.ChargeUsageBasedRuns(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(chargeusagebased.RunsColumn), fks...))
	}))
...
func (_q *ChargeUsageBasedQuery) loadDetailedLines(ctx context.Context, query *ChargeUsageBasedRunDetailedLineQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *ChargeUsageBasedRunDetailedLine)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*ChargeUsageBased)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chargeusagebasedrundetailedline.FieldChargeID)
	}
	query.Where(predicate.ChargeUsageBasedRunDetailedLine(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(chargeusagebased.DetailedLinesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ChargeUsageBasedQuery) loadCharge(ctx context.Context, query *ChargeQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *Charge)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*ChargeUsageBased)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(charge.FieldChargeUsageBasedID)
	}
	query.Where(predicate.Charge(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(chargeusagebased.ChargeColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.ChargeUsageBasedID
		if fk == nil {
			return fmt.Errorf(`foreign-key "charge_usage_based_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *ChargeUsageBasedQuery) loadSubscription(ctx context.Context, query *SubscriptionQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *Subscription)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBased)
	for i := range nodes {
...
func (_q *ChargeUsageBasedQuery) loadSubscriptionPhase(ctx context.Context, query *SubscriptionPhaseQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *SubscriptionPhase)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBased)
	for i := range nodes {
...
func (_q *ChargeUsageBasedQuery) loadSubscriptionItem(ctx context.Context, query *SubscriptionItemQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *SubscriptionItem)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBased)
	for i := range nodes {
...
func (_q *ChargeUsageBasedQuery) loadCustomer(ctx context.Context, query *CustomerQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *Customer)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBased)
	for i := range nodes {
...
func (_q *ChargeUsageBasedQuery) loadFeature(ctx context.Context, query *FeatureQuery, nodes []*ChargeUsageBased, init func(*ChargeUsageBased), assign func(*ChargeUsageBased, *Feature)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBased)
	for i := range nodes {
...
func (_q *ChargeUsageBasedQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(chargeusagebased.Table, chargeusagebased.Columns, sqlgraph.NewFieldSpec(chargeusagebased.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSubscriptionPhase != nil {
			_spec.Node.AddColumnOnce(chargeusagebased.FieldSubscriptionPhaseID)
		}
		if _q.withSubscriptionItem != nil {
			_spec.Node.AddColumnOnce(chargeusagebased.FieldSubscriptionItemID)
		}
		if _q.withCustomer != nil {
			_spec.Node.AddColumnOnce(chargeusagebased.FieldCustomerID)
		}
...
func (_q *ChargeUsageBasedQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(chargeusagebased.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = chargeusagebased.Columns
	}
...
func (_q *ChargeUsageBasedQuery) ForUpdate(opts ...sql.LockOption) *ChargeUsageBasedQuery {
...
func (_q *ChargeUsageBasedQuery) ForShare(opts ...sql.LockOption) *ChargeUsageBasedQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
// ChargeUsageBasedGroupBy is the group-by builder for ChargeUsageBased entities.
type ChargeUsageBasedGroupBy struct {
	selector
	build *ChargeUsageBasedQuery
}

// Aggregate adds the given aggregation functions to the group-by query.
func (_g *ChargeUsageBasedGroupBy) Aggregate(fns ...AggregateFunc) *ChargeUsageBasedGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *ChargeUsageBasedGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ChargeUsageBasedQuery, *ChargeUsageBasedGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ChargeUsageBasedGroupBy) sqlScan(ctx context.Context, root *ChargeUsageBasedQuery, v any) error {
...
// ChargeUsageBasedSelect is the builder for selecting fields of ChargeUsageBased entities.
type ChargeUsageBasedSelect struct {
	*ChargeUsageBasedQuery
	selector
}

// Aggregate adds the given aggregation functions to the selector query.
func (_s *ChargeUsageBasedSelect) Aggregate(fns ...AggregateFunc) *ChargeUsageBasedSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *ChargeUsageBasedSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ChargeUsageBasedQuery, *ChargeUsageBasedSelect](ctx, _s.ChargeUsageBasedQuery, _s, _s.inters, v)
}

func (_s *ChargeUsageBasedSelect) sqlScan(ctx context.Context, root *ChargeUsageBasedQuery, v any) error {
