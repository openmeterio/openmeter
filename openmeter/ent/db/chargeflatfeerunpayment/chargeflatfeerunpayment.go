...
const (
	// Label holds the string label denoting the chargeflatfeerunpayment type in the database.
	Label = "charge_flat_fee_run_payment"
	...
	EdgeRun = "run"
	// Table holds the table name of the chargeflatfeerunpayment in the database.
	Table = "charge_flat_fee_run_payments"
	// BillingInvoiceLineTable is the table that holds the billing_invoice_line relation/edge.
	BillingInvoiceLineTable = "charge_flat_fee_run_payments"
	...
	FlatFeeTable = "charge_flat_fee_run_payments"
	...
	RunTable = "charge_flat_fee_run_payments"
...
// Columns holds all SQL columns for chargeflatfeerunpayment fields.
var Columns = []string{
	FieldID,
	FieldLineID,
	FieldInvoiceID,
...
func StatusValidator(s payment.Status) error {
	...
	case "authorized", "settled":
		return nil
	default:
		return fmt.Errorf("chargeflatfeerunpayment: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeeRunPayment queries.
