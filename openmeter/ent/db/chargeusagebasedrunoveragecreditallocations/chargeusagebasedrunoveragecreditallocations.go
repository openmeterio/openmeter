...
const (
	// Label holds the string label denoting the chargeusagebasedrunoveragecreditallocations type in the database.
	Label = "charge_usage_based_run_overage_credit_allocations"
	...
	EdgeRun = "run"
	// Table holds the table name of the chargeusagebasedrunoveragecreditallocations in the database.
	Table = "charge_usage_based_run_overage_credit_allocations"
	// AllocationTable is the table that holds the allocation relation/edge.
	AllocationTable = "charge_usage_based_run_overage_credit_allocations"
	...
	CorrectionsTable = "charge_usage_based_run_overage_credit_allocations"
	...
	RunTable = "charge_usage_based_run_overage_credit_allocations"
...
// Columns holds all SQL columns for chargeusagebasedrunoveragecreditallocations fields.
var Columns = []string{
	FieldID,
	FieldLineID,
	FieldAmount,
...
func TypeValidator(_type creditrealization.Type) error {
	...
	case "allocation", "correction":
		return nil
	default:
		return fmt.Errorf("chargeusagebasedrunoveragecreditallocations: invalid enum value for type field: %q", _type)
	}
}

// OrderOption defines the ordering options for the ChargeUsageBasedRunOverageCreditAllocations queries.
