...
func (_q *LedgerAccountQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LedgerAccountQuery) FirstIDX(ctx context.Context) string {
...
func (_q *LedgerAccountQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LedgerAccountQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *LedgerAccountQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *LedgerAccountQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(ledgeraccount.FieldNamespace).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
...
//
//	client.LedgerAccount.Query().
//		Select(ledgeraccount.FieldNamespace).
//		Scan(ctx, &v)
...
func (_q *LedgerAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(ledgeraccount.Table, ledgeraccount.Columns, sqlgraph.NewFieldSpec(ledgeraccount.FieldID, field.TypeString))
	_spec.From = _q.sql
