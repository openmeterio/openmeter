...
const (
	// Label holds the string label denoting the chargecreditpurchaseinvoicedpayment type in the database.
	Label = "charge_credit_purchase_invoiced_payment"
	...
	// Table holds the table name of the chargecreditpurchaseinvoicedpayment in the database.
	Table = "charge_credit_purchase_invoiced_payments"
	// BillingInvoiceLineTable is the table that holds the billing_invoice_line relation/edge.
	BillingInvoiceLineTable = "charge_credit_purchase_invoiced_payments"
	...
	CreditPurchaseTable = "charge_credit_purchase_invoiced_payments"
...
// Columns holds all SQL columns for chargecreditpurchaseinvoicedpayment fields.
var Columns = []string{
	FieldID,
	FieldLineID,
	FieldInvoiceID,
...
func StatusValidator(s payment.Status) error {
	...
	case "authorized", "settled":
		return nil
	default:
		return fmt.Errorf("chargecreditpurchaseinvoicedpayment: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ChargeCreditPurchaseInvoicedPayment queries.
