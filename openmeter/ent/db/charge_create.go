...
func (_c *ChargeCreate) AddBillingGatheringInvoiceLineIDs(ids ...string) *ChargeCreate {
...
func (_c *ChargeCreate) AddBillingGatheringInvoiceLines(v ...*BillingGatheringInvoiceLine) *ChargeCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
