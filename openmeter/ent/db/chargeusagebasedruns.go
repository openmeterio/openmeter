...
func (*ChargeUsageBasedRuns) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case chargeusagebasedruns.FieldDetailedLinesPresent, chargeusagebasedruns.FieldDetailedLinesIncludeCreditAllocations, chargeusagebasedruns.FieldNoFiatTransactionRequired, chargeusagebasedruns.FieldFiatOverageCreditAllocationCompleted:
