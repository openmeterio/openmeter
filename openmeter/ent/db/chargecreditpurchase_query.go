...
// QueryExternalPayment chains the current query on the "external_payment" edge.
func (_q *ChargeCreditPurchaseQuery) QueryExternalPayment() *ChargeCreditPurchaseExternalPaymentQuery {
	query := (&ChargeCreditPurchaseExternalPaymentClient{config: _q.config}).Query()
...
// QueryCreditGrant chains the current query on the "credit_grant" edge.
func (_q *ChargeCreditPurchaseQuery) QueryCreditGrant() *ChargeCreditPurchaseCreditGrantQuery {
	query := (&ChargeCreditPurchaseCreditGrantClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *ChargeCreditPurchaseQuery) QuerySubscription() *SubscriptionQuery {
...
func (_q *ChargeCreditPurchaseQuery) QuerySubscriptionPhase() *SubscriptionPhaseQuery {
...
func (_q *ChargeCreditPurchaseQuery) QuerySubscriptionItem() *SubscriptionItemQuery {
...
func (_q *ChargeCreditPurchaseQuery) QueryCustomer() *CustomerQuery {
...
func (_q *ChargeCreditPurchaseQuery) QueryCustomCurrency() *CustomCurrencyQuery {
...
// WithExternalPayment tells the query-builder to eager-load the nodes that are connected to
// the "external_payment" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ChargeCreditPurchaseQuery) WithExternalPayment(opts ...func(*ChargeCreditPurchaseExternalPaymentQuery)) *ChargeCreditPurchaseQuery {
	query := (&ChargeCreditPurchaseExternalPaymentClient{config: _q.config}).Query()
...
// WithCreditGrant tells the query-builder to eager-load the nodes that are connected to
// the "credit_grant" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ChargeCreditPurchaseQuery) WithCreditGrant(opts ...func(*ChargeCreditPurchaseCreditGrantQuery)) *ChargeCreditPurchaseQuery {
	query := (&ChargeCreditPurchaseCreditGrantClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeCreditPurchaseQuery) WithSubscription(opts ...func(*SubscriptionQuery)) *ChargeCreditPurchaseQuery {
	query := (&SubscriptionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeCreditPurchaseQuery) WithSubscriptionPhase(opts ...func(*SubscriptionPhaseQuery)) *ChargeCreditPurchaseQuery {
	query := (&SubscriptionPhaseClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeCreditPurchaseQuery) WithSubscriptionItem(opts ...func(*SubscriptionItemQuery)) *ChargeCreditPurchaseQuery {
	query := (&SubscriptionItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeCreditPurchaseQuery) WithCustomer(opts ...func(*CustomerQuery)) *ChargeCreditPurchaseQuery {
	query := (&CustomerClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeCreditPurchaseQuery) WithCustomCurrency(opts ...func(*CustomCurrencyQuery)) *ChargeCreditPurchaseQuery {
	query := (&CustomCurrencyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(chargecreditpurchase.FieldCustomerID).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
...
//
//	client.ChargeCreditPurchase.Query().
//		Select(chargecreditpurchase.FieldCustomerID).
//		Scan(ctx, &v)
...
func (_q *ChargeCreditPurchaseQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChargeCreditPurchase, error) {
	...
	if query := _q.withSubscription; query != nil {
		if err := _q.loadSubscription(ctx, query, nodes, nil,
			func(n *ChargeCreditPurchase, e *Subscription) { n.Edges.Subscription = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSubscriptionPhase; query != nil {
		if err := _q.loadSubscriptionPhase(ctx, query, nodes, nil,
			func(n *ChargeCreditPurchase, e *SubscriptionPhase) { n.Edges.SubscriptionPhase = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSubscriptionItem; query != nil {
		if err := _q.loadSubscriptionItem(ctx, query, nodes, nil,
			func(n *ChargeCreditPurchase, e *SubscriptionItem) { n.Edges.SubscriptionItem = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withCustomCurrency; query != nil {
		if err := _q.loadCustomCurrency(ctx, query, nodes, nil,
			func(n *ChargeCreditPurchase, e *CustomCurrency) { n.Edges.CustomCurrency = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ChargeCreditPurchaseQuery) loadExternalPayment(ctx context.Context, query *ChargeCreditPurchaseExternalPaymentQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *ChargeCreditPurchaseExternalPayment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chargecreditpurchaseexternalpayment.FieldChargeID)
	}
...
func (_q *ChargeCreditPurchaseQuery) loadCreditGrant(ctx context.Context, query *ChargeCreditPurchaseCreditGrantQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *ChargeCreditPurchaseCreditGrant)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*ChargeCreditPurchase)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chargecreditpurchasecreditgrant.FieldChargeID)
	}
	query.Where(predicate.ChargeCreditPurchaseCreditGrant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(chargecreditpurchase.CreditGrantColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ChargeCreditPurchaseQuery) loadCharge(ctx context.Context, query *ChargeQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *Charge)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(charge.FieldChargeCreditPurchaseID)
	}
	query.Where(predicate.Charge(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(chargecreditpurchase.ChargeColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.ChargeCreditPurchaseID
		if fk == nil {
			return fmt.Errorf(`foreign-key "charge_credit_purchase_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "charge_credit_purchase_id" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *ChargeCreditPurchaseQuery) loadSubscription(ctx context.Context, query *SubscriptionQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *Subscription)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeCreditPurchase)
	for i := range nodes {
...
func (_q *ChargeCreditPurchaseQuery) loadSubscriptionPhase(ctx context.Context, query *SubscriptionPhaseQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *SubscriptionPhase)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeCreditPurchase)
	for i := range nodes {
...
func (_q *ChargeCreditPurchaseQuery) loadSubscriptionItem(ctx context.Context, query *SubscriptionItemQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *SubscriptionItem)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeCreditPurchase)
	for i := range nodes {
...
func (_q *ChargeCreditPurchaseQuery) loadCustomer(ctx context.Context, query *CustomerQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *Customer)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeCreditPurchase)
	for i := range nodes {
...
func (_q *ChargeCreditPurchaseQuery) loadCustomCurrency(ctx context.Context, query *CustomCurrencyQuery, nodes []*ChargeCreditPurchase, init func(*ChargeCreditPurchase), assign func(*ChargeCreditPurchase, *CustomCurrency)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeCreditPurchase)
	for i := range nodes {
...
func (_q *ChargeCreditPurchaseQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSubscriptionPhase != nil {
			_spec.Node.AddColumnOnce(chargecreditpurchase.FieldSubscriptionPhaseID)
		}
		if _q.withSubscriptionItem != nil {
			_spec.Node.AddColumnOnce(chargecreditpurchase.FieldSubscriptionItemID)
		}
		...
		if _q.withCustomCurrency != nil {
			_spec.Node.AddColumnOnce(chargecreditpurchase.FieldCustomCurrencyID)
		}
	}
