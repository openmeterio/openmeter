...
func (_c *BillingInvoiceCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if billinginvoice.DefaultCreatedAt == nil {
			return fmt.Errorf("db: uninitialized billinginvoice.DefaultCreatedAt (forgotten import db/runtime?)")
		}
		v := billinginvoice.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if billinginvoice.DefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized billinginvoice.DefaultUpdatedAt (forgotten import db/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if billinginvoice.DefaultID == nil {
			return fmt.Errorf("db: uninitialized billinginvoice.DefaultID (forgotten import db/runtime?)")
		}
