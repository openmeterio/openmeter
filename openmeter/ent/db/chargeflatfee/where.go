...
func HasCreditAllocationsWith(preds ...predicate.ChargeFlatFeeRunCreditAllocations) predicate.ChargeFlatFee {
	return predicate.ChargeFlatFee(func(s *sql.Selector) {
...
func HasDetailedLinesWith(preds ...predicate.ChargeFlatFeeRunDetailedLine) predicate.ChargeFlatFee {
	return predicate.ChargeFlatFee(func(s *sql.Selector) {
...
func HasInvoicedUsageWith(preds ...predicate.ChargeFlatFeeRunInvoicedUsage) predicate.ChargeFlatFee {
	return predicate.ChargeFlatFee(func(s *sql.Selector) {
...
func HasPaymentWith(preds ...predicate.ChargeFlatFeeRunPayment) predicate.ChargeFlatFee {
	return predicate.ChargeFlatFee(func(s *sql.Selector) {
		step := newPaymentStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
