...
type ChargeCreditRealizationEdges struct {
	...
	// StandardInvoiceRealization holds the value of the standard_invoice_realization edge.
	StandardInvoiceRealization *ChargeStandardInvoiceRealization `json:"standard_invoice_realization,omitempty"`
...
// StandardInvoiceRealizationOrErr returns the StandardInvoiceRealization value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e ChargeCreditRealizationEdges) StandardInvoiceRealizationOrErr() (*ChargeStandardInvoiceRealization, error) {
	if e.StandardInvoiceRealization != nil {
		return e.StandardInvoiceRealization, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: chargestandardinvoicerealization.Label}
	}
	return nil, &NotLoadedError{edge: "standard_invoice_realization"}
}
...
// QueryStandardInvoiceRealization queries the "standard_invoice_realization" edge of the ChargeCreditRealization entity.
func (_m *ChargeCreditRealization) QueryStandardInvoiceRealization() *ChargeStandardInvoiceRealizationQuery {
	return NewChargeCreditRealizationClient(_m.config).QueryStandardInvoiceRealization(_m)
}
