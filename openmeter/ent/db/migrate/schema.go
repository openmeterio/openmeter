...
var (
	...
	BillingInvoiceLinesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BillingInvoiceLinesColumns[1], BillingInvoiceLinesColumns[32], BillingInvoiceLinesColumns[34], BillingInvoiceLinesColumns[33]},
			},
		},
	}
	...
	BillingInvoiceUsageBasedLineConfigsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "billing_invoice_usage_based_line_configs_billing_invoice_split_line_groups_usage_based_line_config",
				Columns:    []*schema.Column{BillingInvoiceUsageBasedLineConfigsColumns[8]},
...
func init() {
	...
	BillingInvoiceUsageBasedLineConfigsTable.ForeignKeys[0].RefTable = BillingInvoiceSplitLineGroupsTable
