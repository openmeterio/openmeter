...
var (
	...
	BillingInvoiceLinesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "billing_invoice_lines_billing_invoice_lines_child_lines",
				Columns:    []*schema.Column{BillingInvoiceLinesColumns[19]},
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BillingInvoiceLinesColumns[1], BillingInvoiceLinesColumns[19]},
			},
		},
	}
	...
	CustomerSubjectsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "customersubjects_namespace_customer_id",
				Unique:  false,
				Columns: []*schema.Column{CustomerSubjectsColumns[1], CustomerSubjectsColumns[5]},
			},
			{
				Name:    "customersubjects_namespace_subject_key_deleted_at",
				Unique:  true,
				Columns: []*schema.Column{CustomerSubjectsColumns[1], CustomerSubjectsColumns[2], CustomerSubjectsColumns[4]},
				Annotation: &entsql.IndexAnnotation{
