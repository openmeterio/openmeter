...
// ChargeFlatFeeRunDetailedLine is the model entity for the ChargeFlatFeeRunDetailedLine schema.
...
// to the ChargeFlatFeeRunDetailedLine fields.
func (_m *ChargeFlatFeeRunDetailedLine) assignValues(columns []string, values []any) error {
	if m, n := len(values), len(columns); m < n {
		return fmt.Errorf("mismatch number of scan values: %d != %d", m, n)
	}
	for i := range columns {
		switch columns[i] {
		case chargeflatfeerundetailedline.FieldID:
		...
		case chargeflatfeerundetailedline.FieldServicePeriodEnd:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field service_period_end", values[i])
			} else if value.Valid {
				_m.ServicePeriodEnd = value.Time
			}
		case chargeflatfeerundetailedline.FieldQuantity:
			if value, ok := values[i].(*alpacadecimal.Decimal); !ok {
				return fmt.Errorf("unexpected type %T for field quantity", values[i])
			} else if value != nil {
				_m.Quantity = *value
			}
		case chargeflatfeerundetailedline.FieldInvoicingAppExternalID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case chargeflatfeerundetailedline.FieldCreditsApplied:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case chargeflatfeerundetailedline.FieldAnnotations:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case chargeflatfeerundetailedline.FieldNamespace:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field namespace", values[i])
			} else if value.Valid {
				_m.Namespace = value.String
			}
		case chargeflatfeerundetailedline.FieldMetadata:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case chargeflatfeerundetailedline.FieldCreatedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field created_at", values[i])
			} else if value.Valid {
				_m.CreatedAt = value.Time
			}
		case chargeflatfeerundetailedline.FieldUpdatedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field updated_at", values[i])
			} else if value.Valid {
				_m.UpdatedAt = value.Time
			}
		case chargeflatfeerundetailedline.FieldDeletedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
		...
		case chargeflatfeerundetailedline.FieldName:
			if value, ok := values[i].(*sql.NullString); !ok {
...
// Value returns the ent.Value that was dynamically selected and assigned to the ChargeFlatFeeRunDetailedLine.
...
func (_m *ChargeFlatFeeRunDetailedLine) QueryRun() *ChargeFlatFeeRunQuery {
...
func (_m *ChargeFlatFeeRunDetailedLine) Update() *ChargeFlatFeeRunDetailedLineUpdateOne {
	return NewChargeFlatFeeRunDetailedLineClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the ChargeFlatFeeRunDetailedLine entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *ChargeFlatFeeRunDetailedLine) Unwrap() *ChargeFlatFeeRunDetailedLine {
	_tx, ok := _m.config.driver.(*txDriver)
	if !ok {
		panic("db: ChargeFlatFeeRunDetailedLine is not a transactional entity")
	}
...
func (_m *ChargeFlatFeeRunDetailedLine) String() string {
...
// ChargeFlatFeeRunDetailedLines is a parsable slice of ChargeFlatFeeRunDetailedLine.
type ChargeFlatFeeRunDetailedLines []*ChargeFlatFeeRunDetailedLine
