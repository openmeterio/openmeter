...
const (
	// Label holds the string label denoting the chargeflatfeecostbasis type in the database.
	Label = "charge_flat_fee_cost_basis"
	...
	// Table holds the table name of the chargeflatfeecostbasis in the database.
	Table = "charge_flat_fee_cost_bases"
	// CurrencyCostBasisTable is the table that holds the currency_cost_basis relation/edge.
	CurrencyCostBasisTable = "charge_flat_fee_cost_bases"
	...
	ResolvedCurrencyCostBasisTable = "charge_flat_fee_cost_bases"
	...
	CustomCurrencyTable = "charge_flat_fee_cost_bases"
...
// Columns holds all SQL columns for chargeflatfeecostbasis fields.
var Columns = []string{
	FieldID,
	FieldMode,
	FieldFiatCurrency,
...
func ModeValidator(m costbasis.Mode) error {
	...
	case "dynamic", "pinned", "manual":
		return nil
	default:
		return fmt.Errorf("chargeflatfeecostbasis: invalid enum value for mode field: %q", m)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeeCostBasis queries.
