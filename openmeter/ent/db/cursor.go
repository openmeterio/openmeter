...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *BillingGatheringInvoiceLineQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*BillingGatheringInvoiceLine], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*BillingGatheringInvoiceLine]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*BillingGatheringInvoiceLine]{}, err
	}

	if items == nil {
		items = make([]*BillingGatheringInvoiceLine, 0)
	}

	result := pagination.Result[*BillingGatheringInvoiceLine]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*Charge], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*Charge]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*Charge]{}, err
	}
	...
	result := pagination.Result[*Charge]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeCreditPurchaseCostBasisQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeCreditPurchaseCostBasis], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeCreditPurchaseCostBasis]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeCreditPurchaseCostBasis]{}, err
	}

	if items == nil {
		items = make([]*ChargeCreditPurchaseCostBasis, 0)
	}

	result := pagination.Result[*ChargeCreditPurchaseCostBasis]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeCreditPurchaseCreditGrantQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeCreditPurchaseCreditGrant], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeCreditPurchaseCreditGrant]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeCreditPurchaseCreditGrant]{}, err
	}

	if items == nil {
		items = make([]*ChargeCreditPurchaseCreditGrant, 0)
	}

	result := pagination.Result[*ChargeCreditPurchaseCreditGrant]{
		Items: items,
	}
...
func (_m *ChargeCreditPurchaseExternalPaymentQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeCreditPurchaseExternalPayment], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeCreditPurchaseExternalPayment]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeCreditPurchaseExternalPayment]{}, err
	}

	if items == nil {
		items = make([]*ChargeCreditPurchaseExternalPayment, 0)
	}

	result := pagination.Result[*ChargeCreditPurchaseExternalPayment]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeCreditPurchaseInvoicedPaymentQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeCreditPurchaseInvoicedPayment], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeCreditPurchaseInvoicedPayment]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeCreditPurchaseInvoicedPayment]{}, err
	}

	if items == nil {
		items = make([]*ChargeCreditPurchaseInvoicedPayment, 0)
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeFlatFeeCostBasisQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeFlatFeeCostBasis], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeFlatFeeCostBasis]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeFlatFeeCostBasis]{}, err
	}

	if items == nil {
		items = make([]*ChargeFlatFeeCostBasis, 0)
	}

	result := pagination.Result[*ChargeFlatFeeCostBasis]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeFlatFeeRunQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeFlatFeeRun], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeFlatFeeRun]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeFlatFeeRun]{}, err
	}

	if items == nil {
		items = make([]*ChargeFlatFeeRun, 0)
	}

	result := pagination.Result[*ChargeFlatFeeRun]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeFlatFeeRunCreditAllocationsQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeFlatFeeRunCreditAllocations], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeFlatFeeRunCreditAllocations]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeFlatFeeRunCreditAllocations]{}, err
	}

	if items == nil {
		items = make([]*ChargeFlatFeeRunCreditAllocations, 0)
	}

	result := pagination.Result[*ChargeFlatFeeRunCreditAllocations]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeFlatFeeRunDetailedLineQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeFlatFeeRunDetailedLine], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeFlatFeeRunDetailedLine]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeFlatFeeRunDetailedLine]{}, err
	}

	if items == nil {
		items = make([]*ChargeFlatFeeRunDetailedLine, 0)
	}

	result := pagination.Result[*ChargeFlatFeeRunDetailedLine]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeFlatFeeRunInvoicedUsageQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeFlatFeeRunInvoicedUsage], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeFlatFeeRunInvoicedUsage]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeFlatFeeRunInvoicedUsage]{}, err
	}

	if items == nil {
		items = make([]*ChargeFlatFeeRunInvoicedUsage, 0)
	}

	result := pagination.Result[*ChargeFlatFeeRunInvoicedUsage]{
		Items: items,
	}
...
func (_m *ChargeFlatFeeRunPaymentQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeFlatFeeRunPayment], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeFlatFeeRunPayment]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeFlatFeeRunPayment]{}, err
	}

	if items == nil {
		items = make([]*ChargeFlatFeeRunPayment, 0)
	}

	result := pagination.Result[*ChargeFlatFeeRunPayment]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeUsageBasedCostBasisQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeUsageBasedCostBasis], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeUsageBasedCostBasis]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeUsageBasedCostBasis]{}, err
	}

	if items == nil {
		items = make([]*ChargeUsageBasedCostBasis, 0)
	}

	result := pagination.Result[*ChargeUsageBasedCostBasis]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeUsageBasedRunCreditAllocationsQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeUsageBasedRunCreditAllocations], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeUsageBasedRunCreditAllocations]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeUsageBasedRunCreditAllocations]{}, err
	}

	if items == nil {
		items = make([]*ChargeUsageBasedRunCreditAllocations, 0)
	}

	result := pagination.Result[*ChargeUsageBasedRunCreditAllocations]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeUsageBasedRunDetailedLineQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeUsageBasedRunDetailedLine], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeUsageBasedRunDetailedLine]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeUsageBasedRunDetailedLine]{}, err
	}

	if items == nil {
		items = make([]*ChargeUsageBasedRunDetailedLine, 0)
	}

	result := pagination.Result[*ChargeUsageBasedRunDetailedLine]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeUsageBasedRunInvoicedUsageQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeUsageBasedRunInvoicedUsage], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeUsageBasedRunInvoicedUsage]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeUsageBasedRunInvoicedUsage]{}, err
	}

	if items == nil {
		items = make([]*ChargeUsageBasedRunInvoicedUsage, 0)
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeUsageBasedRunPaymentQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeUsageBasedRunPayment], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeUsageBasedRunPayment]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeUsageBasedRunPayment]{}, err
	}

	if items == nil {
		items = make([]*ChargeUsageBasedRunPayment, 0)
	}

	result := pagination.Result[*ChargeUsageBasedRunPayment]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *ChargeUsageBasedRunsQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*ChargeUsageBasedRuns], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*ChargeUsageBasedRuns]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*ChargeUsageBasedRuns]{}, err
	}

	if items == nil {
		items = make([]*ChargeUsageBasedRuns, 0)
	}
...
func (_m *CreditRealizationLineageQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*CreditRealizationLineage], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*CreditRealizationLineage]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*CreditRealizationLineage]{}, err
	}

	if items == nil {
		items = make([]*CreditRealizationLineage, 0)
	}

	result := pagination.Result[*CreditRealizationLineage]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *CreditRealizationLineageSegmentQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*CreditRealizationLineageSegment], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*CreditRealizationLineageSegment]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*CreditRealizationLineageSegment]{}, err
	}

	if items == nil {
		items = make([]*CreditRealizationLineageSegment, 0)
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *CurrencyCostBasisQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*CurrencyCostBasis], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*CurrencyCostBasis]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*CurrencyCostBasis]{}, err
	}

	if items == nil {
		items = make([]*CurrencyCostBasis, 0)
	}

	result := pagination.Result[*CurrencyCostBasis]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *CustomCurrencyQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*CustomCurrency], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*CustomCurrency]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*CustomCurrency]{}, err
	}

	if items == nil {
		items = make([]*CustomCurrency, 0)
	}

	result := pagination.Result[*CustomCurrency]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *LLMCostPriceQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*LLMCostPrice], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*LLMCostPrice]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*LLMCostPrice]{}, err
	}

	if items == nil {
		items = make([]*LLMCostPrice, 0)
	}

	result := pagination.Result[*LLMCostPrice]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *LedgerBreakageRecordQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*LedgerBreakageRecord], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*LedgerBreakageRecord]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*LedgerBreakageRecord]{}, err
	}

	if items == nil {
		items = make([]*LedgerBreakageRecord, 0)
	}

	result := pagination.Result[*LedgerBreakageRecord]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *LedgerCreditVoidRecordQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*LedgerCreditVoidRecord], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*LedgerCreditVoidRecord]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*LedgerCreditVoidRecord]{}, err
	}

	if items == nil {
		items = make([]*LedgerCreditVoidRecord, 0)
	}

	result := pagination.Result[*LedgerCreditVoidRecord]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *LedgerSubAccountRouteQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*LedgerSubAccountRoute], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*LedgerSubAccountRoute]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*LedgerSubAccountRoute]{}, err
	}

	if items == nil {
		items = make([]*LedgerSubAccountRoute, 0)
	}

	result := pagination.Result[*LedgerSubAccountRoute]{
		Items: items,
	}
...
// Cursor runs the query and returns a cursor-paginated response.
// Ordering is always by created_at asc, id asc.
func (_m *SubscriptionCostBasisPinQuery) Cursor(ctx context.Context, cursor *pagination.Cursor) (pagination.Result[*SubscriptionCostBasisPin], error) {
	if cursor != nil {
		if err := cursor.Validate(); err != nil {
			return pagination.Result[*SubscriptionCostBasisPin]{}, fmt.Errorf("invalid cursor: %w", err)
		}
	...
	items, err := _m.All(ctx)
	if err != nil {
		return pagination.Result[*SubscriptionCostBasisPin]{}, err
	}

	if items == nil {
		items = make([]*SubscriptionCostBasisPin, 0)
	}

	result := pagination.Result[*SubscriptionCostBasisPin]{
		Items: items,
	}
