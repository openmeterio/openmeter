...
func HasBillingGatheringInvoiceLines() predicate.Charge {
	return predicate.Charge(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBillingGatheringInvoiceLinesWith(preds ...predicate.BillingGatheringInvoiceLine) predicate.Charge {
	return predicate.Charge(func(s *sql.Selector) {
