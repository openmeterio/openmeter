...
const (
	...
	StandardInvoiceRealizationsTable = "charge_standard_invoice_realizations"
	...
	StandardInvoiceRealizationsColumn = "charge_id"
...
func TypeValidator(_type charges.IntentType) error {
	switch _type {
...
// ByStandardInvoiceRealizationsCount orders the results by standard_invoice_realizations count.
func ByStandardInvoiceRealizationsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newStandardInvoiceRealizationsStep(), opts...)
	}
}

// ByStandardInvoiceRealizations orders the results by standard_invoice_realizations terms.
func ByStandardInvoiceRealizations(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newStandardInvoiceRealizationsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
