...
const (
	// Label holds the string label denoting the chargeflatfeeruncreditallocations type in the database.
	Label = "charge_flat_fee_run_credit_allocations"
	...
	FlatFeeTable = "charge_flat_fee_run_credit_allocations"
	...
	BillingInvoiceLineTable = "charge_flat_fee_run_credit_allocations"
...
// Columns holds all SQL columns for chargeflatfeeruncreditallocations fields.
var Columns = []string{
	FieldID,
	FieldLineID,
	FieldAmount,
...
func TypeValidator(_type creditrealization.Type) error {
	...
	case "allocation", "correction":
		return nil
	default:
		return fmt.Errorf("chargeflatfeeruncreditallocations: invalid enum value for type field: %q", _type)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeeRunCreditAllocations queries.
