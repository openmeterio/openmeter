...
const (
	// Label holds the string label denoting the chargeflatfeepayment type in the database.
	Label = "charge_flat_fee_payment"
	...
	// Table holds the table name of the chargeflatfeepayment in the database.
	Table = "charge_flat_fee_payments"
	// BillingInvoiceLineTable is the table that holds the billing_invoice_line relation/edge.
	BillingInvoiceLineTable = "charge_flat_fee_payments"
	...
	FlatFeeTable = "charge_flat_fee_payments"
...
// Columns holds all SQL columns for chargeflatfeepayment fields.
var Columns = []string{
	FieldID,
	FieldLineID,
	FieldInvoiceID,
...
func StatusValidator(s payment.Status) error {
	...
	case "authorized", "settled":
		return nil
	default:
		return fmt.Errorf("chargeflatfeepayment: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeePayment queries.
