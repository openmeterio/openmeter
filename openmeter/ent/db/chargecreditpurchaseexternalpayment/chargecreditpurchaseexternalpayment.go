...
const (
	// Label holds the string label denoting the chargecreditpurchaseexternalpayment type in the database.
	Label = "charge_credit_purchase_external_payment"
	...
	// Table holds the table name of the chargecreditpurchaseexternalpayment in the database.
	Table = "charge_credit_purchase_external_payments"
	// CreditPurchaseTable is the table that holds the credit_purchase relation/edge.
	CreditPurchaseTable = "charge_credit_purchase_external_payments"
...
// Columns holds all SQL columns for chargecreditpurchaseexternalpayment fields.
var Columns = []string{
	FieldID,
...
func StatusValidator(s payment.Status) error {
	...
	case "authorized", "settled":
		return nil
	default:
		return fmt.Errorf("chargecreditpurchaseexternalpayment: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ChargeCreditPurchaseExternalPayment queries.
