...
func (_c *EntitlementCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if entitlement.DefaultCreatedAt == nil {
			return fmt.Errorf("db: uninitialized entitlement.DefaultCreatedAt (forgotten import db/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if entitlement.DefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized entitlement.DefaultUpdatedAt (forgotten import db/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if entitlement.DefaultID == nil {
			return fmt.Errorf("db: uninitialized entitlement.DefaultID (forgotten import db/runtime?)")
		}
