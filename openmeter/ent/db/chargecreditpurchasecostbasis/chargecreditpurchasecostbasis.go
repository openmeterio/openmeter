...
const (
	// Label holds the string label denoting the chargecreditpurchasecostbasis type in the database.
	Label = "charge_credit_purchase_cost_basis"
	...
	// Table holds the table name of the chargecreditpurchasecostbasis in the database.
	...
	CurrencyCostBasisTable = "charge_credit_purchase_cost_bases"
	...
	ResolvedCurrencyCostBasisTable = "charge_credit_purchase_cost_bases"
	...
	CustomCurrencyTable = "charge_credit_purchase_cost_bases"
...
// Columns holds all SQL columns for chargecreditpurchasecostbasis fields.
var Columns = []string{
	FieldID,
	FieldMode,
	FieldFiatCurrency,
...
func ModeValidator(m costbasis.Mode) error {
	...
	case "dynamic", "pinned", "manual":
		return nil
	default:
		return fmt.Errorf("chargecreditpurchasecostbasis: invalid enum value for mode field: %q", m)
	}
}

// OrderOption defines the ordering options for the ChargeCreditPurchaseCostBasis queries.
