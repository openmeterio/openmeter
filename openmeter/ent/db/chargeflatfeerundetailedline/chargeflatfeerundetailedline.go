...
const (
	// Label holds the string label denoting the chargeflatfeerundetailedline type in the database.
	...
	TaxCodeTable = "charge_flat_fee_run_detailed_lines"
...
func TaxBehaviorValidator(tb productcatalog.TaxBehavior) error {
	...
	case "inclusive", "exclusive":
		return nil
	default:
		return fmt.Errorf("chargeflatfeerundetailedline: invalid enum value for tax_behavior field: %q", tb)
	}
}
...
func CategoryValidator(c stddetailedline.Category) error {
	...
	case "regular", "commitment":
		return nil
	default:
		return fmt.Errorf("chargeflatfeerundetailedline: invalid enum value for category field: %q", c)
	}
}
...
func PaymentTermValidator(pt productcatalog.PaymentTermType) error {
	...
	case "in_advance", "in_arrears":
		return nil
	default:
		return fmt.Errorf("chargeflatfeerundetailedline: invalid enum value for payment_term field: %q", pt)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeeRunDetailedLine queries.
