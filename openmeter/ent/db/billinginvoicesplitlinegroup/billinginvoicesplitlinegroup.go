...
const (
	...
	// EdgeUsageBasedLineConfig holds the string denoting the usage_based_line_config edge name in mutations.
	EdgeUsageBasedLineConfig = "usage_based_line_config"
	...
	// UsageBasedLineConfigTable is the table that holds the usage_based_line_config relation/edge.
	UsageBasedLineConfigTable = "billing_invoice_usage_based_line_configs"
	// UsageBasedLineConfigInverseTable is the table name for the BillingInvoiceUsageBasedLineConfig entity.
	// It exists in this package in order to avoid circular dependency with the "billinginvoiceusagebasedlineconfig" package.
	UsageBasedLineConfigInverseTable = "billing_invoice_usage_based_line_configs"
	// UsageBasedLineConfigColumn is the table column denoting the usage_based_line_config relation/edge.
	UsageBasedLineConfigColumn = "split_line_group_id"
)
...
// ByUsageBasedLineConfigCount orders the results by usage_based_line_config count.
func ByUsageBasedLineConfigCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newUsageBasedLineConfigStep(), opts...)
	}
}

// ByUsageBasedLineConfig orders the results by usage_based_line_config terms.
func ByUsageBasedLineConfig(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newUsageBasedLineConfigStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newUsageBasedLineConfigStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(UsageBasedLineConfigInverseTable, FieldID),
