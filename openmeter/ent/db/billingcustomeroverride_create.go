...
func (_c *BillingCustomerOverrideCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if billingcustomeroverride.DefaultCreatedAt == nil {
			return fmt.Errorf("db: uninitialized billingcustomeroverride.DefaultCreatedAt (forgotten import db/runtime?)")
		}
		v := billingcustomeroverride.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if billingcustomeroverride.DefaultUpdatedAt == nil {
			return fmt.Errorf("db: uninitialized billingcustomeroverride.DefaultUpdatedAt (forgotten import db/runtime?)")
		}
		v := billingcustomeroverride.DefaultUpdatedAt()
		_c.mutation.SetUpdatedAt(v)
	}
	if _, ok := _c.mutation.ID(); !ok {
		if billingcustomeroverride.DefaultID == nil {
			return fmt.Errorf("db: uninitialized billingcustomeroverride.DefaultID (forgotten import db/runtime?)")
		}
