...
func (_q *ChargeUsageBasedRunsQuery) QueryFeature() *FeatureQuery {
...
func (_q *ChargeUsageBasedRunsQuery) QueryBillingInvoiceLine() *BillingInvoiceLineQuery {
...
// QueryFiatOverageCreditAllocations chains the current query on the "fiat_overage_credit_allocations" edge.
func (_q *ChargeUsageBasedRunsQuery) QueryFiatOverageCreditAllocations() *ChargeUsageBasedRunOverageCreditAllocationsQuery {
...
func (_q *ChargeUsageBasedRunsQuery) QueryDetailedLines() *ChargeUsageBasedRunDetailedLineQuery {
...
func (_q *ChargeUsageBasedRunsQuery) WithFeature(opts ...func(*FeatureQuery)) *ChargeUsageBasedRunsQuery {
	query := (&FeatureClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedRunsQuery) WithBillingInvoiceLine(opts ...func(*BillingInvoiceLineQuery)) *ChargeUsageBasedRunsQuery {
	query := (&BillingInvoiceLineClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithFiatOverageCreditAllocations tells the query-builder to eager-load the nodes that are connected to
// the "fiat_overage_credit_allocations" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ChargeUsageBasedRunsQuery) WithFiatOverageCreditAllocations(opts ...func(*ChargeUsageBasedRunOverageCreditAllocationsQuery)) *ChargeUsageBasedRunsQuery {
	query := (&ChargeUsageBasedRunOverageCreditAllocationsClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withFiatOverageCreditAllocations = query
	return _q
}
...
func (_q *ChargeUsageBasedRunsQuery) WithDetailedLines(opts ...func(*ChargeUsageBasedRunDetailedLineQuery)) *ChargeUsageBasedRunsQuery {
	query := (&ChargeUsageBasedRunDetailedLineClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChargeUsageBasedRunsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChargeUsageBasedRuns, error) {
	...
	if query := _q.withFeature; query != nil {
		if err := _q.loadFeature(ctx, query, nodes, nil,
			func(n *ChargeUsageBasedRuns, e *Feature) { n.Edges.Feature = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withFiatOverageCreditAllocations; query != nil {
		if err := _q.loadFiatOverageCreditAllocations(ctx, query, nodes,
			func(n *ChargeUsageBasedRuns) {
				n.Edges.FiatOverageCreditAllocations = []*ChargeUsageBasedRunOverageCreditAllocations{}
			},
			func(n *ChargeUsageBasedRuns, e *ChargeUsageBasedRunOverageCreditAllocations) {
				n.Edges.FiatOverageCreditAllocations = append(n.Edges.FiatOverageCreditAllocations, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (_q *ChargeUsageBasedRunsQuery) loadFeature(ctx context.Context, query *FeatureQuery, nodes []*ChargeUsageBasedRuns, init func(*ChargeUsageBasedRuns), assign func(*ChargeUsageBasedRuns, *Feature)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBasedRuns)
	for i := range nodes {
...
func (_q *ChargeUsageBasedRunsQuery) loadBillingInvoiceLine(ctx context.Context, query *BillingInvoiceLineQuery, nodes []*ChargeUsageBasedRuns, init func(*ChargeUsageBasedRuns), assign func(*ChargeUsageBasedRuns, *BillingInvoiceLine)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*ChargeUsageBasedRuns)
	for i := range nodes {
...
func (_q *ChargeUsageBasedRunsQuery) loadFiatOverageCreditAllocations(ctx context.Context, query *ChargeUsageBasedRunOverageCreditAllocationsQuery, nodes []*ChargeUsageBasedRuns, init func(*ChargeUsageBasedRuns), assign func(*ChargeUsageBasedRuns, *ChargeUsageBasedRunOverageCreditAllocations)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*ChargeUsageBasedRuns)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chargeusagebasedrunoveragecreditallocations.FieldRunID)
	}
	query.Where(predicate.ChargeUsageBasedRunOverageCreditAllocations(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(chargeusagebasedruns.FiatOverageCreditAllocationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ChargeUsageBasedRunsQuery) loadDetailedLines(ctx context.Context, query *ChargeUsageBasedRunDetailedLineQuery, nodes []*ChargeUsageBasedRuns, init func(*ChargeUsageBasedRuns), assign func(*ChargeUsageBasedRuns, *ChargeUsageBasedRunDetailedLine)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*ChargeUsageBasedRuns)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chargeusagebasedrundetailedline.FieldRunID)
	}
...
func (_q *ChargeUsageBasedRunsQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withFeature != nil {
			_spec.Node.AddColumnOnce(chargeusagebasedruns.FieldFeatureID)
		}
