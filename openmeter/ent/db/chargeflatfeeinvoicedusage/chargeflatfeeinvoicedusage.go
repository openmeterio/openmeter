...
const (
	// Label holds the string label denoting the chargeflatfeeinvoicedusage type in the database.
	Label = "charge_flat_fee_invoiced_usage"
	...
	// Table holds the table name of the chargeflatfeeinvoicedusage in the database.
	Table = "charge_flat_fee_invoiced_usages"
	// BillingInvoiceLineTable is the table that holds the billing_invoice_line relation/edge.
	BillingInvoiceLineTable = "charge_flat_fee_invoiced_usages"
	...
	FlatFeeTable = "charge_flat_fee_invoiced_usages"
...
// Columns holds all SQL columns for chargeflatfeeinvoicedusage fields.
var Columns = []string{
	FieldID,
	FieldLineID,
...
// OrderOption defines the ordering options for the ChargeFlatFeeInvoicedUsage queries.
