...
const (
	// Label holds the string label denoting the chargeflatfeedetailedline type in the database.
	Label = "charge_flat_fee_detailed_line"
	...
	// Table holds the table name of the chargeflatfeedetailedline in the database.
	Table = "charge_flat_fee_detailed_line"
	// ChargeTable is the table that holds the charge relation/edge.
	ChargeTable = "charge_flat_fee_detailed_line"
	...
	TaxCodeTable = "charge_flat_fee_detailed_line"
...
// Columns holds all SQL columns for chargeflatfeedetailedline fields.
var Columns = []string{
	FieldID,
	FieldCurrency,
	FieldTaxConfig,
...
func TaxBehaviorValidator(tb productcatalog.TaxBehavior) error {
	...
	case "inclusive", "exclusive":
		return nil
	default:
		return fmt.Errorf("chargeflatfeedetailedline: invalid enum value for tax_behavior field: %q", tb)
	}
}
...
func CategoryValidator(c stddetailedline.Category) error {
	...
	case "regular", "commitment":
		return nil
	default:
		return fmt.Errorf("chargeflatfeedetailedline: invalid enum value for category field: %q", c)
	}
}
...
func PaymentTermValidator(pt productcatalog.PaymentTermType) error {
	...
	case "in_advance", "in_arrears":
		return nil
	default:
		return fmt.Errorf("chargeflatfeedetailedline: invalid enum value for payment_term field: %q", pt)
	}
}

// OrderOption defines the ordering options for the ChargeFlatFeeDetailedLine queries.
