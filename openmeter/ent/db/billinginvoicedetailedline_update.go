...
func (_u *BillingInvoiceDetailedLineUpdate) SetCategory(v billing.FlatFeeCategory) *BillingInvoiceDetailedLineUpdate {
	_u.mutation.SetCategory(v)
	return _u
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (_u *BillingInvoiceDetailedLineUpdate) SetNillableCategory(v *billing.FlatFeeCategory) *BillingInvoiceDetailedLineUpdate {
	if v != nil {
		_u.SetCategory(*v)
	}
	return _u
...
// SetCategory sets the "category" field.
func (_u *BillingInvoiceDetailedLineUpdateOne) SetCategory(v billing.FlatFeeCategory) *BillingInvoiceDetailedLineUpdateOne {
	_u.mutation.SetCategory(v)
	return _u
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (_u *BillingInvoiceDetailedLineUpdateOne) SetNillableCategory(v *billing.FlatFeeCategory) *BillingInvoiceDetailedLineUpdateOne {
	if v != nil {
		_u.SetCategory(*v)
	}
	return _u
