...
func (prcu *PlanRateCardUpdate) SetDiscounts(pr []productcatalog.Discount) *PlanRateCardUpdate {
...
// SetDiscounts sets the "discounts" field.
func (prcuo *PlanRateCardUpdateOne) SetDiscounts(pr []productcatalog.Discount) *PlanRateCardUpdateOne {
