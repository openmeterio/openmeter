...
func (biu *BillingInvoiceUpdate) SetTaxProviderConfig(pc provider.TaxConfiguration) *BillingInvoiceUpdate {
	biu.mutation.SetTaxProviderConfig(pc)
	return biu
}

// SetNillableTaxProviderConfig sets the "tax_provider_config" field if the given value is not nil.
func (biu *BillingInvoiceUpdate) SetNillableTaxProviderConfig(pc *provider.TaxConfiguration) *BillingInvoiceUpdate {
	if pc != nil {
		biu.SetTaxProviderConfig(*pc)
	}
	return biu
}

// ClearTaxProviderConfig clears the value of the "tax_provider_config" field.
func (biu *BillingInvoiceUpdate) ClearTaxProviderConfig() *BillingInvoiceUpdate {
	biu.mutation.ClearTaxProviderConfig()
	return biu
}
...
func (biu *BillingInvoiceUpdate) SetInvoicingProviderConfig(pc provider.InvoicingConfiguration) *BillingInvoiceUpdate {
	biu.mutation.SetInvoicingProviderConfig(pc)
	return biu
}

// SetNillableInvoicingProviderConfig sets the "invoicing_provider_config" field if the given value is not nil.
func (biu *BillingInvoiceUpdate) SetNillableInvoicingProviderConfig(pc *provider.InvoicingConfiguration) *BillingInvoiceUpdate {
	if pc != nil {
		biu.SetInvoicingProviderConfig(*pc)
	}
	return biu
}

// ClearInvoicingProviderConfig clears the value of the "invoicing_provider_config" field.
func (biu *BillingInvoiceUpdate) ClearInvoicingProviderConfig() *BillingInvoiceUpdate {
	biu.mutation.ClearInvoicingProviderConfig()
	return biu
}
...
func (biu *BillingInvoiceUpdate) SetPaymentProviderConfig(pc provider.PaymentConfiguration) *BillingInvoiceUpdate {
	biu.mutation.SetPaymentProviderConfig(pc)
	return biu
}

// SetNillablePaymentProviderConfig sets the "payment_provider_config" field if the given value is not nil.
func (biu *BillingInvoiceUpdate) SetNillablePaymentProviderConfig(pc *provider.PaymentConfiguration) *BillingInvoiceUpdate {
	if pc != nil {
		biu.SetPaymentProviderConfig(*pc)
	}
	return biu
}

// ClearPaymentProviderConfig clears the value of the "payment_provider_config" field.
func (biu *BillingInvoiceUpdate) ClearPaymentProviderConfig() *BillingInvoiceUpdate {
	biu.mutation.ClearPaymentProviderConfig()
	return biu
}
...
func (biu *BillingInvoiceUpdate) check() error {
	...
	if v, ok := biu.mutation.TaxProviderConfig(); ok {
	...
	if v, ok := biu.mutation.InvoicingProviderConfig(); ok {
		if err := v.Validate(); err != nil {
	...
	if v, ok := biu.mutation.PaymentProviderConfig(); ok {
		if err := v.Validate(); err != nil {
...
func (biu *BillingInvoiceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := biu.mutation.TaxProviderConfig(); ok {
	...
	if biu.mutation.TaxProviderConfigCleared() {
		_spec.ClearField(billinginvoice.FieldTaxProviderConfig, field.TypeString)
	}
	...
	if value, ok := biu.mutation.InvoicingProviderConfig(); ok {
	...
	if biu.mutation.InvoicingProviderConfigCleared() {
		_spec.ClearField(billinginvoice.FieldInvoicingProviderConfig, field.TypeString)
	}
	...
	if value, ok := biu.mutation.PaymentProviderConfig(); ok {
	...
	if biu.mutation.PaymentProviderConfigCleared() {
		_spec.ClearField(billinginvoice.FieldPaymentProviderConfig, field.TypeString)
	}
...
// SetTaxProviderConfig sets the "tax_provider_config" field.
func (biuo *BillingInvoiceUpdateOne) SetTaxProviderConfig(pc provider.TaxConfiguration) *BillingInvoiceUpdateOne {
	biuo.mutation.SetTaxProviderConfig(pc)
	return biuo
}

// SetNillableTaxProviderConfig sets the "tax_provider_config" field if the given value is not nil.
func (biuo *BillingInvoiceUpdateOne) SetNillableTaxProviderConfig(pc *provider.TaxConfiguration) *BillingInvoiceUpdateOne {
	if pc != nil {
		biuo.SetTaxProviderConfig(*pc)
	}
	return biuo
}

// ClearTaxProviderConfig clears the value of the "tax_provider_config" field.
func (biuo *BillingInvoiceUpdateOne) ClearTaxProviderConfig() *BillingInvoiceUpdateOne {
	biuo.mutation.ClearTaxProviderConfig()
	return biuo
}
...
// SetInvoicingProviderConfig sets the "invoicing_provider_config" field.
func (biuo *BillingInvoiceUpdateOne) SetInvoicingProviderConfig(pc provider.InvoicingConfiguration) *BillingInvoiceUpdateOne {
	biuo.mutation.SetInvoicingProviderConfig(pc)
	return biuo
}

// SetNillableInvoicingProviderConfig sets the "invoicing_provider_config" field if the given value is not nil.
func (biuo *BillingInvoiceUpdateOne) SetNillableInvoicingProviderConfig(pc *provider.InvoicingConfiguration) *BillingInvoiceUpdateOne {
	if pc != nil {
		biuo.SetInvoicingProviderConfig(*pc)
	}
	return biuo
}

// ClearInvoicingProviderConfig clears the value of the "invoicing_provider_config" field.
func (biuo *BillingInvoiceUpdateOne) ClearInvoicingProviderConfig() *BillingInvoiceUpdateOne {
	biuo.mutation.ClearInvoicingProviderConfig()
	return biuo
}
...
// SetPaymentProviderConfig sets the "payment_provider_config" field.
func (biuo *BillingInvoiceUpdateOne) SetPaymentProviderConfig(pc provider.PaymentConfiguration) *BillingInvoiceUpdateOne {
	biuo.mutation.SetPaymentProviderConfig(pc)
	return biuo
}

// SetNillablePaymentProviderConfig sets the "payment_provider_config" field if the given value is not nil.
func (biuo *BillingInvoiceUpdateOne) SetNillablePaymentProviderConfig(pc *provider.PaymentConfiguration) *BillingInvoiceUpdateOne {
	if pc != nil {
		biuo.SetPaymentProviderConfig(*pc)
	}
	return biuo
}

// ClearPaymentProviderConfig clears the value of the "payment_provider_config" field.
func (biuo *BillingInvoiceUpdateOne) ClearPaymentProviderConfig() *BillingInvoiceUpdateOne {
	biuo.mutation.ClearPaymentProviderConfig()
	return biuo
}
...
func (biuo *BillingInvoiceUpdateOne) check() error {
	...
	if v, ok := biuo.mutation.TaxProviderConfig(); ok {
		if err := v.Validate(); err != nil {
			return &ValidationError{Name: "tax_provider_config", err: fmt.Errorf(`db: validator failed for field "BillingInvoice.tax_provider_config": %w`, err)}
		}
	}
	...
	if v, ok := biuo.mutation.InvoicingProviderConfig(); ok {
		if err := v.Validate(); err != nil {
			return &ValidationError{Name: "invoicing_provider_config", err: fmt.Errorf(`db: validator failed for field "BillingInvoice.invoicing_provider_config": %w`, err)}
		}
	}
	...
	if v, ok := biuo.mutation.PaymentProviderConfig(); ok {
		if err := v.Validate(); err != nil {
			return &ValidationError{Name: "payment_provider_config", err: fmt.Errorf(`db: validator failed for field "BillingInvoice.payment_provider_config": %w`, err)}
		}
	}
...
func (biuo *BillingInvoiceUpdateOne) sqlSave(ctx context.Context) (_node *BillingInvoice, err error) {
	...
	if value, ok := biuo.mutation.TaxProviderConfig(); ok {
		vv, err := billinginvoice.ValueScanner.TaxProviderConfig.Value(value)
		if err != nil {
			return nil, err
		}
	...
	if biuo.mutation.TaxProviderConfigCleared() {
		_spec.ClearField(billinginvoice.FieldTaxProviderConfig, field.TypeString)
	}
	...
	if value, ok := biuo.mutation.InvoicingProviderConfig(); ok {
		vv, err := billinginvoice.ValueScanner.InvoicingProviderConfig.Value(value)
		if err != nil {
			return nil, err
		}
	...
	if biuo.mutation.InvoicingProviderConfigCleared() {
		_spec.ClearField(billinginvoice.FieldInvoicingProviderConfig, field.TypeString)
	}
	...
	if value, ok := biuo.mutation.PaymentProviderConfig(); ok {
		vv, err := billinginvoice.ValueScanner.PaymentProviderConfig.Value(value)
		if err != nil {
			return nil, err
		}
	...
	if biuo.mutation.PaymentProviderConfigCleared() {
		_spec.ClearField(billinginvoice.FieldPaymentProviderConfig, field.TypeString)
	}
