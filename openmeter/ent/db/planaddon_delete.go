...
func (_d *PlanAddonDelete) Where(ps ...predicate.PlanAddon) *PlanAddonDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *PlanAddonDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *PlanAddonDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *PlanAddonDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the PlanAddonDelete builder.
func (_d *PlanAddonDeleteOne) Where(ps ...predicate.PlanAddon) *PlanAddonDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *PlanAddonDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *PlanAddonDeleteOne) ExecX(ctx context.Context) {
