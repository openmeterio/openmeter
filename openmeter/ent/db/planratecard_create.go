...
func (prcc *PlanRateCardCreate) SetDiscounts(pr []productcatalog.Discount) *PlanRateCardCreate {
...
// SetDiscounts sets the "discounts" field.
func (u *PlanRateCardUpsert) SetDiscounts(v []productcatalog.Discount) *PlanRateCardUpsert {
...
// SetDiscounts sets the "discounts" field.
func (u *PlanRateCardUpsertOne) SetDiscounts(v []productcatalog.Discount) *PlanRateCardUpsertOne {
	return u.Update(func(s *PlanRateCardUpsert) {
		s.SetDiscounts(v)
	})
}
...
// SetDiscounts sets the "discounts" field.
func (u *PlanRateCardUpsertBulk) SetDiscounts(v []productcatalog.Discount) *PlanRateCardUpsertBulk {
	return u.Update(func(s *PlanRateCardUpsert) {
		s.SetDiscounts(v)
	})
}
