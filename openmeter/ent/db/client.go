...
// QueryCustomer queries the customer edge of a BillingInvoiceSplitLineGroup.
func (c *BillingInvoiceSplitLineGroupClient) QueryCustomer(_m *BillingInvoiceSplitLineGroup) *CustomerQuery {
	query := (&CustomerClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(customer.Table, customer.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, billinginvoicesplitlinegroup.CustomerTable, billinginvoicesplitlinegroup.CustomerColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryUsageBasedLineConfig queries the usage_based_line_config edge of a BillingInvoiceSplitLineGroup.
func (c *BillingInvoiceSplitLineGroupClient) QueryUsageBasedLineConfig(_m *BillingInvoiceSplitLineGroup) *BillingInvoiceUsageBasedLineConfigQuery {
	query := (&BillingInvoiceUsageBasedLineConfigClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(billinginvoicesplitlinegroup.Table, billinginvoicesplitlinegroup.FieldID, id),
			sqlgraph.To(billinginvoiceusagebasedlineconfig.Table, billinginvoiceusagebasedlineconfig.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, billinginvoicesplitlinegroup.UsageBasedLineConfigTable, billinginvoicesplitlinegroup.UsageBasedLineConfigColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QuerySplitLineGroup queries the split_line_group edge of a BillingInvoiceUsageBasedLineConfig.
func (c *BillingInvoiceUsageBasedLineConfigClient) QuerySplitLineGroup(_m *BillingInvoiceUsageBasedLineConfig) *BillingInvoiceSplitLineGroupQuery {
	query := (&BillingInvoiceSplitLineGroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(billinginvoiceusagebasedlineconfig.Table, billinginvoiceusagebasedlineconfig.FieldID, id),
