...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.NotificationEventDeliveryStatus, c.NotificationRule, c.Subscription,
...
type (
	hooks struct {
		...
		NotificationRule, Subscription, SubscriptionPatch,
		SubscriptionPatchValueAddItem, SubscriptionPatchValueAddPhase,
		SubscriptionPatchValueExtendPhase, UsageReset []ent.Hook
	}
	inters struct {
		App, AppCustomer, AppStripe, AppStripeCustomer, BalanceSnapshot,
		BillingCustomerOverride, BillingInvoice, BillingInvoiceItem, BillingProfile,
		...
		NotificationRule, Subscription, SubscriptionPatch,
		SubscriptionPatchValueAddItem, SubscriptionPatchValueAddPhase,
		SubscriptionPatchValueExtendPhase, UsageReset []ent.Interceptor
	}
)
