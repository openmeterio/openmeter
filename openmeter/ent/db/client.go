...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.BillingInvoiceItem, c.BillingProfile, c.BillingWorkflowConfig,
		c.BillingWorkflowConfigOverride, c.Customer, c.CustomerSubjects, c.Entitlement,
...
type (
	hooks struct {
		...
		BillingProfile, BillingWorkflowConfig, BillingWorkflowConfigOverride, Customer,
