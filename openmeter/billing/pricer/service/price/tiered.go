...
func (p Tiered) GenerateDetailedLines(l PricerCalculateInput) (pricer.DetailedLines, error) {
...
func (p Tiered) ResolveBillablePeriod(in pricer.ResolveBillablePeriodInput) (*timeutil.ClosedPeriod, error) {
