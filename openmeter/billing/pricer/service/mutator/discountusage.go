...
func (m *DiscountUsage) Mutate(l price.PricerCalculateInput) (price.PricerCalculateInput, error) {
...
func (m *DiscountUsage) removeUsageDiscounts(l price.PricerCalculateInput) price.PricerCalculateInput {
...
func (m *DiscountUsage) getUsageDiscount(l price.PricerCalculateInput) (*usageDiscountWithChildUniqueReferenceID, error) {
	...
	return &usageDiscountWithChildUniqueReferenceID{
		...
		childUniqueReferenceID: fmt.Sprintf(pricer.RateCardDiscountChildUniqueReferenceID, rcUsageDiscount.CorrelationID),
	}, nil
}
