...
func (s *service) ResolveBillablePeriod(in pricer.ResolveBillablePeriodInput) (*timeutil.ClosedPeriod, error) {
	...
	billablePeriod, err := linePricer.ResolveBillablePeriod(pricer.ResolveBillablePeriodInput{
		AsOf:               in.AsOf,
...
func isDependingOnIncreaseOnlyMeters(in pricer.ResolveBillablePeriodInput) (bool, error) {
