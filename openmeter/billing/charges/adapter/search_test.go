...
func (s *ListCustomersToAdvanceSuite) insertCreditPurchaseWithGrant(
	namespace string,
	customerID string,
...
func (s *ListCustomersToAdvanceSuite) TestListFundedCreditActivities_PaginatesWithAfter() {
	ctx := context.Background()
	...
	page1, err := s.adapter.ListFundedCreditActivities(ctx, charges.ListFundedCreditActivitiesInput{
	...
	page2, err := s.adapter.ListFundedCreditActivities(ctx, charges.ListFundedCreditActivitiesInput{
		Customer: customerRef,
		Limit:    2,
...
func (s *ListCustomersToAdvanceSuite) TestListFundedCreditActivities_PaginatesWithBefore() {
	ctx := context.Background()
	...
	initialPage, err := s.adapter.ListFundedCreditActivities(ctx, charges.ListFundedCreditActivitiesInput{
		Customer: customerRef,
		Limit:    2,
	})
	s.Require().NoError(err)
	...
	page1, err := s.adapter.ListFundedCreditActivities(ctx, charges.ListFundedCreditActivitiesInput{
		Customer: customerRef,
		Limit:    2,
		Before: &charges.FundedCreditActivityCursor{
	...
	pageForward, err := s.adapter.ListFundedCreditActivities(ctx, charges.ListFundedCreditActivitiesInput{
		Customer: customerRef,
		Limit:    2,
		After:    page1.NextCursor,
	})
...
func (s *ListCustomersToAdvanceSuite) TestListFundedCreditActivities_FiltersByCurrency() {
	ctx := context.Background()
	...
	result, err := s.adapter.ListFundedCreditActivities(ctx, charges.ListFundedCreditActivitiesInput{
