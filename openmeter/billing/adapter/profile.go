...
func (a adapter) CreateProfile(ctx context.Context, input billing.CreateProfileInput) (*billing.AdapterProfile, error) {
	if a.tx == nil {
...
func (a adapter) GetProfile(ctx context.Context, input billing.GetProfileInput) (*billing.AdapterProfile, error) {
	if err := input.Validate(); err != nil {
		return nil, err
	}
...
func (a adapter) GetDefaultProfile(ctx context.Context, input billing.GetDefaultProfileInput) (*billing.AdapterProfile, error) {
	if err := input.Validate(); err != nil {
		return nil, err
	}
...
func (a adapter) UpdateProfile(ctx context.Context, input billing.UpdateProfileAdapterInput) (*billing.AdapterProfile, error) {
	if a.tx == nil {
...
func mapProfileFromDB(dbProfile *db.BillingProfile) (*billing.AdapterProfile, error) {
	if dbProfile == nil {
		return nil, nil
	}
