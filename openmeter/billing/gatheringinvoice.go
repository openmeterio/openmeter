...
type CreatePendingInvoiceLine struct {
	...
	// BypassFeatureMeterValidation skips feature-meter validation when creating the
	// pending line. The line engine owns subsequent handling of unresolved dependencies.
