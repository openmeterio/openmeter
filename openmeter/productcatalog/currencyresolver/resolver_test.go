...
func (m mockCurrencyService) GetCurrency(context.Context, currencies.GetCurrencyInput) (currencies.Currency, error) {
	return currencies.Currency{}, errors.New("not implemented")
}
...
func (m mockCurrencyService) GetCostBasis(context.Context, currencies.GetCostBasisInput) (currencies.CostBasis, error) {
	return currencies.CostBasis{}, errors.New("not implemented")
}

func TestResolverResolveCustomCurrencyIgnoresArchivedResources(t *testing.T) {
	deletedAt := time.Now()
	archived := currencytestutils.NewManagedCurrency(t, "ns", "archived", "CREDITS")
	archived.DeletedAt = &deletedAt
	active := currencytestutils.NewManagedCurrency(t, "ns", "active", "CREDITS")
...
func TestResolverResolveCustomCurrencyRejectsArchivedResource(t *testing.T) {
	...
	archived.DeletedAt = &deletedAt
	service := mockCurrencyService{
		currencies: []currencies.Currency{archived},
	}
