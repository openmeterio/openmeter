...
func NewTestEnv(t *testing.T) *TestEnv {
	...
	require.NoErrorf(t, meterAdapter.SetDBClient(client), "setting meter DB client must not fail")
	...
	require.NoErrorf(t, err, "initializing org defaults adapter must not fail")
