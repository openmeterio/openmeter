...
func (h *handler) AppStripeWebhook() AppStripeWebhookHandler {
	return httptransport.NewHandlerWithArgs(
		...
		func(ctx context.Context, request AppStripeWebhookRequest) (AppStripeWebhookResponse, error) {
			return HandleAppStripeWebhookRequest(ctx, request, h.service)
		},
...
func HandleAppStripeWebhookRequest(ctx context.Context, request AppStripeWebhookRequest, stripeService appstripe.Service) (AppStripeWebhookResponse, error) {
	...
	case stripeclient.WebhookEventTypeSetupIntentSucceeded:
		...
		out, err := stripeService.HandleSetupIntentSucceeded(ctx,
	...
	case stripeclient.WebhookEventTypeInvoiceFinalizationFailed:
		...
		err = stripeService.HandleInvoiceStateTransition(ctx, appstripeentity.HandleInvoiceStateTransitionInput{
			AppID:   request.AppID,
			Invoice: invoice,
	...
	case stripeclient.WebhookEventTypeInvoiceSent:
		...
		err = stripeService.HandleInvoiceSentEvent(ctx, appstripeentity.HandleInvoiceSentEventInput{
			AppID:   request.AppID,
			Invoice: invoice,
