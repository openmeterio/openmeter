        ...
        devenv.shells = {
          default = {
            ...
            packages = with pkgs; [
              ...
              # $ nix-shell -p nix-prefetch-git jq --run "nix hash convert sha256:\$(nix-prefetch-git --url https://github.com/confluentinc/librdkafka.git --quiet --rev v2.10.1 | jq -r '.sha256')"
