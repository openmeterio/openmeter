...
update-openapi: ## Update OpenAPI spec
	$(call print-target)
	dagger call --source . generate openapi -o ./api/openapi.yaml
	dagger call --source . generate openapicloud -o ./api/openapi.cloud.yaml
	go generate ./api/...
...
migrate-check: ## Validate migrations
	$(call print-target)
	dagger call --source . migrate check
