...
func initializeApplication(ctx context.Context, conf config.Configuration) (Application, func(), error) {
	...
	billingService, err := common.BillingService(logger, service, adapter, customerService, entitlement, featureConnector, meterService, connector, eventbusPublisher, billingConfiguration, subscriptionServiceWithWorkflow, billingFeatureSwitchesConfiguration, tracer)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
