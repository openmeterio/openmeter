...
func initializeApplication(ctx context.Context, conf config.Configuration) (Application, func(), error) {
	...
	subscriptionServiceWithWorkflow, err := common.NewSubscriptionServices(logger, client, featureConnector, entitlement, customerService, currencyResolver, planService, planaddonService, addonService, eventbusPublisher, locker, ffxService, taxcodeService)
	if err != nil {
		cleanup7()
		cleanup6()
		cleanup5()
