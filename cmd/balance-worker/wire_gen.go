...
func initializeApplication(ctx context.Context, conf config.Configuration) (Application, func(), error) {
	...
	v4 := conf.Svix
	handler, err := common.NewNotificationWebhookHandler(logger, tracer, webhookConfiguration, v4)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
	...
	eventHandler, cleanup7, err := common.NewNotificationEventHandler(logger, tracer, repository, handler)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
	...
	workerOptions := common.NewBalanceWorkerOptions(eventsConfiguration, options, eventbusPublisher, entitlement, balanceWorkerEntitlementRepo, notificationService, subjectService, customerService, logger, filterStateStorage)
