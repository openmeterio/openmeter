...
export interface components {
  schemas: {
    ...
    NotificationRuleBalanceThresholdCreateRequest: components['schemas']['GenericNotificationRuleCreateRequest'] & {
      ...
      /**
       * @description Optional field for defining the scope of notification by feature.
       * @example [
       *   "gpt4_tokens"
       * ]
       */
    ...
    NotificationRuleBalanceThreshold: components['schemas']['GenericNotificationRule'] & {
      ...
      thresholds: components['schemas']['NotificationRuleBalanceThresholdValue'][]
      /**
       * @description Optional field for scoping notification based by features.
       * @example [
       *   "gpt4_tokens"
       * ]
       */
    ...
    NotificationEvent: {
      ...
      ruleId: string
      /**
       * @description The identifier of the feature defined in notification rule triggered this event.
       * @example 01ARZ3NDEKTSV4RRFFQ69G5FAV
       */
      featureId?: string
      /**
    ...
    NotificationEventPayload: {
      /**
       * @description A unique identifier for the notification event.
       * @example 01J34ZDJC70G3NP8TK1ZY6A297
       */
      id: string
      /**
       * @description The type of teh notification rule generated this event.
       * @example entitlements.balance.threshold
       */
      type: string
      /** @description Metadata information releted to the event. */
      metadata?: {
        [key: string]: unknown
      } | null
      /**
