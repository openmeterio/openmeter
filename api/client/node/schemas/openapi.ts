...
export interface paths {
  ...
  '/api/v1/billing/invoices/{customerId}': {
     ...
     */
    get: operations['listInvoicesByCustomer']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/api/v1/billing/invoices/{customerId}/invoice': {
    parameters: {
      query?: never
      header?: never
      path?: never
  ...
  '/api/v1/billing/invoices/{customerId}/lines': {
     ...
     */
    post: operations['createInvoiceLineByCustomer']
    delete?: never
    options?: never
    head?: never
    patch?: never
...
export interface components {
  schemas: {
    ...
    InvoiceLineCreate:
      | components['schemas']['InvoiceUsageBasedLineCreate']
      | components['schemas']['InvoiceFlatFeeLineCreate']
