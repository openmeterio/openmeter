...
class PortalOperations:  # pylint: disable=docstring-missing-param
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.portal_tokens = PortalPortalTokensOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.portal_meters = PortalPortalMetersOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
...
class AppsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get(self, id: str, **kwargs: Any) -> "_unions.App":
        """Get app.
    ...
    async def update(self, id: str, app: "_unions.AppReplaceUpdate", **kwargs: Any) -> "_unions.App":
        """Update app.
...
class AppStripeOperations:  # pylint: disable=docstring-missing-param
    ...
    async def webhook(
        ...
        _request = build_app_stripe_webhook_request(
            id=id,
            content_type=content_type,
            content=_content,
            headers=_headers,
    ...
    async def create_checkout_session(
        ...
        **kwargs: Any
        ...
        _request = build_app_stripe_create_checkout_session_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
...
class CustomersOperations:  # pylint: disable=docstring-missing-param
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        _request = build_customers_update_request(
            customer_id_or_key=customer_id_or_key,
            content_type=content_type,
            content=_content,
            headers=_headers,
    ...
    async def delete(self, customer_id_or_key: "_unions.ULIDOrExternalKey", **kwargs: Any) -> None:
        """Delete customer.
...
class PlansOperations:  # pylint: disable=docstring-missing-param
    ...
    async def create(
        self, request: Union[_models.PlanCreate, _types.PlanCreate, IO[bytes]], **kwargs: Any
    ) -> _models.Plan:
        """Create a plan.
        ...
        _request = build_plans_create_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
    ...
    async def update(
        ...
        _request = build_plans_update_request(
            plan_id=plan_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class PlanAddonsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def create(
        ...
        _request = build_plan_addons_create_request(
            plan_id=plan_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        _request = build_plan_addons_update_request(
            plan_id=plan_id,
...
class AddonsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def create(
        ...
        _request = build_addons_create_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        _request = build_addons_update_request(
            addon_id=addon_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class SubscriptionsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def create(self, body: "_unions.SubscriptionCreate", **kwargs: Any) -> _models.Subscription:
        """Create subscription.
    ...
    async def edit(
        ...
        **kwargs: Any
        ...
        _request = build_subscriptions_edit_request(
            subscription_id=subscription_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
    ...
    async def migrate(
        ...
        **kwargs: Any
        ...
        Migrates a running subscription to a later version of its current plan. If billingAnchor is
        omitted or unchanged, the subscription is amended in place. Unchanged items retain their
        service periods. Changed or removed items end at the effective time; replacements and additions
        start from that time. For in-place migrations, existing addons must be compatible with the
        target plan version. The phase timeline, billing anchor, and subscription-level billing
        settings are preserved. Both response entries refer to the same subscription: current is the
        before snapshot and next is the amended view. Providing a different billingAnchor uses
        subscription change: the current subscription ends and a replacement starts at the effective
        time. This resets the phase timeline and can produce billing adjustments. Addons are not
    ...
    async def cancel(
        ...
        _request = build_subscriptions_cancel_request(
            subscription_id=subscription_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class EntitlementsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get(self, entitlement_id: str, **kwargs: Any) -> "_unions.Entitlement":
...
class SubjectsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get(self, subject_id_or_key: str, entitlement_id: str, **kwargs: Any) -> "_unions.Entitlement":
    ...
    async def reset(
        ...
        **kwargs: Any
        ...
        _request = build_subjects_reset_request(
            subject_id_or_key=subject_id_or_key,
            entitlement_id=entitlement_id,
            content_type=content_type,
            content=_content,
...
class CustomerStripeOperations:  # pylint: disable=docstring-missing-param
    ...
    async def upsert(
        ...
        **kwargs: Any
        ...
        _request = build_customer_stripe_upsert_request(
            customer_id_or_key=customer_id_or_key,
            content_type=content_type,
            content=_content,
            headers=_headers,
    ...
    async def create_portal_session(
        ...
        **kwargs: Any
        ...
        _request = build_customer_stripe_create_portal_session_request(
            customer_id_or_key=customer_id_or_key,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class MarketplaceOperations:  # pylint: disable=docstring-missing-param
    ...
    async def install_with_api_key(
        ...
        **kwargs: Any
        ...
        _request = build_marketplace_install_with_api_key_request(
            type=type,
            content_type=content_type,
            content=_content,
            headers=_headers,
    ...
    async def install(
        ...
        **kwargs: Any
        ...
        _request = build_marketplace_install_request(
            type=type,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class AppCustomInvoicingOperations:  # pylint: disable=docstring-missing-param
    ...
    async def draft_syncronized(
        ...
        **kwargs: Any
        ...
        _request = build_app_custom_invoicing_draft_syncronized_request(
    ...
    async def payment_status(
        ...
        **kwargs: Any
        ...
        _request = build_app_custom_invoicing_payment_status_request(
            invoice_id=invoice_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class EventsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def ingest_event(self, body: Union[_models.Event, _types.Event, IO[bytes]], **kwargs: Any) -> None:
        """Ingest events.
    ...
    async def ingest_events_json(self, body: "_unions.IngestEventsBody", **kwargs: Any) -> None:
        """ingest_events_json.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        async def extract_data(pipeline_response):
            ...
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextCursor") or None, AsyncList(list_of_elem)
...
class MetersOperations:  # pylint: disable=docstring-missing-param
    ...
    async def create(
        self, meter: Union[_models.MeterCreate, _types.MeterCreate, IO[bytes]], **kwargs: Any
    ) -> _models.Meter:
        """Create meter.
...
class NotificationChannelsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get(self, channel_id: str, **kwargs: Any) -> "_unions.NotificationChannel":
...
class NotificationRulesOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~openmeter.aio.OpenMeterClient`'s
        :attr:`notification_rules` attribute.
    """
    ...
    async def create(
        self, request: "_unions.NotificationRuleCreateRequest", **kwargs: Any
    ) -> "_unions.NotificationRule":
        """Create a notification rule.
    ...
    async def get(self, rule_id: str, **kwargs: Any) -> "_unions.NotificationRule":
...
class NotificationEventsOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~openmeter.aio.OpenMeterClient`'s
        :attr:`notification_events` attribute.
    """
...
class EntitlementsV2Operations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~openmeter.aio.OpenMeterClient`'s
        :attr:`entitlements_v2` attribute.
    """
    ...
    async def get(self, entitlement_id: str, **kwargs: Any) -> "_unions.EntitlementV2":
        """Get entitlement by ID.
...
class CustomerEntitlementsV2Operations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~openmeter.aio.OpenMeterClient`'s
        :attr:`customer_entitlements_v2` attribute.
    """
...
class CustomerEntitlementV2Operations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~openmeter.aio.OpenMeterClient`'s
        :attr:`customer_entitlement_v2` attribute.
    """
    ...
    async def reset_customer_entitlement(
        ...
        **kwargs: Any
        ...
        _request = build_customer_entitlement_v2_reset_customer_entitlement_request(
            customer_id_or_key=customer_id_or_key,
            entitlement_id_or_feature_key=entitlement_id_or_feature_key,
            content_type=content_type,
            content=_content,
...
class CustomerOverridesOperations:  # pylint: disable=docstring-missing-param
    ...
    async def upsert(
        ...
        **kwargs: Any
        ...
        _request = build_customer_overrides_upsert_request(
            customer_id=customer_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class InvoiceOperations:  # pylint: disable=docstring-missing-param
    ...
    async def update_invoice(
        ...
        **kwargs: Any
        ...
        _request = build_invoice_update_invoice_request(
            invoice_id=invoice_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class CustomerInvoiceOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~openmeter.aio.OpenMeterClient`'s
        :attr:`customer_invoice` attribute.
    """
    ...
    async def simulate_invoice(
        ...
        **kwargs: Any
        ...
        _request = build_customer_invoice_simulate_invoice_request(
            customer_id=customer_id,
            content_type=content_type,
            content=_content,
            headers=_headers,
...
class PortalPortalTokensOperations:  # pylint: disable=docstring-missing-param
    ...
    async def create(
        ...
        _request = build_portal_portal_tokens_create_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
    ...
    async def invalidate(
        ...
        **kwargs: Any
        ...
        _request = build_portal_portal_tokens_invalidate_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
