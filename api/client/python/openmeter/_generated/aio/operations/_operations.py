...
class FeaturesOperations:
    ...
    async def query_feature_cost(
        ...
        **kwargs: Any
        ...
        For features with manual unit cost, the cost is usage × fixed amount. For features with LLM
        unit cost, the cost is resolved per row from the LLM cost database. The feature must have a
        meter and unit cost configured.
