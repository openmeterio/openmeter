...
SubscriptionErrorExtensions = "_models.SubscriptionBadRequestErrorResponseExtensions"
...
ListEntitlementsResult = Union[list["_unions.Entitlement"], "_models.EntitlementPaginatedResponse"]
