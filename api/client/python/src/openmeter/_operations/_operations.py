...
def build_get_meter_values_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/api/v1/meters/{meterIdOrSlug}/values"
    path_format_arguments = {
        "meterIdOrSlug": _SERIALIZER.url("meter_id_or_slug", meter_id_or_slug, "str"),
    }
...
class ClientOperationsMixin(ClientMixinABC):
    ...
    def list_meters(self, *, om_namespace: Optional[str] = None, **kwargs: Any) -> List[JSON]:
        ...
        request = build_list_meters_request(
            om_namespace=om_namespace,
            headers=_headers,
            params=_params,
        )
    ...
    def create_meter(self, body: Union[JSON, IO], *, om_namespace: Optional[str] = None, **kwargs: Any) -> JSON:
        ...
        request = build_create_meter_request(
            om_namespace=om_namespace,
            content_type=content_type,
            json=_json,
            content=_content,
    ...
    def get_meter(self, meter_id_or_slug: str, *, om_namespace: Optional[str] = None, **kwargs: Any) -> JSON:
        ...
        request = build_get_meter_request(
    ...
    def delete_meter(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_delete_meter_request(
            meter_id_or_slug=meter_id_or_slug,
            om_namespace=om_namespace,
            headers=_headers,
            params=_params,
    ...
    def get_meter_values(
        ...
        **kwargs: Any
        ...
        request = build_get_meter_values_request(
            meter_id_or_slug=meter_id_or_slug,
            om_namespace=om_namespace,
            subject=subject,
    ...
    def query_meter(
        ...
        **kwargs: Any
        ...
        request = build_query_meter_request(
            meter_id_or_slug=meter_id_or_slug,
            om_namespace=om_namespace,
            from_parameter=from_parameter,
            to=to,
    ...
    def list_meter_subjects(
        ...
        request = build_list_meter_subjects_request(
            meter_id_or_slug=meter_id_or_slug,
            om_namespace=om_namespace,
            headers=_headers,
            params=_params,
    ...
    def create_namespace(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_create_namespace_request(
            content_type=content_type,
            json=_json,
            content=_content,
            headers=_headers,
