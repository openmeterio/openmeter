...
def main() -> None:
    try:
        ...
        subscription = client.subscriptions.create(subscription_create)
        ...
        retrieved_subscription = client.subscriptions.get_expanded(subscription.id)
        ...
        subscriptions_response = client.customers.list_customer_subscriptions(
