...
export interface components {
  schemas: {
    ...
    BillingCustomerWorkflowOverride: {
       ...
       */
      collectionAlignment?: components['schemas']['BillingWorkflowCollectionAlignment']
      /**
       * Format: ISO8601
       * @description The period for collecting the pending line items into an invoice.
       * @default PT1H
       * @example P1D
       */
      itemCollectionPeriod?: string
      invoice?: components['schemas']['BillingWorkflowInvoice']
      /**
       * ID
       * @description A unique identifier for the resource.
       * @example 01G65Z755AFWAKHE12NY0CQ9FH
    ...
    BillingProfileCreateInput: {
      ...
      /** Is this the default profile? */
      default: boolean
      workflow: components['schemas']['BillingWorkflowCreateInput']
    }
    /**
     * @description ProfileOrderBy specifies the ordering options for profiles
     * @enum {string}
     */
    BillingProfileOrderBy: 'createdAt' | 'updatedAt'
    /** @enum {string} */
    ...
    BillingWorkflowAppReference: {
      /**
       * The ID of the app, if not specified the type is used to find the default app
       * @description ULID (Universally Unique Lexicographically Sortable Identifier).
       * @example 01G65Z755AFWAKHE12NY0CQ9FH
       */
      id?: string
      /** The type of the app, if specified the default app is used */
    ...
    /** @description WorkflowCreate represents the workflow settings for creation of a billing profile */
    BillingWorkflowCreateInput: {
      /**
       * @description When to collect the pending line items into an invoice.
       * @default subscription
       */
      ...
      itemCollectionPeriod?: string
      invoice?: components['schemas']['BillingWorkflowInvoice']
      taxApp?: components['schemas']['BillingWorkflowAppReference']
      invoicingApp?: components['schemas']['BillingWorkflowAppReference']
      paymentApp?: components['schemas']['BillingWorkflowAppReference']
    }
    /**
     * Workflow invoice settings
     * @description WorkflowInvoice represents the invoice settings for a billing workflow
     */
    BillingWorkflowInvoice: {
      /**
      ...
      dueAfter?: string
      /**
       * @description The method to collect the invoice.
       * @default charge_automatically
       */
      collectionMethod?: components['schemas']['BillingWorkflowCollectionMethod']
      /**
       * @description The resolution of the line items in the invoice.
       * @default period
       */
      itemResolution?: components['schemas']['BillingWorkflowItemResolution']
      /**
       * @description Whether to create one line item per subject in the invoice.
       * @default true
       */
    ...
    /**
     * Item resolution
     * @description ItemResolution specifies how the line items should be resolved in the invoice
     * @enum {string}
     */
    BillingWorkflowItemResolution: 'day' | 'period'
    ...
    Discount:
      ...
      | components['schemas']['DiscountAmount']
    ...
    /** @description Common fields of the rate card. */
    RateCardBase: {
      /**
       * ID
       * @description A unique identifier for the resource.
       ...
       */
      type: components['schemas']['RateCardType']
      /**
       * Feature key
    ...
    RateCardFlatFee: WithRequired<
      {
        ...
        /**
         * Discount
         * @description The discount of the rate card. Either a percentage or an amount.
         * Only available when price is set.
         */
        discount?:
          | components['schemas']['DiscountPercentage']
          | components['schemas']['DiscountAmount']
      } & components['schemas']['RateCardBase'],
      'type' | 'billingCandence' | 'price'
    >
    ...
    RateCardUsageBased: WithRequired<
      {
        /** @enum {string} */
        type: 'usage_based'
        /**
        ...
        } & Omit<components['schemas']['Discount'], 'type'>
      } & components['schemas']['RateCardBase'],
      'type' | 'billingCandence' | 'price'
    >
    /**
