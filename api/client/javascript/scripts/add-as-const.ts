...
function addAsConstAssertions() {
  ...
  for (const statement of variableStatements) {
    ...
    for (const declaration of declarations) {
      ...
      // // Special-case: union default for BillingWorkflowCollectionAlignment is missing in OAPI and becomes {}
      // // Patch those constants to a concrete default literal expected by Zod and consumers.
      // if (
      //   name === 'createBillingProfileBodyWorkflowCollectionAlignmentDefault' ||
      //   name === 'updateBillingProfileBodyWorkflowCollectionAlignmentDefault'
      // ) {
      //   declaration.setInitializer("{ type: 'subscription' } as const")
      //   transformationCount++
      //   continue
      // }
