export interface paths {
  ...
  '/types': {
    ...
    /** Exports tree shaken types we want to export which are then hidden from the API docs. This API doesn't actually exist or return anything, it's just used for exporting tree-shaken types through codegeneration and SDKs */
    get: operations['Exports_exports']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  Exports_exports: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': {
            errorExtension: components['schemas']['ErrorExtension']
          }
        }
      }
    }
