...
export const queryFeatureCostQueryClientIdMax = 36

export const queryFeatureCostQueryWindowTimeZoneDefault = 'UTC'
export const queryFeatureCostQueryFilterCustomerIdMax = 100
