...
export const listAddonsQueryPageDefault = 1;export const listAddonsQueryPageSizeDefault = 100;
export const listAddonsQueryPageSizeMax = 1000;


export const listAddonsQueryParams = zod.object({
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted add-ons in response.\n\nUsage: `?includeDeleted=true`'),
...
export const createAddonBodyCurrencyDefault = "USD";export const createAddonBodyRateCardsItemKeyMax = 64;
...
export const createAddonBodyRateCardsItemEntitlementTemplateIsSoftLimitDefault = false;export const createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMin = 0;
...
export const createAddonBodyRateCardsItemEntitlementTemplatePreserveOverageAtResetDefault = false;export const createAddonBodyRateCardsItemTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const createAddonBodyRateCardsItemPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const createAddonBodyRateCardsItemPricePaymentTermDefault = "in_advance";export const createAddonBodyRateCardsItemDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createAddonBodyRateCardsItemEntitlementTemplateIsSoftLimitDefaultOne = false;export const createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const createAddonBodyRateCardsItemEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const createAddonBodyRateCardsItemTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const createAddonBodyRateCardsItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const createAddonBodyRateCardsItemPricePaymentTermDefaultTwo = "in_advance";export const createAddonBodyRateCardsItemPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createAddonBodyRateCardsItemPriceMultiplierDefault = "1";export const createAddonBodyRateCardsItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createAddonBody = zod.object({
  ...
  "currency": zod.coerce.string().min(createAddonBodyCurrencyMinOne).max(createAddonBodyCurrencyMaxOne).regex(createAddonBodyCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').describe('The currency code of the add-on.'),
  "rateCards": zod.array(zod.union([zod.object({
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(createAddonBodyRateCardsItemKeyMax).regex(createAddonBodyRateCardsItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createAddonBodyRateCardsItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createAddonBodyRateCardsItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(createAddonBodyRateCardsItemFeatureKeyMax).regex(createAddonBodyRateCardsItemFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  ...
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityMax).default(createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  ...
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createAddonBodyRateCardsItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createAddonBodyRateCardsItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createAddonBodyRateCardsItemDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
  ...
  "key": zod.coerce.string().min(1).max(createAddonBodyRateCardsItemKeyMaxOne).regex(createAddonBodyRateCardsItemKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createAddonBodyRateCardsItemNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createAddonBodyRateCardsItemDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(createAddonBodyRateCardsItemFeatureKeyMaxOne).regex(createAddonBodyRateCardsItemFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityMaxOne).default(createAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createAddonBodyRateCardsItemTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createAddonBodyRateCardsItemPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
  ...
  "upToAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
  ...
  "amount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
  ...
  "minimumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(createAddonBodyRateCardsItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createAddonBodyRateCardsItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createAddonBodyRateCardsItemDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
...
export const updateAddonBodyRateCardsItemEntitlementTemplateIsSoftLimitDefault = false;export const updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMin = 0;
...
export const updateAddonBodyRateCardsItemEntitlementTemplatePreserveOverageAtResetDefault = false;export const updateAddonBodyRateCardsItemTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const updateAddonBodyRateCardsItemPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const updateAddonBodyRateCardsItemPricePaymentTermDefault = "in_advance";export const updateAddonBodyRateCardsItemDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateAddonBodyRateCardsItemEntitlementTemplateIsSoftLimitDefaultOne = false;export const updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const updateAddonBodyRateCardsItemEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const updateAddonBodyRateCardsItemTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const updateAddonBodyRateCardsItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const updateAddonBodyRateCardsItemPricePaymentTermDefaultTwo = "in_advance";export const updateAddonBodyRateCardsItemPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateAddonBodyRateCardsItemPriceMultiplierDefault = "1";export const updateAddonBodyRateCardsItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateAddonBody = zod.object({
  ...
  "rateCards": zod.array(zod.union([zod.object({
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(updateAddonBodyRateCardsItemKeyMax).regex(updateAddonBodyRateCardsItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(updateAddonBodyRateCardsItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updateAddonBodyRateCardsItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(updateAddonBodyRateCardsItemFeatureKeyMax).regex(updateAddonBodyRateCardsItemFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityMax).default(updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updateAddonBodyRateCardsItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(updateAddonBodyRateCardsItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(updateAddonBodyRateCardsItemDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discount of the rate card. For flat fee rate cards only percentage discounts are supported.\nOnly available when price is set.')
}).describe('A flat fee rate card defines a one-time purchase or a recurring fee.'),zod.object({
  "type": zod.enum(['usage_based']),
  "key": zod.coerce.string().min(1).max(updateAddonBodyRateCardsItemKeyMaxOne).regex(updateAddonBodyRateCardsItemKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(updateAddonBodyRateCardsItemNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updateAddonBodyRateCardsItemDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(updateAddonBodyRateCardsItemFeatureKeyMaxOne).regex(updateAddonBodyRateCardsItemFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityMaxOne).default(updateAddonBodyRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updateAddonBodyRateCardsItemTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(updateAddonBodyRateCardsItemPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(updateAddonBodyRateCardsItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateAddonBodyRateCardsItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(updateAddonBodyRateCardsItemDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts of the rate card.\n\nFlat fee rate cards only support percentage discounts.')
}).describe('A usage-based rate card defines a price based on usage.')]).describe('A rate card defines the pricing and entitlement of a feature or service.')).describe('The rate cards of the add-on.')
...
export const getAddonQueryParams = zod.object({
  "includeLatest": zod.coerce.boolean().optional().describe('Include latest version of the add-on instead of the version in active state.\n\nUsage: `?includeLatest=true`')
})
 ...
 * @summary List apps
 */
export const listAppsQueryPageDefault = 1;export const listAppsQueryPageSizeDefault = 100;
...
export const appCustomInvoicingDraftSynchronizedBody = zod.object({
  ...
  "lineId": zod.coerce.string().regex(appCustomInvoicingDraftSynchronizedBodyInvoicingLineExternalIdsItemLineIdRegExp).describe('The line ID.'),
  ...
  "lineDiscountId": zod.coerce.string().regex(appCustomInvoicingDraftSynchronizedBodyInvoicingLineDiscountExternalIdsItemLineDiscountIdRegExp).describe('The line discount ID.'),
  "externalId": zod.coerce.string().describe('The external ID (e.g. custom invoicing system\'s ID).')
...
export const appCustomInvoicingIssuingSynchronizedBody = zod.object({
  "invoicing": zod.object({
  "invoiceNumber": zod.coerce.string().min(1).max(appCustomInvoicingIssuingSynchronizedBodyInvoicingInvoiceNumberMaxOne).describe('InvoiceNumber is a unique identifier for the invoice, generated by the\ninvoicing app.\n\nThe uniqueness depends on a lot of factors:\n- app setting (unique per app or unique per customer)\n- multiple app scenarios (multiple apps generating invoices with the same prefix)').optional().describe('If set the invoice\'s number will be set to this value.'),
...
export const updateAppBody = zod.union([zod.object({
  "name": zod.coerce.string().min(1).max(updateAppBodyNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updateAppBodyDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  ...
  "name": zod.coerce.string().min(1).max(updateAppBodyNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updateAppBodyDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "type": zod.enum(['sandbox'])
}).describe('Resource update operation model.'),zod.object({
  "name": zod.coerce.string().min(1).max(updateAppBodyNameMaxTwo).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updateAppBodyDescriptionMaxTwo).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
...
export const listBillingProfileCustomerOverridesQueryPageDefault = 1;export const listBillingProfileCustomerOverridesQueryPageSizeDefault = 100;
...
export const createPendingInvoiceLineBodyLinesItemPricePaymentTermDefault = "in_advance";export const createPendingInvoiceLineBodyLinesItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPendingInvoiceLineBodyLinesItemPriceMultiplierDefault = "1";export const createPendingInvoiceLineBodyLinesItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPendingInvoiceLineBodyLinesItemRateCardPricePaymentTermDefault = "in_advance";export const createPendingInvoiceLineBodyLinesItemRateCardPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPendingInvoiceLineBodyLinesItemRateCardPriceMultiplierDefault = "1";export const createPendingInvoiceLineBodyLinesItemRateCardPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPendingInvoiceLineBody = zod.object({
  "currency": zod.coerce.string().min(createPendingInvoiceLineBodyCurrencyMinOne).max(createPendingInvoiceLineBodyCurrencyMaxOne).regex(createPendingInvoiceLineBodyCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').describe('The currency of the lines to be created.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createPendingInvoiceLineBodyLinesItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(createPendingInvoiceLineBodyLinesItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
  ...
  "rateCard": zod.object({
  "featureKey": zod.coerce.string().min(1).max(createPendingInvoiceLineBodyLinesItemRateCardFeatureKeyMax).regex(createPendingInvoiceLineBodyLinesItemRateCardFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "taxConfig": zod.object({
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createPendingInvoiceLineBodyLinesItemRateCardPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(createPendingInvoiceLineBodyLinesItemRateCardPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.'),
  "correlationId": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardDiscountsPercentageCorrelationIdRegExp).optional().describe('Correlation ID for the discount.\n\nThis is used to link discounts across different invoices (progressive billing use case).\n\nIf not provided, the invoicing engine will auto-generate one. When editing an invoice line,\nplease make sure to keep the same correlation ID of the discount or in progressive billing\nsetups the discount amounts might be incorrect.')
}).describe('A percentage discount.').optional().describe('The percentage discount.'),
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.'),
  "correlationId": zod.coerce.string().regex(createPendingInvoiceLineBodyLinesItemRateCardDiscountsUsageCorrelationIdRegExp).optional().describe('Correlation ID for the discount.\n\nThis is used to link discounts across different invoices (progressive billing use case).\n\nIf not provided, the invoicing engine will auto-generate one. When editing an invoice line,\nplease make sure to keep the same correlation ID of the discount or in progressive billing\nsetups the discount amounts might be incorrect.')
...
export const simulateInvoiceBodyLinesItemPricePaymentTermDefault = "in_advance";export const simulateInvoiceBodyLinesItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const simulateInvoiceBodyLinesItemPriceMultiplierDefault = "1";export const simulateInvoiceBodyLinesItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const simulateInvoiceBodyLinesItemRateCardPricePaymentTermDefault = "in_advance";export const simulateInvoiceBodyLinesItemRateCardPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const simulateInvoiceBodyLinesItemRateCardPriceMultiplierDefault = "1";export const simulateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const simulateInvoiceBody = zod.object({
  "number": zod.coerce.string().min(1).max(simulateInvoiceBodyNumberMaxOne).describe('InvoiceNumber is a unique identifier for the invoice, generated by the\ninvoicing app.\n\nThe uniqueness depends on a lot of factors:\n- app setting (unique per app or unique per customer)\n- multiple app scenarios (multiple apps generating invoices with the same prefix)').optional().describe('The number of the invoice.'),
  "currency": zod.coerce.string().min(simulateInvoiceBodyCurrencyMinOne).max(simulateInvoiceBodyCurrencyMaxOne).regex(simulateInvoiceBodyCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').describe('Currency for all invoice line items.\n\nMulti currency invoices are not supported yet.'),
  "lines": zod.array(zod.object({
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(simulateInvoiceBodyLinesItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(simulateInvoiceBodyLinesItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(simulateInvoiceBodyLinesItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').optional().describe('Price of the usage-based item being sold.'),
  ...
  "rateCard": zod.object({
  "featureKey": zod.coerce.string().min(1).max(simulateInvoiceBodyLinesItemRateCardFeatureKeyMax).regex(simulateInvoiceBodyLinesItemRateCardFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "taxConfig": zod.object({
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(simulateInvoiceBodyLinesItemRateCardPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(simulateInvoiceBodyLinesItemRateCardPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.'),
  "correlationId": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardDiscountsPercentageCorrelationIdRegExp).optional().describe('Correlation ID for the discount.\n\nThis is used to link discounts across different invoices (progressive billing use case).\n\nIf not provided, the invoicing engine will auto-generate one. When editing an invoice line,\nplease make sure to keep the same correlation ID of the discount or in progressive billing\nsetups the discount amounts might be incorrect.')
}).describe('A percentage discount.').optional().describe('The percentage discount.'),
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.'),
  "correlationId": zod.coerce.string().regex(simulateInvoiceBodyLinesItemRateCardDiscountsUsageCorrelationIdRegExp).optional().describe('Correlation ID for the discount.\n\nThis is used to link discounts across different invoices (progressive billing use case).\n\nIf not provided, the invoicing engine will auto-generate one. When editing an invoice line,\nplease make sure to keep the same correlation ID of the discount or in progressive billing\nsetups the discount amounts might be incorrect.')
}).describe('A usage discount.').optional().describe('The usage discount.')
}).describe('A discount by type.').optional().describe('The discounts that are applied to the line.')
}).describe('InvoiceUsageBasedRateCard represents the rate card (intent) for an usage-based line.').optional().describe('The rate card that is used for this line.\n\nThe rate card captures the intent of the price and discounts for the usage-based item.'),
  "quantity": zod.coerce.string().regex(simulateInvoiceBodyLinesItemQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the item being sold.'),
  "preLinePeriodQuantity": zod.coerce.string().regex(simulateInvoiceBodyLinesItemPreLinePeriodQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The quantity of the item used before this line\'s period, if the line is billed progressively.'),
...
export const listInvoicesQueryPageDefault = 1;export const listInvoicesQueryPageSizeDefault = 100;
...
export const getInvoiceQueryExpandDefault = ["lines"];export const getInvoiceQueryIncludeDeletedLinesDefault = false;

export const getInvoiceQueryParams = zod.object({
  "expand": zod.array(zod.enum(['lines', 'preceding', 'workflow.apps']).describe('InvoiceExpand specifies the parts of the invoice to expand in the list output.')).default(getInvoiceQueryExpandDefault),
...
export const updateInvoiceBodyLinesItemPricePaymentTermDefault = "in_advance";export const updateInvoiceBodyLinesItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateInvoiceBodyLinesItemPriceMultiplierDefault = "1";export const updateInvoiceBodyLinesItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateInvoiceBodyLinesItemRateCardPricePaymentTermDefault = "in_advance";export const updateInvoiceBodyLinesItemRateCardPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateInvoiceBodyLinesItemRateCardPriceMultiplierDefault = "1";export const updateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updateInvoiceBodyWorkflowWorkflowInvoicingAutoAdvanceDefault = true;export const updateInvoiceBodyWorkflowWorkflowInvoicingDraftPeriodDefault = "P0D";export const updateInvoiceBodyWorkflowWorkflowInvoicingDueAfterDefault = "P30D";export const updateInvoiceBodyWorkflowWorkflowInvoicingDefaultTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
...
export const updateInvoiceBody = zod.object({
  ...
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "supplier": zod.object({
  "key": zod.coerce.string().min(1).max(updateInvoiceBodySupplierKeyMax).optional().describe('An optional unique key of the party (if available)'),
  "name": zod.coerce.string().optional().describe('Legal name or representation of the organization.'),
  "taxId": zod.object({
  "code": zod.coerce.string().min(1).max(updateInvoiceBodySupplierTaxIdCodeMaxOne).describe('TaxIdentificationCode is a normalized tax code shown on the original identity document.').optional().describe('Normalized tax code shown on the original identity document.')
  ...
  "country": zod.coerce.string().min(updateInvoiceBodySupplierAddressesItemCountryMinOne).max(updateInvoiceBodySupplierAddressesItemCountryMaxOne).regex(updateInvoiceBodySupplierAddressesItemCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
...
}).describe('Address')).max(updateInvoiceBodySupplierAddressesMax).optional().describe('Regular post addresses for where information should be sent if needed.')
}).describe('Resource update operation model.').describe('The supplier of the lines included in the invoice.'),
  "customer": zod.object({
  "key": zod.coerce.string().min(1).max(updateInvoiceBodyCustomerKeyMax).optional().describe('An optional unique key of the party (if available)'),
  "name": zod.coerce.string().optional().describe('Legal name or representation of the organization.'),
  "taxId": zod.object({
  "code": zod.coerce.string().min(1).max(updateInvoiceBodyCustomerTaxIdCodeMaxOne).describe('TaxIdentificationCode is a normalized tax code shown on the original identity document.').optional().describe('Normalized tax code shown on the original identity document.')
}).describe('Identity stores the details required to identify an entity for tax purposes in a specific country.').optional().describe('The entity\'s legal ID code used for tax purposes. They may have\nother numbers, but we\'re only interested in those valid for tax purposes.'),
  "addresses": zod.array(zod.object({
  "country": zod.coerce.string().min(updateInvoiceBodyCustomerAddressesItemCountryMinOne).max(updateInvoiceBodyCustomerAddressesItemCountryMaxOne).regex(updateInvoiceBodyCustomerAddressesItemCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
  "postalCode": zod.coerce.string().optional().describe('Postal code.'),
  "state": zod.coerce.string().optional().describe('State or province.'),
  "city": zod.coerce.string().optional().describe('City.'),
  "line1": zod.coerce.string().optional().describe('First line of the address.'),
  "line2": zod.coerce.string().optional().describe('Second line of the address.'),
  "phoneNumber": zod.coerce.string().optional().describe('Phone number.')
}).describe('Address')).max(updateInvoiceBodyCustomerAddressesMax).optional().describe('Regular post addresses for where information should be sent if needed.')
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updateInvoiceBodyLinesItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(updateInvoiceBodyLinesItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(updateInvoiceBodyLinesItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').optional().describe('Price of the usage-based item being sold.'),
  ...
  "rateCard": zod.object({
  "featureKey": zod.coerce.string().min(1).max(updateInvoiceBodyLinesItemRateCardFeatureKeyMax).regex(updateInvoiceBodyLinesItemRateCardFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "taxConfig": zod.object({
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(updateInvoiceBodyLinesItemRateCardPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(updateInvoiceBodyLinesItemRateCardPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.'),
  "correlationId": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardDiscountsPercentageCorrelationIdRegExp).optional().describe('Correlation ID for the discount.\n\nThis is used to link discounts across different invoices (progressive billing use case).\n\nIf not provided, the invoicing engine will auto-generate one. When editing an invoice line,\nplease make sure to keep the same correlation ID of the discount or in progressive billing\nsetups the discount amounts might be incorrect.')
}).describe('A percentage discount.').optional().describe('The percentage discount.'),
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.'),
  "correlationId": zod.coerce.string().regex(updateInvoiceBodyLinesItemRateCardDiscountsUsageCorrelationIdRegExp).optional().describe('Correlation ID for the discount.\n\nThis is used to link discounts across different invoices (progressive billing use case).\n\nIf not provided, the invoicing engine will auto-generate one. When editing an invoice line,\nplease make sure to keep the same correlation ID of the discount or in progressive billing\nsetups the discount amounts might be incorrect.')
}).describe('A usage discount.').optional().describe('The usage discount.')
}).describe('A discount by type.').optional().describe('The discounts that are applied to the line.')
}).describe('InvoiceUsageBasedRateCard represents the rate card (intent) for an usage-based line.').optional().describe('The rate card that is used for this line.\n\nThe rate card captures the intent of the price and discounts for the usage-based item.'),
  ...
  "workflow": zod.object({
  "invoicing": zod.object({
  "autoAdvance": zod.coerce.boolean().default(updateInvoiceBodyWorkflowWorkflowInvoicingAutoAdvanceDefault).describe('Whether to automatically issue the invoice after the draftPeriod has passed.'),
  "draftPeriod": zod.coerce.string().default(updateInvoiceBodyWorkflowWorkflowInvoicingDraftPeriodDefault).describe('The period for the invoice to be kept in draft status for manual reviews.'),
  "dueAfter": zod.coerce.string().default(updateInvoiceBodyWorkflowWorkflowInvoicingDueAfterDefault).describe('The period after which the invoice is due.\nWith some payment solutions it\'s only applicable for manual collection method.'),
  "defaultTaxConfig": zod.object({
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updateInvoiceBodyWorkflowWorkflowInvoicingDefaultTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "payment": zod.object({
  "collectionMethod": zod.enum(['charge_automatically', 'send_invoice']).describe('CollectionMethod specifies how the invoice should be collected (automatic vs manual)').default(updateInvoiceBodyWorkflowWorkflowPaymentCollectionMethodDefault).describe('The payment method for the invoice.')
 ...
 */
export const listBillingProfilesQueryIncludeArchivedDefault = false;export const listBillingProfilesQueryPageDefault = 1;export const listBillingProfilesQueryPageSizeDefault = 100;
...
export const createBillingProfileBodyWorkflowCollectionAlignmentRecurringPeriodIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
export const createBillingProfileBodyWorkflowCollectionAlignmentDefault = { type: "subscription" };export const createBillingProfileBodyWorkflowCollectionIntervalDefault = "PT1H";export const createBillingProfileBodyWorkflowInvoicingAutoAdvanceDefault = true;export const createBillingProfileBodyWorkflowInvoicingDraftPeriodDefault = "P0D";export const createBillingProfileBodyWorkflowInvoicingDueAfterDefault = "P30D";export const createBillingProfileBodyWorkflowInvoicingProgressiveBillingDefault = false;export const createBillingProfileBodyWorkflowInvoicingDefaultTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const createBillingProfileBodyWorkflowPaymentCollectionMethodDefault = "charge_automatically";export const createBillingProfileBodyWorkflowTaxEnabledDefault = true;export const createBillingProfileBodyWorkflowTaxEnforcedDefault = false;export const createBillingProfileBodyAppsTaxRegExp = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const createBillingProfileBody = zod.object({
  ...
  "key": zod.coerce.string().min(1).max(createBillingProfileBodySupplierKeyMax).optional().describe('An optional unique key of the party (if available)'),
  "name": zod.coerce.string().optional().describe('Legal name or representation of the organization.'),
  "taxId": zod.object({
  "code": zod.coerce.string().min(1).max(createBillingProfileBodySupplierTaxIdCodeMaxOne).describe('TaxIdentificationCode is a normalized tax code shown on the original identity document.').optional().describe('Normalized tax code shown on the original identity document.')
}).describe('Identity stores the details required to identify an entity for tax purposes in a specific country.').optional().describe('The entity\'s legal ID code used for tax purposes. They may have\nother numbers, but we\'re only interested in those valid for tax purposes.'),
  "addresses": zod.array(zod.object({
  "country": zod.coerce.string().min(createBillingProfileBodySupplierAddressesItemCountryMinOne).max(createBillingProfileBodySupplierAddressesItemCountryMaxOne).regex(createBillingProfileBodySupplierAddressesItemCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
  "postalCode": zod.coerce.string().optional().describe('Postal code.'),
  "state": zod.coerce.string().optional().describe('State or province.'),
  "city": zod.coerce.string().optional().describe('City.'),
  "line1": zod.coerce.string().optional().describe('First line of the address.'),
  "line2": zod.coerce.string().optional().describe('Second line of the address.'),
  "phoneNumber": zod.coerce.string().optional().describe('Phone number.')
}).describe('Address')).max(createBillingProfileBodySupplierAddressesMax).optional().describe('Regular post addresses for where information should be sent if needed.')
  ...
  "interval": zod.union([zod.coerce.string().regex(createBillingProfileBodyWorkflowCollectionAlignmentRecurringPeriodIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval. Heuristically maps ISO duraitons to enum values or returns the ISO duration.'),
...
}).describe('BillingWorkflowCollectionAlignmentAnchored specifies the alignment for collecting the pending line items\ninto an invoice.')]).describe('The alignment for collecting the pending line items into an invoice.\n\nDefaults to subscription, which means that we are to create a new invoice every time the\na subscription period starts (for in advance items) or ends (for in arrears items).').default(createBillingProfileBodyWorkflowCollectionAlignmentDefault).describe('The alignment for collecting the pending line items into an invoice.'),
  "interval": zod.coerce.string().default(createBillingProfileBodyWorkflowCollectionIntervalDefault).describe('This grace period can be used to delay the collection of the pending line items specified in\nalignment.\n\nThis is useful, in case of multiple subscriptions having slightly different billing periods.')
  ...
  "invoicing": zod.object({
  "autoAdvance": zod.coerce.boolean().default(createBillingProfileBodyWorkflowInvoicingAutoAdvanceDefault).describe('Whether to automatically issue the invoice after the draftPeriod has passed.'),
  "draftPeriod": zod.coerce.string().default(createBillingProfileBodyWorkflowInvoicingDraftPeriodDefault).describe('The period for the invoice to be kept in draft status for manual reviews.'),
  "dueAfter": zod.coerce.string().default(createBillingProfileBodyWorkflowInvoicingDueAfterDefault).describe('The period after which the invoice is due.\nWith some payment solutions it\'s only applicable for manual collection method.'),
  "progressiveBilling": zod.coerce.boolean().optional().describe('Should progressive billing be allowed for this workflow?'),
  "defaultTaxConfig": zod.object({
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createBillingProfileBodyWorkflowInvoicingDefaultTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "payment": zod.object({
  "collectionMethod": zod.enum(['charge_automatically', 'send_invoice']).describe('CollectionMethod specifies how the invoice should be collected (automatic vs manual)').default(createBillingProfileBodyWorkflowPaymentCollectionMethodDefault).describe('The payment method for the invoice.')
  ...
  "apps": zod.object({
  "tax": zod.coerce.string().regex(createBillingProfileBodyAppsTaxRegExp).describe('The tax app used for this workflow'),
  "invoicing": zod.coerce.string().regex(createBillingProfileBodyAppsInvoicingRegExp).describe('The invoicing app used for this workflow'),
  "payment": zod.coerce.string().regex(createBillingProfileBodyAppsPaymentRegExp).describe('The payment app used for this workflow')
...
export const updateBillingProfileBodyWorkflowCollectionAlignmentRecurringPeriodIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
export const updateBillingProfileBodyWorkflowCollectionAlignmentDefault = { type: "subscription" };export const updateBillingProfileBodyWorkflowCollectionIntervalDefault = "PT1H";export const updateBillingProfileBodyWorkflowInvoicingAutoAdvanceDefault = true;export const updateBillingProfileBodyWorkflowInvoicingDraftPeriodDefault = "P0D";export const updateBillingProfileBodyWorkflowInvoicingDueAfterDefault = "P30D";export const updateBillingProfileBodyWorkflowInvoicingProgressiveBillingDefault = false;export const updateBillingProfileBodyWorkflowInvoicingDefaultTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const updateBillingProfileBodyWorkflowPaymentCollectionMethodDefault = "charge_automatically";export const updateBillingProfileBodyWorkflowTaxEnabledDefault = true;export const updateBillingProfileBodyWorkflowTaxEnforcedDefault = false;
...
export const updateBillingProfileBody = zod.object({
  ...
  "supplier": zod.object({
  "id": zod.coerce.string().optional().describe('Unique identifier for the party (if available)'),
  "key": zod.coerce.string().min(1).max(updateBillingProfileBodySupplierKeyMax).optional().describe('An optional unique key of the party (if available)'),
  "name": zod.coerce.string().optional().describe('Legal name or representation of the organization.'),
  "taxId": zod.object({
  "code": zod.coerce.string().min(1).max(updateBillingProfileBodySupplierTaxIdCodeMaxOne).describe('TaxIdentificationCode is a normalized tax code shown on the original identity document.').optional().describe('Normalized tax code shown on the original identity document.')
}).describe('Identity stores the details required to identify an entity for tax purposes in a specific country.').optional().describe('The entity\'s legal ID code used for tax purposes. They may have\nother numbers, but we\'re only interested in those valid for tax purposes.'),
  "addresses": zod.array(zod.object({
  "country": zod.coerce.string().min(updateBillingProfileBodySupplierAddressesItemCountryMinOne).max(updateBillingProfileBodySupplierAddressesItemCountryMaxOne).regex(updateBillingProfileBodySupplierAddressesItemCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
  "postalCode": zod.coerce.string().optional().describe('Postal code.'),
  "state": zod.coerce.string().optional().describe('State or province.'),
  "city": zod.coerce.string().optional().describe('City.'),
  "line1": zod.coerce.string().optional().describe('First line of the address.'),
  "line2": zod.coerce.string().optional().describe('Second line of the address.'),
  "phoneNumber": zod.coerce.string().optional().describe('Phone number.')
}).describe('Address')).max(updateBillingProfileBodySupplierAddressesMax).optional().describe('Regular post addresses for where information should be sent if needed.')
}).describe('Party represents a person or business entity.').describe('The name and contact information for the supplier this billing profile represents'),
  "default": zod.coerce.boolean().describe('Is this the default profile?'),
  "workflow": zod.object({
  "collection": zod.object({
  ...
  "type": zod.enum(['anchored']),
  "recurringPeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(updateBillingProfileBodyWorkflowCollectionAlignmentRecurringPeriodIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval. Heuristically maps ISO duraitons to enum values or returns the ISO duration.'),
  "anchor": zod.coerce.date().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').describe('The recurring period for the alignment.')
}).describe('BillingWorkflowCollectionAlignmentAnchored specifies the alignment for collecting the pending line items\ninto an invoice.')]).describe('The alignment for collecting the pending line items into an invoice.\n\nDefaults to subscription, which means that we are to create a new invoice every time the\na subscription period starts (for in advance items) or ends (for in arrears items).').default(updateBillingProfileBodyWorkflowCollectionAlignmentDefault).describe('The alignment for collecting the pending line items into an invoice.'),
  "interval": zod.coerce.string().default(updateBillingProfileBodyWorkflowCollectionIntervalDefault).describe('This grace period can be used to delay the collection of the pending line items specified in\nalignment.\n\nThis is useful, in case of multiple subscriptions having slightly different billing periods.')
}).describe('Workflow collection specifies how to collect the pending line items for an invoice').optional().describe('The collection settings for this workflow'),
  "invoicing": zod.object({
  "autoAdvance": zod.coerce.boolean().default(updateBillingProfileBodyWorkflowInvoicingAutoAdvanceDefault).describe('Whether to automatically issue the invoice after the draftPeriod has passed.'),
  "draftPeriod": zod.coerce.string().default(updateBillingProfileBodyWorkflowInvoicingDraftPeriodDefault).describe('The period for the invoice to be kept in draft status for manual reviews.'),
  "dueAfter": zod.coerce.string().default(updateBillingProfileBodyWorkflowInvoicingDueAfterDefault).describe('The period after which the invoice is due.\nWith some payment solutions it\'s only applicable for manual collection method.'),
  "progressiveBilling": zod.coerce.boolean().optional().describe('Should progressive billing be allowed for this workflow?'),
  "defaultTaxConfig": zod.object({
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updateBillingProfileBodyWorkflowInvoicingDefaultTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "payment": zod.object({
  "collectionMethod": zod.enum(['charge_automatically', 'send_invoice']).describe('CollectionMethod specifies how the invoice should be collected (automatic vs manual)').default(updateBillingProfileBodyWorkflowPaymentCollectionMethodDefault).describe('The payment method for the invoice.')
}).describe('BillingWorkflowPaymentSettings represents the payment settings for a billing workflow').optional().describe('The payment settings for this workflow'),
  "tax": zod.object({
  "enabled": zod.coerce.boolean().default(updateBillingProfileBodyWorkflowTaxEnabledDefault).describe('Enable automatic tax calculation when tax is supported by the app.\nFor example, with Stripe Invoicing when enabled, tax is calculated via Stripe Tax.'),
  "enforced": zod.coerce.boolean().optional().describe('Enforce tax calculation when tax is supported by the app.\nWhen enabled, OpenMeter will not allow to create an invoice without tax calculation.\nEnforcement is different per apps, for example, Stripe app requires customer\nto have a tax location when starting a paid subscription.')
}).describe('BillingWorkflowTaxSettings represents the tax settings for a billing workflow').optional().describe('The tax settings for this workflow')
...
export const createCustomerBodyUsageAttributionSubjectKeysMin = 0;
...
export const createCustomerBody = zod.object({
  ...
  "subjectKeys": zod.array(zod.coerce.string().min(1).describe('SubjectKey is a key that is used to identify a subject.')).min(createCustomerBodyUsageAttributionSubjectKeysMin).describe('The subjects that are attributed to the customer.\nCan be empty when no subjects are associated with the customer.')
  ...
  "currency": zod.coerce.string().min(createCustomerBodyCurrencyMinOne).max(createCustomerBodyCurrencyMaxOne).regex(createCustomerBodyCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').optional().describe('Currency of the customer.\nUsed for billing, tax and invoicing.'),
  "billingAddress": zod.object({
  "country": zod.coerce.string().min(createCustomerBodyBillingAddressCountryMinOne).max(createCustomerBodyBillingAddressCountryMaxOne).regex(createCustomerBodyBillingAddressCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
  "postalCode": zod.coerce.string().optional().describe('Postal code.'),
  "state": zod.coerce.string().optional().describe('State or province.'),
  "city": zod.coerce.string().optional().describe('City.'),
  "line1": zod.coerce.string().optional().describe('First line of the address.'),
 ...
 */
export const listCustomersQueryPageDefault = 1;export const listCustomersQueryPageSizeDefault = 100;
...
export const listCustomersQueryParams = zod.object({
  ...
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted customers.'),
 ...
 */
export const getCustomerPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const getCustomerPathCustomerIdOrKeyMaxTwo = 256;


export const getCustomerParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(getCustomerPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(getCustomerPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
 ...
 */
export const updateCustomerPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const updateCustomerPathCustomerIdOrKeyMaxTwo = 256;


export const updateCustomerParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(updateCustomerPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(updateCustomerPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
...
export const updateCustomerBodyUsageAttributionSubjectKeysMin = 0;
...
export const updateCustomerBody = zod.object({
  ...
  "usageAttribution": zod.object({
  "subjectKeys": zod.array(zod.coerce.string().min(1).describe('SubjectKey is a key that is used to identify a subject.')).min(updateCustomerBodyUsageAttributionSubjectKeysMin).describe('The subjects that are attributed to the customer.\nCan be empty when no subjects are associated with the customer.')
}).describe('Mapping to attribute metered usage to the customer.\nOne customer can have zero or more subjects,\nbut one subject can only belong to one customer.').optional().describe('Mapping to attribute metered usage to the customer\nEither key or usageAttribution.subjectKeys must be provided.'),
  "primaryEmail": zod.coerce.string().optional().describe('The primary email address of the customer.'),
  "currency": zod.coerce.string().min(updateCustomerBodyCurrencyMinOne).max(updateCustomerBodyCurrencyMaxOne).regex(updateCustomerBodyCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').optional().describe('Currency of the customer.\nUsed for billing, tax and invoicing.'),
  "billingAddress": zod.object({
  "country": zod.coerce.string().min(updateCustomerBodyBillingAddressCountryMinOne).max(updateCustomerBodyBillingAddressCountryMaxOne).regex(updateCustomerBodyBillingAddressCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
  "postalCode": zod.coerce.string().optional().describe('Postal code.'),
  "state": zod.coerce.string().optional().describe('State or province.'),
  "city": zod.coerce.string().optional().describe('City.'),
  "line1": zod.coerce.string().optional().describe('First line of the address.'),
 ...
 */
export const deleteCustomerPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const deleteCustomerPathCustomerIdOrKeyMaxTwo = 256;


export const deleteCustomerParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(deleteCustomerPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(deleteCustomerPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
 ...
 */
export const getCustomerAccessPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const getCustomerAccessPathCustomerIdOrKeyMaxTwo = 256;


export const getCustomerAccessParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(getCustomerAccessPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(getCustomerAccessPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
 ...
 */
export const listCustomerAppDataPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const listCustomerAppDataPathCustomerIdOrKeyMaxTwo = 256;


export const listCustomerAppDataParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(listCustomerAppDataPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(listCustomerAppDataPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})

export const listCustomerAppDataQueryPageDefault = 1;export const listCustomerAppDataQueryPageSizeDefault = 100;
 ...
 */
export const upsertCustomerAppDataPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const upsertCustomerAppDataPathCustomerIdOrKeyMaxTwo = 256;


export const upsertCustomerAppDataParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(upsertCustomerAppDataPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(upsertCustomerAppDataPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
...
export const upsertCustomerAppDataBodyItem = zod.union([zod.object({
  "id": zod.coerce.string().regex(upsertCustomerAppDataBodyIdRegExp).optional().describe('The app ID.\nIf not provided, it will use the global default for the app type.'),
  "type": zod.enum(['stripe']),
  ...
  "app": zod.object({
  "id": zod.coerce.string().regex(upsertCustomerAppDataBodyAppIdRegExp).describe('A unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(upsertCustomerAppDataBodyAppNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(upsertCustomerAppDataBodyAppDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  ...
  "key": zod.coerce.string().min(1).max(upsertCustomerAppDataBodyAppListingCapabilitiesItemKeyMax).regex(upsertCustomerAppDataBodyAppListingCapabilitiesItemKeyRegExp).describe('Key'),
  ...
  "id": zod.coerce.string().regex(upsertCustomerAppDataBodyIdRegExpOne).optional().describe('The app ID.\nIf not provided, it will use the global default for the app type.'),
  "type": zod.enum(['sandbox'])
}).describe('Sandbox Customer App Data.'),zod.object({
  "app": zod.object({
  "id": zod.coerce.string().regex(upsertCustomerAppDataBodyAppIdRegExpOne).describe('A unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(upsertCustomerAppDataBodyAppNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(upsertCustomerAppDataBodyAppDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "createdAt": zod.coerce.date().describe('Timestamp of when the resource was created.'),
  "updatedAt": zod.coerce.date().describe('Timestamp of when the resource was last updated.'),
  "deletedAt": zod.coerce.date().optional().describe('Timestamp of when the resource was permanently deleted.'),
  ...
  "capabilities": zod.array(zod.object({
  "type": zod.enum(['reportUsage', 'reportEvents', 'calculateTax', 'invoiceCustomers', 'collectPayments']).describe('App capability type.').describe('The capability type.'),
  "key": zod.coerce.string().min(1).max(upsertCustomerAppDataBodyAppListingCapabilitiesItemKeyMaxOne).regex(upsertCustomerAppDataBodyAppListingCapabilitiesItemKeyRegExpOne).describe('Key'),
  "name": zod.coerce.string().describe('The capability name.'),
  "description": zod.coerce.string().describe('The capability description.')
}).describe('App capability.\n\nCapabilities only exist in config so they don\'t extend the Resource model.')).describe('The app\'s capabilities.'),
  "installMethods": zod.array(zod.enum(['with_oauth2', 'with_api_key', 'no_credentials_required']).describe('Install method of the application.')).describe('Install methods.\n\nList of methods to install the app.')
  ...
  "id": zod.coerce.string().regex(upsertCustomerAppDataBodyIdRegExpTwo).optional().describe('The app ID.\nIf not provided, it will use the global default for the app type.'),
  "type": zod.enum(['custom_invoicing']),
 ...
 */
export const deleteCustomerAppDataPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const deleteCustomerAppDataParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(deleteCustomerAppDataPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(deleteCustomerAppDataPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
 ...
 */
export const getCustomerEntitlementValuePathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const getCustomerStripeAppDataParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(getCustomerStripeAppDataPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(getCustomerStripeAppDataPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
...
export const upsertCustomerStripeAppDataParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(upsertCustomerStripeAppDataPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(upsertCustomerStripeAppDataPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
...
export const createCustomerStripePortalSessionParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(createCustomerStripePortalSessionPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(createCustomerStripePortalSessionPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
 ...
 */
export const listCustomerSubscriptionsPathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const listCustomerSubscriptionsParams = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(listCustomerSubscriptionsPathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(listCustomerSubscriptionsPathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})

export const listCustomerSubscriptionsQueryPageDefault = 1;export const listCustomerSubscriptionsQueryPageSizeDefault = 100;
 ...
 */
export const listEntitlementsQueryExcludeInactiveDefault = false;export const listEntitlementsQueryPageDefault = 1;export const listEntitlementsQueryPageSizeDefault = 100;
...
export const listEntitlementsQueryParams = zod.object({
  ...
  "excludeInactive": zod.coerce.boolean().optional().describe('Exclude inactive entitlements in the response (those scheduled for later or earlier)'),
  ...
  "offset": zod.coerce.number().min(listEntitlementsQueryOffsetMin).optional().describe('Number of items to skip.\n\nDefault is 0.'),
 ...
 */
export const ingestEventsBodySpecversionDefault = "1.0";export const ingestEventsBodyItemSpecversionDefault = "1.0";
...
export const ingestEventsBody = zod.union([zod.object({
  ...
  "dataschema": zod.coerce.string().url().min(1).nullish().describe('Identifies the schema that data adheres to.'),
  ...
  "data": zod.record(zod.string(), zod.any()).nullish().describe('The event payload.\nOptional, if present it must be a JSON object.')
 ...
 */
export const listFeaturesQueryIncludeArchivedDefault = false;export const listFeaturesQueryPageDefault = 1;export const listFeaturesQueryPageSizeDefault = 100;
...
export const listFeaturesQueryParams = zod.object({
  ...
  "includeArchived": zod.coerce.boolean().optional().describe('Include archived features in response.'),
  ...
  "offset": zod.coerce.number().min(listFeaturesQueryOffsetMin).optional().describe('Number of items to skip.\n\nDefault is 0.'),
...
export const createFeatureBody = zod.object({
  ...
  "$and": zod.array(zod.any()).nullish().describe('Provide a list of filters to be combined with a logical AND.'),
  "$or": zod.array(zod.any()).nullish().describe('Provide a list of filters to be combined with a logical OR.')
 ...
 * @summary List grants
 */
export const listGrantsQueryIncludeDeletedDefault = false;export const listGrantsQueryPageDefault = 1;export const listGrantsQueryPageSizeDefault = 100;
...
export const listGrantsQueryParams = zod.object({
  ...
  "offset": zod.coerce.number().min(listGrantsQueryOffsetMin).optional().describe('Number of items to skip.\n\nDefault is 0.'),
 ...
 */
export const listMarketplaceListingsQueryPageDefault = 1;export const listMarketplaceListingsQueryPageSizeDefault = 100;
 ...
 * @summary List meters
 */
export const listMetersQueryPageDefault = 1;export const listMetersQueryPageSizeDefault = 100;
...
export const listMetersQueryParams = zod.object({
  ...
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted meters.')
})
 ...
 */
export const listNotificationChannelsQueryIncludeDeletedDefault = false;export const listNotificationChannelsQueryIncludeDisabledDefault = false;export const listNotificationChannelsQueryPageDefault = 1;export const listNotificationChannelsQueryPageSizeDefault = 100;
export const listNotificationChannelsQueryPageSizeMax = 1000;


export const listNotificationChannelsQueryParams = zod.object({
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted notification channels in response.\n\nUsage: `?includeDeleted=true`'),
  "includeDisabled": zod.coerce.boolean().optional().describe('Include disabled notification channels in response.\n\nUsage: `?includeDisabled=false`'),
...
export const createNotificationChannelBodyDisabledDefault = false;export const createNotificationChannelBodySigningSecretRegExp = new RegExp('^(whsec_)?[a-zA-Z0-9+/=]{32,100}$');


export const createNotificationChannelBody = zod.object({
  "type": zod.enum(['WEBHOOK']).describe('Notification channel type.'),
  "name": zod.coerce.string().min(1).max(createNotificationChannelBodyNameMax).describe('User friendly name of the channel.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the channel is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  ...
  "signingSecret": zod.coerce.string().regex(createNotificationChannelBodySigningSecretRegExp).optional().describe('Signing secret used for webhook request validation on the receiving end.\n\nFormat: `base64` encoded random bytes optionally prefixed with `whsec_`. Recommended size: 24')
...
export const updateNotificationChannelBodyDisabledDefault = false;export const updateNotificationChannelBodySigningSecretRegExp = new RegExp('^(whsec_)?[a-zA-Z0-9+/=]{32,100}$');


export const updateNotificationChannelBody = zod.object({
  "type": zod.enum(['WEBHOOK']).describe('Notification channel type.'),
  "name": zod.coerce.string().min(1).max(updateNotificationChannelBodyNameMax).describe('User friendly name of the channel.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the channel is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "url": zod.coerce.string().describe('Webhook URL where the notification is sent.'),
  "customHeaders": zod.record(zod.string(), zod.coerce.string()).optional().describe('Custom HTTP headers sent as part of the webhook request.'),
  "signingSecret": zod.coerce.string().regex(updateNotificationChannelBodySigningSecretRegExp).optional().describe('Signing secret used for webhook request validation on the receiving end.\n\nFormat: `base64` encoded random bytes optionally prefixed with `whsec_`. Recommended size: 24')
}).describe('Request with input parameters for creating new notification channel with webhook type.').describe('Union type for requests creating new notification channel with certain type.')
...
export const listNotificationEventsQueryPageDefault = 1;export const listNotificationEventsQueryPageSizeDefault = 100;
...
export const listNotificationRulesQueryPageDefault = 1;export const listNotificationRulesQueryPageSizeDefault = 100;
export const listNotificationRulesQueryPageSizeMax = 1000;


export const listNotificationRulesQueryParams = zod.object({
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted notification rules in response.\n\nUsage: `?includeDeleted=true`'),
  "includeDisabled": zod.coerce.boolean().optional().describe('Include disabled notification rules in response.\n\nUsage: `?includeDisabled=false`'),
...
export const createNotificationRuleBodyDisabledDefault = false;export const createNotificationRuleBodyThresholdsMax = 10;
...
export const createNotificationRuleBodyDisabledDefaultOne = false;export const createNotificationRuleBodyChannelsItemRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const createNotificationRuleBodyDisabledDefaultTwo = false;export const createNotificationRuleBodyChannelsItemRegExpTwo = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const createNotificationRuleBodyNameMaxThree = 256;
export const createNotificationRuleBodyDisabledDefaultThree = false;export const createNotificationRuleBodyChannelsItemRegExpThree = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');


export const createNotificationRuleBody = zod.union([zod.object({
  "type": zod.enum(['entitlements.balance.threshold']),
  "name": zod.coerce.string().min(1).max(createNotificationRuleBodyNameMax).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
...
}).describe('Threshold value with multiple supported types.')).min(1).max(createNotificationRuleBodyThresholdsMax).describe('List of thresholds the rule suppose to be triggered.'),
  "channels": zod.array(zod.coerce.string().regex(createNotificationRuleBodyChannelsItemRegExp).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.'),
  "features": zod.array(zod.coerce.string().min(1).max(createNotificationRuleBodyFeaturesItemMax).regex(createNotificationRuleBodyFeaturesItemRegExp).describe('ULID (Universally Unique Lexicographically Sortable Identifier).\nA key is a unique string that is used to identify a resource.\n\nTODO: this is a temporary solution to support both ULID and Key in the same spec for codegen.')).min(1).optional().describe('Optional field for defining the scope of notification by feature. It may contain features by id or key.')
  ...
  "name": zod.coerce.string().min(1).max(createNotificationRuleBodyNameMaxOne).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "channels": zod.array(zod.coerce.string().regex(createNotificationRuleBodyChannelsItemRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.'),
  "features": zod.array(zod.coerce.string().min(1).max(createNotificationRuleBodyFeaturesItemMaxOne).regex(createNotificationRuleBodyFeaturesItemRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).\nA key is a unique string that is used to identify a resource.\n\nTODO: this is a temporary solution to support both ULID and Key in the same spec for codegen.')).min(1).optional().describe('Optional field for defining the scope of notification by feature. It may contain features by id or key.')
  ...
  "name": zod.coerce.string().min(1).max(createNotificationRuleBodyNameMaxTwo).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "channels": zod.array(zod.coerce.string().regex(createNotificationRuleBodyChannelsItemRegExpTwo).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.')
  ...
  "name": zod.coerce.string().min(1).max(createNotificationRuleBodyNameMaxThree).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "channels": zod.array(zod.coerce.string().regex(createNotificationRuleBodyChannelsItemRegExpThree).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.')
...
export const updateNotificationRuleBodyDisabledDefault = false;export const updateNotificationRuleBodyThresholdsMax = 10;
...
export const updateNotificationRuleBodyDisabledDefaultOne = false;export const updateNotificationRuleBodyChannelsItemRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const updateNotificationRuleBodyDisabledDefaultTwo = false;export const updateNotificationRuleBodyChannelsItemRegExpTwo = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const updateNotificationRuleBodyNameMaxThree = 256;
export const updateNotificationRuleBodyDisabledDefaultThree = false;export const updateNotificationRuleBodyChannelsItemRegExpThree = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');


export const updateNotificationRuleBody = zod.union([zod.object({
  "type": zod.enum(['entitlements.balance.threshold']),
  "name": zod.coerce.string().min(1).max(updateNotificationRuleBodyNameMax).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "thresholds": zod.array(zod.object({
  "value": zod.coerce.number().describe('Value of the threshold.'),
  "type": zod.enum(['PERCENT', 'NUMBER', 'balance_value', 'usage_percentage', 'usage_value']).describe('Type of the rule in the balance threshold specification:\n* `balance_value`: threshold defined by the remaining balance value based on usage and the total of grants in the current usage period\n* `usage_percentage`: threshold defined by the usage percentage compared to the total of grants in the current usage period\n* `usage_value`: threshold defined by the usage value in the current usage period\n* `NUMBER` (**deprecated**): see `usage_value`\n* `PERCENT` (**deprecated**): see `usage_percentage`').describe('Type of the threshold.')
}).describe('Threshold value with multiple supported types.')).min(1).max(updateNotificationRuleBodyThresholdsMax).describe('List of thresholds the rule suppose to be triggered.'),
  "channels": zod.array(zod.coerce.string().regex(updateNotificationRuleBodyChannelsItemRegExp).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.'),
  "features": zod.array(zod.coerce.string().min(1).max(updateNotificationRuleBodyFeaturesItemMax).regex(updateNotificationRuleBodyFeaturesItemRegExp).describe('ULID (Universally Unique Lexicographically Sortable Identifier).\nA key is a unique string that is used to identify a resource.\n\nTODO: this is a temporary solution to support both ULID and Key in the same spec for codegen.')).min(1).optional().describe('Optional field for defining the scope of notification by feature. It may contain features by id or key.')
}).describe('Request with input parameters for creating new notification rule with entitlements.balance.threshold type.'),zod.object({
  "type": zod.enum(['entitlements.reset']),
  "name": zod.coerce.string().min(1).max(updateNotificationRuleBodyNameMaxOne).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "channels": zod.array(zod.coerce.string().regex(updateNotificationRuleBodyChannelsItemRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.'),
  "features": zod.array(zod.coerce.string().min(1).max(updateNotificationRuleBodyFeaturesItemMaxOne).regex(updateNotificationRuleBodyFeaturesItemRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).\nA key is a unique string that is used to identify a resource.\n\nTODO: this is a temporary solution to support both ULID and Key in the same spec for codegen.')).min(1).optional().describe('Optional field for defining the scope of notification by feature. It may contain features by id or key.')
}).describe('Request with input parameters for creating new notification rule with entitlements.reset type.'),zod.object({
  "type": zod.enum(['invoice.created']),
  "name": zod.coerce.string().min(1).max(updateNotificationRuleBodyNameMaxTwo).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "channels": zod.array(zod.coerce.string().regex(updateNotificationRuleBodyChannelsItemRegExpTwo).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.')
}).describe('Request with input parameters for creating new notification rule with invoice.created type.'),zod.object({
  "type": zod.enum(['invoice.updated']),
  "name": zod.coerce.string().min(1).max(updateNotificationRuleBodyNameMaxThree).describe('The user friendly name of the notification rule.'),
  "disabled": zod.coerce.boolean().optional().describe('Whether the rule is disabled or not.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "channels": zod.array(zod.coerce.string().regex(updateNotificationRuleBodyChannelsItemRegExpThree).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')).min(1).describe('List of notification channels the rule is applied to.')
}).describe('Request with input parameters for creating new notification rule with invoice.updated  type.')]).describe('Union type for requests creating new notification rule with certain type.')
...
export const listPlansQueryPageDefault = 1;export const listPlansQueryPageSizeDefault = 100;
export const listPlansQueryPageSizeMax = 1000;


export const listPlansQueryParams = zod.object({
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted plans in response.\n\nUsage: `?includeDeleted=true`'),
...
export const createPlanBodyCurrencyDefault = "USD";export const createPlanBodyProRatingConfigEnabledDefault = true;export const createPlanBodyProRatingConfigModeDefault = "prorate_prices";export const createPlanBodyProRatingConfigDefault = { enabled: true, mode: "prorate_prices" };export const createPlanBodyPhasesItemKeyMax = 64;
...
export const createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefault = false;export const createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin = 0;
...
export const createPlanBodyPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefault = false;export const createPlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const createPlanBodyPhasesItemRateCardsItemPricePaymentTermDefault = "in_advance";export const createPlanBodyPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefaultOne = false;export const createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const createPlanBodyPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const createPlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const createPlanBodyPhasesItemRateCardsItemPricePaymentTermDefaultTwo = "in_advance";export const createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPlanBodyPhasesItemRateCardsItemPriceMultiplierDefault = "1";export const createPlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createPlanBody = zod.object({
  ...
  "currency": zod.coerce.string().min(createPlanBodyCurrencyMinOne).max(createPlanBodyCurrencyMaxOne).regex(createPlanBodyCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').describe('The currency code of the plan.'),
  ...
  "rateCards": zod.array(zod.union([zod.object({
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(createPlanBodyPhasesItemRateCardsItemKeyMax).regex(createPlanBodyPhasesItemRateCardsItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createPlanBodyPhasesItemRateCardsItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createPlanBodyPhasesItemRateCardsItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(createPlanBodyPhasesItemRateCardsItemFeatureKeyMax).regex(createPlanBodyPhasesItemRateCardsItemFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMax).default(createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createPlanBodyPhasesItemRateCardsItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discount of the rate card. For flat fee rate cards only percentage discounts are supported.\nOnly available when price is set.')
}).describe('A flat fee rate card defines a one-time purchase or a recurring fee.'),zod.object({
  "type": zod.enum(['usage_based']),
  "key": zod.coerce.string().min(1).max(createPlanBodyPhasesItemRateCardsItemKeyMaxOne).regex(createPlanBodyPhasesItemRateCardsItemKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createPlanBodyPhasesItemRateCardsItemNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createPlanBodyPhasesItemRateCardsItemDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(createPlanBodyPhasesItemRateCardsItemFeatureKeyMaxOne).regex(createPlanBodyPhasesItemRateCardsItemFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMaxOne).default(createPlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createPlanBodyPhasesItemRateCardsItemPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(createPlanBodyPhasesItemRateCardsItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createPlanBodyPhasesItemRateCardsItemDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts of the rate card.\n\nFlat fee rate cards only support percentage discounts.')
...
export const updatePlanBodyProRatingConfigEnabledDefault = true;export const updatePlanBodyProRatingConfigModeDefault = "prorate_prices";export const updatePlanBodyProRatingConfigDefault = { enabled: true, mode: "prorate_prices" };export const updatePlanBodyPhasesItemKeyMax = 64;
...
export const updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefault = false;export const updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin = 0;
...
export const updatePlanBodyPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefault = false;export const updatePlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const updatePlanBodyPhasesItemRateCardsItemPricePaymentTermDefault = "in_advance";export const updatePlanBodyPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefaultOne = false;export const updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const updatePlanBodyPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const updatePlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const updatePlanBodyPhasesItemRateCardsItemPricePaymentTermDefaultTwo = "in_advance";export const updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updatePlanBodyPhasesItemRateCardsItemPriceMultiplierDefault = "1";export const updatePlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const updatePlanBody = zod.object({
  ...
  "rateCards": zod.array(zod.union([zod.object({
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(updatePlanBodyPhasesItemRateCardsItemKeyMax).regex(updatePlanBodyPhasesItemRateCardsItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(updatePlanBodyPhasesItemRateCardsItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updatePlanBodyPhasesItemRateCardsItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(updatePlanBodyPhasesItemRateCardsItemFeatureKeyMax).regex(updatePlanBodyPhasesItemRateCardsItemFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMax).default(updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(updatePlanBodyPhasesItemRateCardsItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discount of the rate card. For flat fee rate cards only percentage discounts are supported.\nOnly available when price is set.')
}).describe('A flat fee rate card defines a one-time purchase or a recurring fee.'),zod.object({
  "type": zod.enum(['usage_based']),
  "key": zod.coerce.string().min(1).max(updatePlanBodyPhasesItemRateCardsItemKeyMaxOne).regex(updatePlanBodyPhasesItemRateCardsItemKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(updatePlanBodyPhasesItemRateCardsItemNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(updatePlanBodyPhasesItemRateCardsItemDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(updatePlanBodyPhasesItemRateCardsItemFeatureKeyMaxOne).regex(updatePlanBodyPhasesItemRateCardsItemFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMaxOne).default(updatePlanBodyPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(updatePlanBodyPhasesItemRateCardsItemPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(updatePlanBodyPhasesItemRateCardsItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(updatePlanBodyPhasesItemRateCardsItemDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts of the rate card.\n\nFlat fee rate cards only support percentage discounts.')
}).describe('A usage-based rate card defines a price based on usage.')]).describe('A rate card defines the pricing and entitlement of a feature or service.')).describe('The rate cards of the plan.')
}).describe('The plan phase or pricing ramp allows changing a plan\'s rate cards over time as a subscription progresses.')).min(1).describe('The plan phase or pricing ramp allows changing a plan\'s rate cards over time as a subscription progresses.\nA phase switch occurs only at the end of a billing period, ensuring that a single subscription invoice will not include charges from different phase prices.')
...
export const getPlanQueryParams = zod.object({
  "includeLatest": zod.coerce.boolean().optional().describe('Include latest version of the Plan instead of the version in active state.\n\nUsage: `?includeLatest=true`')
})
...
export const listPlanAddonsQueryPageDefault = 1;export const listPlanAddonsQueryPageSizeDefault = 100;
export const listPlanAddonsQueryPageSizeMax = 1000;


export const listPlanAddonsQueryParams = zod.object({
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted plan add-on assignments.\n\nUsage: `?includeDeleted=true`'),
...
export const createStripeCheckoutSessionBodyCustomerUsageAttributionSubjectKeysMin = 0;
...
export const createStripeCheckoutSessionBody = zod.object({
  ...
  "id": zod.coerce.string().regex(createStripeCheckoutSessionBodyCustomerIdRegExp).describe('ULID (Universally Unique Lexicographically Sortable Identifier).')
  ...
  "name": zod.coerce.string().min(1).max(createStripeCheckoutSessionBodyCustomerNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createStripeCheckoutSessionBodyCustomerDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "key": zod.coerce.string().min(1).max(createStripeCheckoutSessionBodyCustomerKeyMaxOne).optional().describe('An optional unique key of the customer.\nEither key or usageAttribution.subjectKeys must be provided.\nUseful to reference the customer in external systems.\nFor example, your database ID.'),
  "usageAttribution": zod.object({
  "subjectKeys": zod.array(zod.coerce.string().min(1).describe('SubjectKey is a key that is used to identify a subject.')).min(createStripeCheckoutSessionBodyCustomerUsageAttributionSubjectKeysMin).describe('The subjects that are attributed to the customer.\nCan be empty when no subjects are associated with the customer.')
}).describe('Mapping to attribute metered usage to the customer.\nOne customer can have zero or more subjects,\nbut one subject can only belong to one customer.').optional().describe('Mapping to attribute metered usage to the customer\nEither key or usageAttribution.subjectKeys must be provided.'),
  "primaryEmail": zod.coerce.string().optional().describe('The primary email address of the customer.'),
  "currency": zod.coerce.string().min(createStripeCheckoutSessionBodyCustomerCurrencyMinOne).max(createStripeCheckoutSessionBodyCustomerCurrencyMaxOne).regex(createStripeCheckoutSessionBodyCustomerCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').optional().describe('Currency of the customer.\nUsed for billing, tax and invoicing.'),
  "billingAddress": zod.object({
  "country": zod.coerce.string().min(createStripeCheckoutSessionBodyCustomerBillingAddressCountryMinOne).max(createStripeCheckoutSessionBodyCustomerBillingAddressCountryMaxOne).regex(createStripeCheckoutSessionBodyCustomerBillingAddressCountryRegExpOne).describe('[ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 country code.\nCustom two-letter country codes are also supported for convenience.').optional().describe('Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format.'),
  "postalCode": zod.coerce.string().optional().describe('Postal code.'),
  "state": zod.coerce.string().optional().describe('State or province.'),
  "city": zod.coerce.string().optional().describe('City.'),
  "line1": zod.coerce.string().optional().describe('First line of the address.'),
  ...
  "options": zod.object({
  "billingAddressCollection": zod.enum(['auto', 'required']).describe('Specify whether Checkout should collect the customer’s billing address.').optional().describe('Specify whether Checkout should collect the customer’s billing address. Defaults to auto.'),
  ...
  "currency": zod.coerce.string().min(createStripeCheckoutSessionBodyOptionsCurrencyMinOne).max(createStripeCheckoutSessionBodyOptionsCurrencyMaxOne).regex(createStripeCheckoutSessionBodyOptionsCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').optional().describe('Three-letter ISO currency code, in lowercase.'),
  "customText": zod.object({
  "afterSubmit": zod.object({
  "message": zod.coerce.string().max(createStripeCheckoutSessionBodyOptionsCustomTextAfterSubmitMessageMax).optional()
}).optional().describe('Custom text that should be displayed after the payment confirmation button.'),
  "shippingAddress": zod.object({
  "message": zod.coerce.string().max(createStripeCheckoutSessionBodyOptionsCustomTextShippingAddressMessageMax).optional()
}).optional().describe('Custom text that should be displayed alongside shipping address collection.'),
  "submit": zod.object({
  "message": zod.coerce.string().max(createStripeCheckoutSessionBodyOptionsCustomTextSubmitMessageMax).optional()
  ...
  "message": zod.coerce.string().max(createStripeCheckoutSessionBodyOptionsCustomTextTermsOfServiceAcceptanceMessageMax).optional()
  ...
  "returnURL": zod.coerce.string().optional().describe('The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method’s app or site.\nThis parameter is required if ui_mode is embedded and redirect-based payment methods are enabled on the session.'),
...
export const upsertSubjectBodyItem = zod.object({
  ...
  "metadata": zod.record(zod.string(), zod.any()).nullish().describe('Metadata for the subject.'),
...
export const createEntitlementBodyIsSoftLimitDefault = false;export const createEntitlementBodyIsUnlimitedDefault = false;export const createEntitlementBodyUsagePeriodIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const createEntitlementBodyPreserveOverageAtResetDefault = false;export const createEntitlementBodyFeatureKeyMaxOne = 64;
...
export const createEntitlementBodyUsagePeriodIntervalRegExpSix = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const createEntitlementBodyUsagePeriodIntervalRegExpOnezero = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');


export const createEntitlementBody = zod.union([zod.object({
  "featureKey": zod.coerce.string().min(1).max(createEntitlementBodyFeatureKeyMax).regex(createEntitlementBodyFeatureKeyRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(createEntitlementBodyFeatureIdRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "isUnlimited": zod.coerce.boolean().optional().describe('Deprecated, ignored by the backend. Please use isSoftLimit instead; this field will be removed in the future.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createEntitlementBodyUsagePeriodIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  ...
  "issueAfterReset": zod.coerce.number().min(createEntitlementBodyIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createEntitlementBodyIssueAfterResetPriorityMax).default(createEntitlementBodyIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.')
}).describe('Create inpurs for metered entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(createEntitlementBodyFeatureKeyMaxOne).regex(createEntitlementBodyFeatureKeyRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(createEntitlementBodyFeatureIdRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createEntitlementBodyUsagePeriodIntervalRegExpSix),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
  ...
  "featureKey": zod.coerce.string().min(1).max(createEntitlementBodyFeatureKeyMaxTwo).regex(createEntitlementBodyFeatureKeyRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(createEntitlementBodyFeatureIdRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createEntitlementBodyUsagePeriodIntervalRegExpOnezero),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['boolean'])
...
export const createGrantBodyMaxRolloverAmountDefault = 0;export const createGrantBodyMinRolloverAmountDefault = 0;export const createGrantBodyRecurrenceIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const createGrantBody = zod.object({
  ...
  "count": zod.coerce.number().min(1).max(createGrantBodyExpirationCountMax).describe('The number of time units in the expiration period.')
}).describe('The grant expiration definition').describe('The grant expiration definition'),
  "maxRolloverAmount": zod.coerce.number().optional().describe('Grants are rolled over at reset, after which they can have a different balance compared to what they had before the reset.\nBalance after the reset is calculated as: Balance_After_Reset = MIN(MaxRolloverAmount, MAX(Balance_Before_Reset, MinRolloverAmount))'),
  "minRolloverAmount": zod.coerce.number().optional().describe('Grants are rolled over at reset, after which they can have a different balance compared to what they had before the reset.\nBalance after the reset is calculated as: Balance_After_Reset = MIN(MaxRolloverAmount, MAX(Balance_Before_Reset, MinRolloverAmount))'),
  ...
  "interval": zod.union([zod.coerce.string().regex(createGrantBodyRecurrenceIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
...
export const overrideEntitlementBodyIsSoftLimitDefault = false;export const overrideEntitlementBodyIsUnlimitedDefault = false;export const overrideEntitlementBodyUsagePeriodIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const overrideEntitlementBodyPreserveOverageAtResetDefault = false;export const overrideEntitlementBodyFeatureKeyMaxOne = 64;
...
export const overrideEntitlementBodyUsagePeriodIntervalRegExpSix = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const overrideEntitlementBodyUsagePeriodIntervalRegExpOnezero = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');


export const overrideEntitlementBody = zod.union([zod.object({
  "featureKey": zod.coerce.string().min(1).max(overrideEntitlementBodyFeatureKeyMax).regex(overrideEntitlementBodyFeatureKeyRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(overrideEntitlementBodyFeatureIdRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "isUnlimited": zod.coerce.boolean().optional().describe('Deprecated, ignored by the backend. Please use isSoftLimit instead; this field will be removed in the future.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideEntitlementBodyUsagePeriodIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').describe('The usage period associated with the entitlement.'),
  "measureUsageFrom": zod.union([zod.enum(['CURRENT_PERIOD_START', 'NOW']).describe('Start of measurement options'),zod.coerce.date().describe('[RFC3339](https://tools.ietf.org/html/rfc3339) formatted date-time string in UTC.')]).describe('Measure usage from').optional().describe('Defines the time from which usage is measured. If not specified on creation, defaults to entitlement creation time.'),
  "issueAfterReset": zod.coerce.number().min(overrideEntitlementBodyIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(overrideEntitlementBodyIssueAfterResetPriorityMax).default(overrideEntitlementBodyIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.')
}).describe('Create inpurs for metered entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(overrideEntitlementBodyFeatureKeyMaxOne).regex(overrideEntitlementBodyFeatureKeyRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(overrideEntitlementBodyFeatureIdRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideEntitlementBodyUsagePeriodIntervalRegExpSix),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['static']),
  "config": zod.coerce.string().describe('The JSON parsable config of the entitlement. This value is also returned when checking entitlement access and it is useful for configuring fine-grained access settings to the feature, implemented in your own system. Has to be an object.')
}).describe('Create inputs for static entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(overrideEntitlementBodyFeatureKeyMaxTwo).regex(overrideEntitlementBodyFeatureKeyRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(overrideEntitlementBodyFeatureIdRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideEntitlementBodyUsagePeriodIntervalRegExpOnezero),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['boolean'])
}).describe('Create inputs for boolean entitlement')]).describe('Create inputs for entitlement')
...
export const createSubscriptionBodyTimingDefault = "immediate";export const createSubscriptionBodyCustomerIdRegExp = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const createSubscriptionBodyCustomPlanCurrencyDefault = "USD";export const createSubscriptionBodyCustomPlanProRatingConfigEnabledDefault = true;export const createSubscriptionBodyCustomPlanProRatingConfigModeDefault = "prorate_prices";export const createSubscriptionBodyCustomPlanProRatingConfigDefault = { enabled: true, mode: "prorate_prices" };export const createSubscriptionBodyCustomPlanPhasesItemKeyMax = 64;
...
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefault = false;export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin = 0;
...
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefault = false;export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefault = "in_advance";export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefaultOne = false;export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefaultTwo = "in_advance";export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMultiplierDefault = "1";export const createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const createSubscriptionBodyTimingDefaultFour = "immediate";export const createSubscriptionBodyCustomerIdRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const createSubscriptionBody = zod.union([zod.object({
  ...
  "plan": zod.object({
  "key": zod.coerce.string().min(1).max(createSubscriptionBodyPlanKeyMax).regex(createSubscriptionBodyPlanKeyRegExp).describe('The plan key.'),
  ...
  "timing": zod.union([zod.enum(['immediate', 'next_billing_cycle']).describe('Subscription edit timing.\nWhen immediate, the requested changes take effect immediately.\nWhen nextBillingCycle, the requested changes take effect at the next billing cycle.'),zod.coerce.date().describe('[RFC3339](https://tools.ietf.org/html/rfc3339) formatted date-time string in UTC.')]).describe('Subscription edit timing defined when the changes should take effect.\nIf the provided configuration is not supported by the subscription, an error will be returned.').default(createSubscriptionBodyTimingDefault).describe('Timing configuration for the change, when the change should take effect.\nThe default is immediate.'),
  "customerId": zod.coerce.string().regex(createSubscriptionBodyCustomerIdRegExp).optional().describe('The ID of the customer. Provide either the key or ID. Has presedence over the key.'),
  "customerKey": zod.coerce.string().min(1).max(createSubscriptionBodyCustomerKeyMax).optional().describe('The key of the customer. Provide either the key or ID.'),
  ...
  "name": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createSubscriptionBodyCustomPlanDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "alignment": zod.object({
  "billablesMustAlign": zod.coerce.boolean().optional().describe('Whether all Billable items and RateCards must align.\nAlignment means the Price\'s BillingCadence must align for both duration and anchor time.')
}).describe('Alignment configuration for a plan or subscription.').optional().describe('Alignment configuration for the plan.'),
  "currency": zod.coerce.string().min(createSubscriptionBodyCustomPlanCurrencyMinOne).max(createSubscriptionBodyCustomPlanCurrencyMaxOne).regex(createSubscriptionBodyCustomPlanCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').describe('The currency code of the plan.'),
  "billingCadence": zod.coerce.string().describe('The default billing cadence for subscriptions using this plan.\nDefines how often customers are billed using ISO8601 duration format.\nExamples: \"P1M\" (monthly), \"P3M\" (quarterly), \"P1Y\" (annually).'),
  "proRatingConfig": zod.object({
  "enabled": zod.coerce.boolean().describe('Whether pro-rating is enabled for this plan.'),
  "mode": zod.enum(['prorate_prices']).describe('Pro-rating mode options for handling billing period changes.').describe('How to handle pro-rating for billing period changes.')
}).describe('Configuration for pro-rating behavior.').default(createSubscriptionBodyCustomPlanProRatingConfigDefault).describe('Default pro-rating configuration for subscriptions using this plan.'),
  "phases": zod.array(zod.object({
  "key": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemKeyMax).regex(createSubscriptionBodyCustomPlanPhasesItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createSubscriptionBodyCustomPlanPhasesItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "duration": zod.coerce.string().nullable().describe('The duration of the phase.'),
  "rateCards": zod.array(zod.union([zod.object({
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyMax).regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyMax).regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMax).default(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discount of the rate card. For flat fee rate cards only percentage discounts are supported.\nOnly available when price is set.')
}).describe('A flat fee rate card defines a one-time purchase or a recurring fee.'),zod.object({
  "type": zod.enum(['usage_based']),
  "key": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyMaxOne).regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyMaxOne).regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMaxOne).default(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(createSubscriptionBodyCustomPlanPhasesItemRateCardsItemDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts of the rate card.\n\nFlat fee rate cards only support percentage discounts.')
}).describe('A usage-based rate card defines a price based on usage.')]).describe('A rate card defines the pricing and entitlement of a feature or service.')).describe('The rate cards of the plan.')
}).describe('The plan phase or pricing ramp allows changing a plan\'s rate cards over time as a subscription progresses.')).min(1).describe('The plan phase or pricing ramp allows changing a plan\'s rate cards over time as a subscription progresses.\nA phase switch occurs only at the end of a billing period, ensuring that a single subscription invoice will not include charges from different phase prices.')
  ...
  "timing": zod.union([zod.enum(['immediate', 'next_billing_cycle']).describe('Subscription edit timing.\nWhen immediate, the requested changes take effect immediately.\nWhen nextBillingCycle, the requested changes take effect at the next billing cycle.'),zod.coerce.date().describe('[RFC3339](https://tools.ietf.org/html/rfc3339) formatted date-time string in UTC.')]).describe('Subscription edit timing defined when the changes should take effect.\nIf the provided configuration is not supported by the subscription, an error will be returned.').default(createSubscriptionBodyTimingDefaultFour).describe('Timing configuration for the change, when the change should take effect.\nThe default is immediate.'),
  "customerId": zod.coerce.string().regex(createSubscriptionBodyCustomerIdRegExpOne).optional().describe('The ID of the customer. Provide either the key or ID. Has presedence over the key.'),
  "customerKey": zod.coerce.string().min(1).max(createSubscriptionBodyCustomerKeyMaxOne).optional().describe('The key of the customer. Provide either the key or ID.'),
  "billingAnchor": zod.coerce.date().optional().describe('The billing anchor of the subscription. The provided date will be normalized according to the billing cadence to the nearest recurrence before start time. If not provided, the subscription start time will be used.')
...
export const editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIsSoftLimitDefault = false;export const editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetMin = 0;
...
export const editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplatePreserveOverageAtResetDefault = false;export const editSubscriptionBodyCustomizationsItemRateCardTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const editSubscriptionBodyCustomizationsItemRateCardPricePaymentTermDefault = "in_advance";export const editSubscriptionBodyCustomizationsItemRateCardDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIsSoftLimitDefaultOne = false;export const editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const editSubscriptionBodyCustomizationsItemRateCardTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const editSubscriptionBodyCustomizationsItemRateCardPricePaymentTermDefaultTwo = "in_advance";export const editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const editSubscriptionBodyCustomizationsItemRateCardPriceMultiplierDefault = "1";export const editSubscriptionBodyCustomizationsItemRateCardPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const editSubscriptionBody = zod.object({
  ...
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemRateCardKeyMax).regex(editSubscriptionBodyCustomizationsItemRateCardKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemRateCardNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(editSubscriptionBodyCustomizationsItemRateCardDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemRateCardFeatureKeyMax).regex(editSubscriptionBodyCustomizationsItemRateCardFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetPriorityMax).default(editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(editSubscriptionBodyCustomizationsItemRateCardPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discount of the rate card. For flat fee rate cards only percentage discounts are supported.\nOnly available when price is set.')
}).describe('A flat fee rate card defines a one-time purchase or a recurring fee.'),zod.object({
  "type": zod.enum(['usage_based']),
  "key": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemRateCardKeyMaxOne).regex(editSubscriptionBodyCustomizationsItemRateCardKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemRateCardNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(editSubscriptionBodyCustomizationsItemRateCardDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemRateCardFeatureKeyMaxOne).regex(editSubscriptionBodyCustomizationsItemRateCardFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetPriorityMaxOne).default(editSubscriptionBodyCustomizationsItemRateCardEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(editSubscriptionBodyCustomizationsItemRateCardPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(editSubscriptionBodyCustomizationsItemRateCardPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemRateCardDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts of the rate card.\n\nFlat fee rate cards only support percentage discounts.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(editSubscriptionBodyCustomizationsItemPhaseDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts on the plan.'),
  "key": zod.coerce.string().min(1).max(editSubscriptionBodyCustomizationsItemPhaseKeyMaxTwo).regex(editSubscriptionBodyCustomizationsItemPhaseKeyRegExpTwo).describe('A locally unique identifier for the phase.'),
...
export const changeSubscriptionBodyCustomPlanCurrencyDefault = "USD";export const changeSubscriptionBodyCustomPlanProRatingConfigEnabledDefault = true;export const changeSubscriptionBodyCustomPlanProRatingConfigModeDefault = "prorate_prices";export const changeSubscriptionBodyCustomPlanProRatingConfigDefault = { enabled: true, mode: "prorate_prices" };export const changeSubscriptionBodyCustomPlanPhasesItemKeyMax = 64;
...
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefault = false;export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin = 0;
...
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefault = false;export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExp = new RegExp('^txcd_\\d{8}$');
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefault = "in_advance";export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIsSoftLimitDefaultOne = false;export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne = 0;
...
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplatePreserveOverageAtResetDefaultOne = false;export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne = new RegExp('^txcd_\\d{8}$');
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpThree = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefaultTwo = "in_advance";export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMultiplierDefault = "1";export const changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpFive = new RegExp('^\\-?[0-9]+(\\.[0-9]+)?$');
...
export const changeSubscriptionBody = zod.union([zod.object({
  ...
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Arbitrary metadata associated with the subscription.'),
  "plan": zod.object({
  "key": zod.coerce.string().min(1).max(changeSubscriptionBodyPlanKeyMax).regex(changeSubscriptionBodyPlanKeyRegExp).describe('The plan key.'),
  "version": zod.coerce.number().optional().describe('The plan version.')
}).describe('References an exact plan defaulting to the current active version.').describe('The plan reference to change to.'),
  "startingPhase": zod.coerce.string().min(1).optional().describe('The key of the phase to start the subscription in.\nIf not provided, the subscription will start in the first phase of the plan.'),
  "name": zod.coerce.string().optional().describe('The name of the Subscription. If not provided the plan name is used.'),
  ...
  "billingAnchor": zod.coerce.date().optional().describe('The billing anchor of the subscription. The provided date will be normalized according to the billing cadence to the nearest recurrence before start time. If not provided, the previous subscription billing anchor will be used.'),
  "customPlan": zod.object({
  "name": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(changeSubscriptionBodyCustomPlanDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "alignment": zod.object({
  "billablesMustAlign": zod.coerce.boolean().optional().describe('Whether all Billable items and RateCards must align.\nAlignment means the Price\'s BillingCadence must align for both duration and anchor time.')
}).describe('Alignment configuration for a plan or subscription.').optional().describe('Alignment configuration for the plan.'),
  "currency": zod.coerce.string().min(changeSubscriptionBodyCustomPlanCurrencyMinOne).max(changeSubscriptionBodyCustomPlanCurrencyMaxOne).regex(changeSubscriptionBodyCustomPlanCurrencyRegExpOne).describe('Three-letter [ISO4217](https://www.iso.org/iso-4217-currency-codes.html) currency code.\nCustom three-letter currency codes are also supported for convenience.').describe('The currency code of the plan.'),
  "billingCadence": zod.coerce.string().describe('The default billing cadence for subscriptions using this plan.\nDefines how often customers are billed using ISO8601 duration format.\nExamples: \"P1M\" (monthly), \"P3M\" (quarterly), \"P1Y\" (annually).'),
  "proRatingConfig": zod.object({
  "enabled": zod.coerce.boolean().describe('Whether pro-rating is enabled for this plan.'),
  "mode": zod.enum(['prorate_prices']).describe('Pro-rating mode options for handling billing period changes.').describe('How to handle pro-rating for billing period changes.')
}).describe('Configuration for pro-rating behavior.').default(changeSubscriptionBodyCustomPlanProRatingConfigDefault).describe('Default pro-rating configuration for subscriptions using this plan.'),
  "phases": zod.array(zod.object({
  "key": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemKeyMax).regex(changeSubscriptionBodyCustomPlanPhasesItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(changeSubscriptionBodyCustomPlanPhasesItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "duration": zod.coerce.string().nullable().describe('The duration of the phase.'),
  "rateCards": zod.array(zod.union([zod.object({
  "type": zod.enum(['flat_fee']),
  "key": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyMax).regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyRegExp).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemNameMax).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemDescriptionMax).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyMax).regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyRegExp).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMax).default(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExp).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefault).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemDiscountsUsageQuantityRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discount of the rate card. For flat fee rate cards only percentage discounts are supported.\nOnly available when price is set.')
}).describe('A flat fee rate card defines a one-time purchase or a recurring fee.'),zod.object({
  "type": zod.enum(['usage_based']),
  "key": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyMaxOne).regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemKeyRegExpOne).describe('A semi-unique identifier for the resource.'),
  "name": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemNameMaxOne).describe('Human-readable name for the resource. Between 1 and 256 characters.'),
  "description": zod.coerce.string().max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemDescriptionMaxOne).optional().describe('Optional description of the resource. Maximum 1024 characters.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').nullish().describe('Additional metadata for the resource.'),
  "featureKey": zod.coerce.string().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyMaxOne).regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemFeatureKeyRegExpOne).optional().describe('The feature the customer is entitled to use.'),
  "entitlementTemplate": zod.union([zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "issueAfterReset": zod.coerce.number().min(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetMinOne).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityMaxOne).default(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemEntitlementTemplateIssueAfterResetPriorityDefaultOne).describe('Defines the grant priority for the default grant.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "usagePeriod": zod.coerce.string().optional().describe('The interval of the metered entitlement.\nDefaults to the billing cadence of the rate card.')
}).describe('The entitlement template with a metered entitlement.'),zod.object({
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  ...
  "behavior": zod.enum(['inclusive', 'exclusive']).describe('Tax behavior.\n\nThis enum is used to specify whether tax is included in the price or excluded from the price.').optional().describe('Tax behavior.\n\nIf not specified the billing profile is used to determine the tax behavior.\nIf not specified in the billing profile, the provider\'s default behavior is used.'),
  "stripe": zod.object({
  "code": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemTaxConfigStripeCodeRegExpOne).describe('Product tax code.\n\nSee: https://docs.stripe.com/tax/tax-codes')
}).describe('The tax config for Stripe.').optional().describe('Stripe tax config.'),
  "customInvoicing": zod.object({
  "code": zod.coerce.string().describe('Tax code.\n\nThe tax code should be interpreted by the custom invoicing provider.')
}).describe('Custom invoicing tax config.').optional().describe('Custom invoicing tax config.')
  ...
  "price": zod.union([zod.object({
  "type": zod.enum(['flat']),
  "amount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.'),
  "paymentTerm": zod.enum(['in_advance', 'in_arrears']).describe('The payment term of a flat price.\nOne of: in_advance or in_arrears.').default(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPricePaymentTermDefaultTwo).describe('The payment term of the flat price.\nDefaults to in advance.')
}).describe('Flat price with payment term.'),zod.object({
  "type": zod.enum(['unit']),
  "amount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.'),
  "minimumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Unit price with spend commitments.'),zod.object({
  "type": zod.enum(['tiered']),
  "mode": zod.enum(['volume', 'graduated']).describe('The mode of the tiered price.').describe('Defines if the tiering mode is volume-based or graduated:\n- In `volume`-based tiering, the maximum quantity within a period determines the per unit price.\n- In `graduated` tiering, pricing can change as the quantity grows.'),
  "tiers": zod.array(zod.object({
  "upToAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceTiersItemUpToAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').optional().describe('Up to and including to this quantity will be contained in the tier.\nIf null, the tier is open-ended.'),
  "flatPrice": zod.object({
  "type": zod.enum(['flat']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceTiersItemFlatPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the flat price.')
}).describe('Flat price.').nullable().describe('The flat price component of the tier.'),
  "unitPrice": zod.object({
  "type": zod.enum(['unit']).describe('The type of the price.'),
  "amount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceTiersItemUnitPriceAmountRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The amount of the unit price.')
}).describe('Unit price.').nullable().describe('The unit price component of the tier.')
}).describe('A price tier.\nAt least one price component is required in each tier.')).min(1).describe('The tiers of the tiered price.\nAt least one price component is required in each tier.'),
  "minimumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpThree).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Tiered price with spend commitments.'),zod.object({
  "type": zod.enum(['dynamic']),
  "multiplier": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMultiplierRegExpOne).describe('Numeric represents an arbitrary precision number.').default(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMultiplierDefault).describe('The multiplier to apply to the base price to get the dynamic price.\n\nExamples:\n- 0.0: the price is zero\n- 0.5: the price is 50% of the base price\n- 1.0: the price is the same as the base price\n- 1.5: the price is 150% of the base price'),
  "minimumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpFive).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Dynamic price with spend commitments.'),zod.object({
  "type": zod.enum(['package']),
  "amount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').describe('The price of one package.'),
  "quantityPerPackage": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceQuantityPerPackageRegExpOne).describe('Numeric represents an arbitrary precision number.').describe('The quantity per package.'),
  "minimumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMinimumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is committed to spend at least the amount.'),
  "maximumAmount": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemPriceMaximumAmountRegExpSeven).describe('Numeric represents an arbitrary precision number.').optional().describe('The customer is limited to spend at most the amount.')
}).describe('Package price with spend commitments.')]).describe('The price of the usage based rate card.').nullable().describe('The price of the rate card.\nWhen null, the feature or service is free.'),
  "discounts": zod.object({
  "percentage": zod.object({
  "percentage": zod.coerce.number().describe('Numeric representation of a percentage\n\n50% is represented as 50').describe('The percentage of the discount.')
  ...
  "usage": zod.object({
  "quantity": zod.coerce.string().regex(changeSubscriptionBodyCustomPlanPhasesItemRateCardsItemDiscountsUsageQuantityRegExpThree).describe('Numeric represents an arbitrary precision number.').describe('The quantity of the usage discount.\n\nMust be positive.')
}).describe('Usage discount.\n\nUsage discount means that the first N items are free. From billing perspective\nthis means that any usage on a specific feature is considered 0 until this discount\nis exhausted.').optional().describe('The usage discount.')
}).describe('Discount by type on a price').optional().describe('The discounts of the rate card.\n\nFlat fee rate cards only support percentage discounts.')
}).describe('A usage-based rate card defines a price based on usage.')]).describe('A rate card defines the pricing and entitlement of a feature or service.')).describe('The rate cards of the plan.')
}).describe('The plan phase or pricing ramp allows changing a plan\'s rate cards over time as a subscription progresses.')).min(1).describe('The plan phase or pricing ramp allows changing a plan\'s rate cards over time as a subscription progresses.\nA phase switch occurs only at the end of a billing period, ensuring that a single subscription invoice will not include charges from different phase prices.')
 ...
 */
export const createCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const createCustomerEntitlementV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(createCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(createCustomerEntitlementV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
...
export const createCustomerEntitlementV2BodyIsSoftLimitDefault = false;export const createCustomerEntitlementV2BodyUsagePeriodIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
export const createCustomerEntitlementV2BodyPreserveOverageAtResetDefault = false;export const createCustomerEntitlementV2BodyIssueAfterResetMin = 0;
...
export const createCustomerEntitlementV2BodyGrantsItemMinRolloverAmountDefault = 0;export const createCustomerEntitlementV2BodyGrantsItemRecurrenceIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const createCustomerEntitlementV2BodyUsagePeriodIntervalRegExpSix = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const createCustomerEntitlementV2BodyUsagePeriodIntervalRegExpOnezero = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');


export const createCustomerEntitlementV2Body = zod.union([zod.object({
  "featureKey": zod.coerce.string().min(1).max(createCustomerEntitlementV2BodyFeatureKeyMax).regex(createCustomerEntitlementV2BodyFeatureKeyRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(createCustomerEntitlementV2BodyFeatureIdRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createCustomerEntitlementV2BodyUsagePeriodIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').describe('The usage period associated with the entitlement.'),
  "measureUsageFrom": zod.union([zod.enum(['CURRENT_PERIOD_START', 'NOW']).describe('Start of measurement options'),zod.coerce.date().describe('[RFC3339](https://tools.ietf.org/html/rfc3339) formatted date-time string in UTC.')]).describe('Measure usage from').optional().describe('Defines the time from which usage is measured. If not specified on creation, defaults to entitlement creation time.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "issueAfterReset": zod.coerce.number().min(createCustomerEntitlementV2BodyIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(createCustomerEntitlementV2BodyIssueAfterResetPriorityMax).default(createCustomerEntitlementV2BodyIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "issue": zod.object({
  "amount": zod.coerce.number().min(createCustomerEntitlementV2BodyIssueAmountMin).describe('The initial grant amount'),
  "priority": zod.coerce.number().min(1).max(createCustomerEntitlementV2BodyIssuePriorityMax).default(createCustomerEntitlementV2BodyIssuePriorityDefault).describe('The priority of the issue after reset')
}).describe('Issue after reset').optional().describe('Issue after reset'),
  "grants": zod.array(zod.object({
  "amount": zod.coerce.number().min(createCustomerEntitlementV2BodyGrantsItemAmountMin).describe('The amount to grant. Should be a positive number.'),
  "priority": zod.coerce.number().min(1).max(createCustomerEntitlementV2BodyGrantsItemPriorityMax).optional().describe('The priority of the grant. Grants with higher priority are applied first.\nPriority is a positive decimal numbers. With lower numbers indicating higher importance.\nFor example, a priority of 1 is more urgent than a priority of 2.\nWhen there are several grants available for the same subject, the system selects the grant with the highest priority.\nIn cases where grants share the same priority level, the grant closest to its expiration will be used first.\nIn the case of two grants have identical priorities and expiration dates, the system will use the grant that was created first.'),
  "effectiveAt": zod.coerce.date().describe('Effective date for grants and anchor for recurring grants. Provided value will be ceiled to metering windowSize (minute).'),
  "minRolloverAmount": zod.coerce.number().optional().describe('Grants are rolled over at reset, after which they can have a different balance compared to what they had before the reset.\nBalance after the reset is calculated as: Balance_After_Reset = MIN(MaxRolloverAmount, MAX(Balance_Before_Reset, MinRolloverAmount))'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('The grant metadata.'),
  "recurrence": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createCustomerEntitlementV2BodyGrantsItemRecurrenceIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The subject of the grant.'),
  ...
  "expiration": zod.object({
  "duration": zod.enum(['HOUR', 'DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The expiration duration enum').describe('The unit of time for the expiration period.'),
  "count": zod.coerce.number().min(1).max(createCustomerEntitlementV2BodyGrantsItemExpirationCountMax).describe('The number of time units in the expiration period.')
  ...
  "annotations": zod.record(zod.string(), zod.any()).describe('Set of key-value pairs managed by the system. Cannot be modified by user.').optional().describe('Grant annotations')
}).describe('The grant creation input.')).optional().describe('Grants')
}).describe('Create inputs for metered entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(createCustomerEntitlementV2BodyFeatureKeyMaxOne).regex(createCustomerEntitlementV2BodyFeatureKeyRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(createCustomerEntitlementV2BodyFeatureIdRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createCustomerEntitlementV2BodyUsagePeriodIntervalRegExpSix),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['static']),
  "config": zod.coerce.string().describe('The JSON parsable config of the entitlement. This value is also returned when checking entitlement access and it is useful for configuring fine-grained access settings to the feature, implemented in your own system. Has to be an object.')
}).describe('Create inputs for static entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(createCustomerEntitlementV2BodyFeatureKeyMaxTwo).regex(createCustomerEntitlementV2BodyFeatureKeyRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(createCustomerEntitlementV2BodyFeatureIdRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createCustomerEntitlementV2BodyUsagePeriodIntervalRegExpOnezero),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['boolean'])
}).describe('Create inputs for boolean entitlement')]).describe('Create inputs for entitlement')
 ...
 */
export const listCustomerEntitlementsV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const listCustomerEntitlementsV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(listCustomerEntitlementsV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(listCustomerEntitlementsV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})

export const listCustomerEntitlementsV2QueryIncludeDeletedDefault = false;export const listCustomerEntitlementsV2QueryPageDefault = 1;export const listCustomerEntitlementsV2QueryPageSizeDefault = 100;
 ...
 */
export const getCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const getCustomerEntitlementV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(getCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(getCustomerEntitlementV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
 ...
 */
export const deleteCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const deleteCustomerEntitlementV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(deleteCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(deleteCustomerEntitlementV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
 ...
 */
export const listCustomerEntitlementGrantsV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const listCustomerEntitlementGrantsV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(listCustomerEntitlementGrantsV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(listCustomerEntitlementGrantsV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
...
export const listCustomerEntitlementGrantsV2QueryIncludeDeletedDefault = false;export const listCustomerEntitlementGrantsV2QueryPageDefault = 1;export const listCustomerEntitlementGrantsV2QueryPageSizeDefault = 100;
...
export const listCustomerEntitlementGrantsV2QueryParams = zod.object({
  ...
  "offset": zod.coerce.number().min(listCustomerEntitlementGrantsV2QueryOffsetMin).optional().describe('Number of items to skip.\n\nDefault is 0.'),
 ...
 */
export const createCustomerEntitlementGrantV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const createCustomerEntitlementGrantV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(createCustomerEntitlementGrantV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(createCustomerEntitlementGrantV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
...
export const createCustomerEntitlementGrantV2BodyMinRolloverAmountDefault = 0;export const createCustomerEntitlementGrantV2BodyRecurrenceIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const createCustomerEntitlementGrantV2Body = zod.object({
  ...
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('The grant metadata.'),
  "recurrence": zod.object({
  "interval": zod.union([zod.coerce.string().regex(createCustomerEntitlementGrantV2BodyRecurrenceIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The subject of the grant.'),
  "maxRolloverAmount": zod.coerce.number().optional().describe('Grants are rolled over at reset, after which they can have a different balance compared to what they had before the reset. The default value equals grant amount.\nBalance after the reset is calculated as: Balance_After_Reset = MIN(MaxRolloverAmount, MAX(Balance_Before_Reset, MinRolloverAmount))'),
  "expiration": zod.object({
  "duration": zod.enum(['HOUR', 'DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The expiration duration enum').describe('The unit of time for the expiration period.'),
  "count": zod.coerce.number().min(1).max(createCustomerEntitlementGrantV2BodyExpirationCountMax).describe('The number of time units in the expiration period.')
}).describe('The grant expiration definition').optional().describe('The grant expiration definition. If no expiration is provided, the grant can be active indefinitely.'),
  "annotations": zod.record(zod.string(), zod.any()).describe('Set of key-value pairs managed by the system. Cannot be modified by user.').optional().describe('Grant annotations')
}).describe('The grant creation input.')
 ...
 */
export const getCustomerEntitlementHistoryV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const getCustomerEntitlementHistoryV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(getCustomerEntitlementHistoryV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(getCustomerEntitlementHistoryV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
 ...
 */
export const overrideCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const overrideCustomerEntitlementV2PathCustomerIdOrKeyMaxTwo = 256;
export const overrideCustomerEntitlementV2PathEntitlementIdOrFeatureKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const overrideCustomerEntitlementV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(overrideCustomerEntitlementV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(overrideCustomerEntitlementV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
  "entitlementIdOrFeatureKey": zod.union([zod.coerce.string().regex(overrideCustomerEntitlementV2PathEntitlementIdOrFeatureKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(overrideCustomerEntitlementV2PathEntitlementIdOrFeatureKeyMaxTwo).describe('ExternalKey is a looser version of key.')])
})
...
export const overrideCustomerEntitlementV2BodyIsSoftLimitDefault = false;export const overrideCustomerEntitlementV2BodyUsagePeriodIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
export const overrideCustomerEntitlementV2BodyPreserveOverageAtResetDefault = false;export const overrideCustomerEntitlementV2BodyIssueAfterResetMin = 0;
...
export const overrideCustomerEntitlementV2BodyGrantsItemMinRolloverAmountDefault = 0;export const overrideCustomerEntitlementV2BodyGrantsItemRecurrenceIntervalRegExpTwo = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const overrideCustomerEntitlementV2BodyUsagePeriodIntervalRegExpSix = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');
...
export const overrideCustomerEntitlementV2BodyUsagePeriodIntervalRegExpOnezero = new RegExp('^P(?:\\d+(?:\\.\\d+)?Y)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$');


export const overrideCustomerEntitlementV2Body = zod.union([zod.object({
  "featureKey": zod.coerce.string().min(1).max(overrideCustomerEntitlementV2BodyFeatureKeyMax).regex(overrideCustomerEntitlementV2BodyFeatureKeyRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(overrideCustomerEntitlementV2BodyFeatureIdRegExp).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "type": zod.enum(['metered']),
  "isSoftLimit": zod.coerce.boolean().optional().describe('If softLimit=true the subject can use the feature even if the entitlement is exhausted, hasAccess will always be true.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideCustomerEntitlementV2BodyUsagePeriodIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').describe('The usage period associated with the entitlement.'),
  "measureUsageFrom": zod.union([zod.enum(['CURRENT_PERIOD_START', 'NOW']).describe('Start of measurement options'),zod.coerce.date().describe('[RFC3339](https://tools.ietf.org/html/rfc3339) formatted date-time string in UTC.')]).describe('Measure usage from').optional().describe('Defines the time from which usage is measured. If not specified on creation, defaults to entitlement creation time.'),
  "preserveOverageAtReset": zod.coerce.boolean().optional().describe('If true, the overage is preserved at reset. If false, the usage is reset to 0.'),
  "issueAfterReset": zod.coerce.number().min(overrideCustomerEntitlementV2BodyIssueAfterResetMin).optional().describe('You can grant usage automatically alongside the entitlement, the example scenario would be creating a starting balance.\nIf an amount is specified here, a grant will be created alongside the entitlement with the specified amount.\nThat grant will have it\'s rollover settings configured in a way that after each reset operation, the balance will return the original amount specified here.\nManually creating such a grant would mean having the \"amount\", \"minRolloverAmount\", and \"maxRolloverAmount\" fields all be the same.'),
  "issueAfterResetPriority": zod.coerce.number().min(1).max(overrideCustomerEntitlementV2BodyIssueAfterResetPriorityMax).default(overrideCustomerEntitlementV2BodyIssueAfterResetPriorityDefault).describe('Defines the grant priority for the default grant.'),
  "issue": zod.object({
  "amount": zod.coerce.number().min(overrideCustomerEntitlementV2BodyIssueAmountMin).describe('The initial grant amount'),
  "priority": zod.coerce.number().min(1).max(overrideCustomerEntitlementV2BodyIssuePriorityMax).default(overrideCustomerEntitlementV2BodyIssuePriorityDefault).describe('The priority of the issue after reset')
}).describe('Issue after reset').optional().describe('Issue after reset'),
  "grants": zod.array(zod.object({
  "amount": zod.coerce.number().min(overrideCustomerEntitlementV2BodyGrantsItemAmountMin).describe('The amount to grant. Should be a positive number.'),
  "priority": zod.coerce.number().min(1).max(overrideCustomerEntitlementV2BodyGrantsItemPriorityMax).optional().describe('The priority of the grant. Grants with higher priority are applied first.\nPriority is a positive decimal numbers. With lower numbers indicating higher importance.\nFor example, a priority of 1 is more urgent than a priority of 2.\nWhen there are several grants available for the same subject, the system selects the grant with the highest priority.\nIn cases where grants share the same priority level, the grant closest to its expiration will be used first.\nIn the case of two grants have identical priorities and expiration dates, the system will use the grant that was created first.'),
  "effectiveAt": zod.coerce.date().describe('Effective date for grants and anchor for recurring grants. Provided value will be ceiled to metering windowSize (minute).'),
  "minRolloverAmount": zod.coerce.number().optional().describe('Grants are rolled over at reset, after which they can have a different balance compared to what they had before the reset.\nBalance after the reset is calculated as: Balance_After_Reset = MIN(MaxRolloverAmount, MAX(Balance_Before_Reset, MinRolloverAmount))'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('The grant metadata.'),
  "recurrence": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideCustomerEntitlementV2BodyGrantsItemRecurrenceIntervalRegExpTwo),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The subject of the grant.'),
  "maxRolloverAmount": zod.coerce.number().optional().describe('Grants are rolled over at reset, after which they can have a different balance compared to what they had before the reset. The default value equals grant amount.\nBalance after the reset is calculated as: Balance_After_Reset = MIN(MaxRolloverAmount, MAX(Balance_Before_Reset, MinRolloverAmount))'),
  "expiration": zod.object({
  "duration": zod.enum(['HOUR', 'DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The expiration duration enum').describe('The unit of time for the expiration period.'),
  "count": zod.coerce.number().min(1).max(overrideCustomerEntitlementV2BodyGrantsItemExpirationCountMax).describe('The number of time units in the expiration period.')
}).describe('The grant expiration definition').optional().describe('The grant expiration definition. If no expiration is provided, the grant can be active indefinitely.'),
  "annotations": zod.record(zod.string(), zod.any()).describe('Set of key-value pairs managed by the system. Cannot be modified by user.').optional().describe('Grant annotations')
}).describe('The grant creation input.')).optional().describe('Grants')
}).describe('Create inputs for metered entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(overrideCustomerEntitlementV2BodyFeatureKeyMaxOne).regex(overrideCustomerEntitlementV2BodyFeatureKeyRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(overrideCustomerEntitlementV2BodyFeatureIdRegExpOne).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideCustomerEntitlementV2BodyUsagePeriodIntervalRegExpSix),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['static']),
  "config": zod.coerce.string().describe('The JSON parsable config of the entitlement. This value is also returned when checking entitlement access and it is useful for configuring fine-grained access settings to the feature, implemented in your own system. Has to be an object.')
}).describe('Create inputs for static entitlement'),zod.object({
  "featureKey": zod.coerce.string().min(1).max(overrideCustomerEntitlementV2BodyFeatureKeyMaxTwo).regex(overrideCustomerEntitlementV2BodyFeatureKeyRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "featureId": zod.coerce.string().regex(overrideCustomerEntitlementV2BodyFeatureIdRegExpTwo).optional().describe('The feature the subject is entitled to use.\nEither featureKey or featureId is required.'),
  "metadata": zod.record(zod.string(), zod.coerce.string()).describe('Set of key-value pairs.\nMetadata can be used to store additional information about a resource.').optional().describe('Additional metadata for the feature.'),
  "usagePeriod": zod.object({
  "interval": zod.union([zod.coerce.string().regex(overrideCustomerEntitlementV2BodyUsagePeriodIntervalRegExpOnezero),zod.enum(['DAY', 'WEEK', 'MONTH', 'YEAR']).describe('The unit of time for the interval.\nOne of: `day`, `week`, `month`, or `year`.')]).describe('Period duration for the recurrence').describe('The unit of time for the interval.'),
  "anchor": zod.coerce.date().optional().describe('A date-time anchor to base the recurring period on.')
}).describe('Recurring period with an interval and an anchor.').optional().describe('The usage period associated with the entitlement.'),
  "type": zod.enum(['boolean'])
}).describe('Create inputs for boolean entitlement')]).describe('Create inputs for entitlement')
 ...
 */
export const resetCustomerEntitlementUsageV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const resetCustomerEntitlementUsageV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(resetCustomerEntitlementUsageV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(resetCustomerEntitlementUsageV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
 ...
 * @summary Get customer entitlement value
 */
export const getCustomerEntitlementValueV2PathCustomerIdOrKeyRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
...
export const getCustomerEntitlementValueV2Params = zod.object({
  "customerIdOrKey": zod.union([zod.coerce.string().regex(getCustomerEntitlementValueV2PathCustomerIdOrKeyRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(getCustomerEntitlementValueV2PathCustomerIdOrKeyMaxTwo).describe('ExternalKey is a looser version of key.')]),
 ...
 * @summary List all entitlements
 */
export const listEntitlementsV2QueryExcludeInactiveDefault = false;export const listEntitlementsV2QueryPageDefault = 1;export const listEntitlementsV2QueryPageSizeDefault = 100;
...
export const listEntitlementsV2QueryParams = zod.object({
  ...
  "offset": zod.coerce.number().min(listEntitlementsV2QueryOffsetMin).optional().describe('Number of items to skip.\n\nDefault is 0.'),
 ...
 * @summary List grants
 */
export const listGrantsV2QueryCustomerItemRegExpOne = new RegExp('^[0-7][0-9A-HJKMNP-TV-Za-hjkmnp-tv-z]{25}$');
export const listGrantsV2QueryCustomerItemMaxTwo = 256;
export const listGrantsV2QueryIncludeDeletedDefault = false;export const listGrantsV2QueryPageDefault = 1;export const listGrantsV2QueryPageSizeDefault = 100;
...
export const listGrantsV2QueryParams = zod.object({
  "feature": zod.array(zod.coerce.string()).optional().describe('Filtering by multiple features.\n\nUsage: `?feature=feature-1&feature=feature-2`'),
  "customer": zod.array(zod.union([zod.coerce.string().regex(listGrantsV2QueryCustomerItemRegExpOne).describe('ULID (Universally Unique Lexicographically Sortable Identifier).'),zod.coerce.string().min(1).max(listGrantsV2QueryCustomerItemMaxTwo).describe('ExternalKey is a looser version of key.')]).describe('ULID (Universally Unique Lexicographically Sortable Identifier) or external unique key.')).optional().describe('Filtering by multiple customers (either by ID or key).\n\nUsage: `?customer=customer-1&customer=customer-2`'),
  "includeDeleted": zod.coerce.boolean().optional().describe('Include deleted'),
  ...
  "offset": zod.coerce.number().min(listGrantsV2QueryOffsetMin).optional().describe('Number of items to skip.\n\nDefault is 0.'),
