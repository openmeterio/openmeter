...
export const createBillingProfileBodyWorkflowOneCollectionOneAlignmentDefault =
  { type: 'subscription' as const } as const
            ...
            proRatingConfig: zod
              .object({
                enabled: zod.coerce
                  .boolean()
                  .default(
                    createSubscriptionBodyTwoCustomPlanOneOneProRatingConfigOneEnabledDefault,
                  )
                  .describe('Whether pro-rating is enabled for this plan.'),
                mode: zod
                  .enum(['prorate_prices'])
            ...
            proRatingConfig: zod
              .object({
                enabled: zod.coerce
                  .boolean()
                  .default(
                    changeSubscriptionBodyTwoCustomPlanOneOneProRatingConfigOneEnabledDefault,
                  )
                  .describe('Whether pro-rating is enabled for this plan.'),
                mode: zod
                  .enum(['prorate_prices'])
                  ...
                  .default(
                    changeSubscriptionBodyTwoCustomPlanOneOneProRatingConfigOneModeDefault,
                  )
                  .describe(
                    'How to handle pro-rating for billing period changes.',
                  ),
