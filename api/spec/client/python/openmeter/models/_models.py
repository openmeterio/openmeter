...
class Addon(_Model):
    ...
    :vartype metadata: ~openmeter.models.Metadata
    ...
    :vartype annotations: ~openmeter.models.Annotations
    ...
    :vartype rate_cards: list[~openmeter.models.RateCardFlatFee or
     ~openmeter.models.RateCardUsageBased]
    :ivar validation_errors: Validation errors. Required.
    :vartype validation_errors: list[~openmeter.models.ValidationError]
    """
...
class AppPaginatedResponse(_Model):
    ...
    :vartype items_property: list[~openmeter.models.StripeApp or ~openmeter.models.SandboxApp or
...
class BalanceHistoryWindow(_Model):
    ...
    :vartype period: ~openmeter.models.Period
...
class BillingCustomerProfile(_Model):
    ...
    :ivar supplier: The name and contact information for the supplier this billing profile
     represents. Required.
    :vartype supplier: ~openmeter.models.BillingParty
    :ivar workflow: The billing workflow settings for this profile. Required.
    :vartype workflow: ~openmeter.models.BillingWorkflow
    ...
    :vartype apps: ~openmeter.models.BillingProfileApps or
     ~openmeter.models.BillingProfileAppReferences
    """
...
class BillingDiscounts(_Model):
    ...
    :vartype percentage: ~openmeter.models.BillingDiscountPercentage
    :ivar usage: The usage discount.
    :vartype usage: ~openmeter.models.BillingDiscountUsage
    """
...
class BillingInvoiceCustomerExtendedDetails(_Model):
    ...
    :vartype tax_id: ~openmeter.models.BillingPartyTaxIdentity
    :ivar addresses: Regular post addresses for where information should be sent if needed.
    :vartype addresses: list[~openmeter.models.Address]
    :ivar usage_attribution: Usage Attribution. Required.
    :vartype usage_attribution: ~openmeter.models.CustomerUsageAttribution
    """
...
class BillingProfileAppReferences(_Model):
    ...
    :vartype tax: ~openmeter.models.AppReference
    :ivar invoicing: The invoicing app used for this workflow. Required.
    :vartype invoicing: ~openmeter.models.AppReference
    :ivar payment: The payment app used for this workflow. Required.
    :vartype payment: ~openmeter.models.AppReference
    """
...
class BillingProfileApps(_Model):
    ...
    :vartype tax: ~openmeter.models.StripeApp or ~openmeter.models.SandboxApp or
     ~openmeter.models.CustomInvoicingApp
    ...
    :vartype invoicing: ~openmeter.models.StripeApp or ~openmeter.models.SandboxApp or
     ~openmeter.models.CustomInvoicingApp
    :ivar payment: The payment app used for this workflow. Required. Is one of the following types:
     StripeApp, SandboxApp, CustomInvoicingApp
    :vartype payment: ~openmeter.models.StripeApp or ~openmeter.models.SandboxApp or
     ~openmeter.models.CustomInvoicingApp
    """
...
class BillingProfileCreate(_Model):
    ...
    :vartype default: bool
    :ivar workflow: The billing workflow settings for this profile. Required.
    :vartype workflow: ~openmeter.models.BillingWorkflowCreate
    :ivar apps: The apps used by this billing profile. Required.
    :vartype apps: ~openmeter.models.BillingProfileAppsCreate
    """
...
class BillingProfileCustomerOverrideWithDetails(_Model):  # pylint: disable=name-too-long
    ...
    :vartype customer_override: ~openmeter.models.BillingProfileCustomerOverride
    ...
    :vartype customer_profile: ~openmeter.models.BillingCustomerProfile
    :ivar customer: The customer this override belongs to.
    :vartype customer: ~openmeter.models.Customer
    """
...
class BillingProfileCustomerOverrideWithDetailsPaginatedResponse(_Model):  # pylint: disable=name-too-long
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.BillingProfileCustomerOverrideWithDetails]
    """
...
class BillingProfilePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.BillingProfile]
    """
...
class BillingWorkflow(_Model):
    ...
    :vartype collection: ~openmeter.models.BillingWorkflowCollectionSettings
    :ivar invoicing: The invoicing settings for this workflow.
    :vartype invoicing: ~openmeter.models.BillingWorkflowInvoicingSettings
    :ivar payment: The payment settings for this workflow.
    :vartype payment: ~openmeter.models.BillingWorkflowPaymentSettings
    :ivar tax: The tax settings for this workflow.
    :vartype tax: ~openmeter.models.BillingWorkflowTaxSettings
    """
...
class BillingWorkflowCollectionAlignmentSubscription(_Model):  # pylint: disable=name-too-long
    ...
    :ivar type: The type of alignment. Required. Align the collection to the start of the
     subscription period.
    :vartype type: str or ~openmeter.models.SUBSCRIPTION
    """
...
class BillingWorkflowCollectionSettings(_Model):
    ...
    :vartype alignment: ~openmeter.models.BillingWorkflowCollectionAlignmentSubscription
...
class BillingWorkflowInvoicingSettings(_Model):
    ...
    :vartype default_tax_config: ~openmeter.models.TaxConfig
    """
...
class CheckoutSessionCustomTextAfterSubmitParams(_Model):  # pylint: disable=name-too-long
    ...
    :vartype after_submit: ~openmeter.models.CheckoutSessionCustomTextParamsAfterSubmit
    :ivar shipping_address: Custom text that should be displayed alongside shipping address
     collection.
    :vartype shipping_address: ~openmeter.models.CheckoutSessionCustomTextParamsShippingAddress
    :ivar submit: Custom text that should be displayed alongside the payment confirmation button.
    :vartype submit: ~openmeter.models.CheckoutSessionCustomTextParamsSubmit
    ...
    :vartype terms_of_service_acceptance:
     ~openmeter.models.CheckoutSessionCustomTextParamsTermsOfServiceAcceptance
    """
...
class CreateStripeCheckoutSessionConsentCollection(_Model):  # pylint: disable=name-too-long
    ...
    :vartype payment_method_reuse_agreement:
     ~openmeter.models.CreateStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreement
...
class CreateStripeCheckoutSessionRequest(_Model):
    ...
    :vartype customer: ~openmeter.models.CustomerId or ~openmeter.models.CustomerKey or
     ~openmeter.models.CustomerCreate
    ...
    :vartype options: ~openmeter.models.CreateStripeCheckoutSessionRequestOptions
    """
...
class CreateStripeCheckoutSessionRequestOptions(_Model):  # pylint: disable=name-too-long
    ...
    :vartype customer_update: ~openmeter.models.CreateStripeCheckoutSessionCustomerUpdate
    :ivar consent_collection: Configure fields for the Checkout Session to gather active consent
     from customers.
    :vartype consent_collection: ~openmeter.models.CreateStripeCheckoutSessionConsentCollection
    ...
    :vartype custom_text: ~openmeter.models.CheckoutSessionCustomTextAfterSubmitParams
    ...
    :vartype tax_id_collection: ~openmeter.models.CreateCheckoutSessionTaxIdCollection
    """
...
class CreditNoteOriginalInvoiceRef(InvoiceGenericDocumentRef):
    ...
    :vartype type: str or ~openmeter.models.CREDIT_NOTE_ORIGINAL_INVOICE
...
class CustomerAccess(_Model):
    ...
    :vartype entitlements: dict[str, ~openmeter.models.EntitlementValue]
    """
...
class CustomerAppDataPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.StripeCustomerAppData or
...
class CustomerPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.Customer]
    """
...
class CustomInvoicingApp(_Model):
    ...
    :vartype listing: ~openmeter.models.MarketplaceListing
    ...
    :vartype type: str or ~openmeter.models.CUSTOM_INVOICING
...
class CustomInvoicingCustomerAppData(_Model):
    ...
    :vartype app: ~openmeter.models.CustomInvoicingApp
    :ivar id: App ID.
    :vartype id: str
...
class CustomInvoicingDraftSynchronizedRequest(_Model):
    ...
    :vartype invoicing: ~openmeter.models.CustomInvoicingSyncResult
    """
...
class CustomInvoicingFinalizedRequest(_Model):
    ...
    :ivar invoicing: The result of the synchronization.
    :vartype invoicing: ~openmeter.models.CustomInvoicingFinalizedInvoicingRequest
    :ivar payment: The result of the payment synchronization.
    :vartype payment: ~openmeter.models.CustomInvoicingFinalizedPaymentRequest
    """
...
class CustomInvoicingSyncResult(_Model):
    ...
    :ivar line_external_ids: If set the invoice's line external IDs will be set to this value.
     ...
     invoice.
    :vartype line_external_ids: list[~openmeter.models.CustomInvoicingLineExternalIdMapping]
    ...
    :vartype line_discount_external_ids:
     list[~openmeter.models.CustomInvoicingLineDiscountExternalIdMapping]
    """
...
class OmitPropertiesResourceCreateModel(_Model):
    ...
    :vartype alignment: ~openmeter.models.Alignment
    :ivar currency: Currency. Required.
    :vartype currency: str
    ...
    :vartype pro_rating_config: ~openmeter.models.ProRatingConfig
    :ivar phases: Plan phases. Required.
    :vartype phases: list[~openmeter.models.PlanPhase]
    """
...
class CustomSubscriptionChange(_Model):
    ...
    :vartype custom_plan: ~openmeter.models.CustomPlanInput
    """
...
class DiscountReasonMaximumSpend(_Model):
    ...
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.MAXIMUM_SPEND
    """
...
class DiscountReasonRatecardPercentage(_Model):
    ...
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.RATECARD_PERCENTAGE
    :ivar percentage: Percentage. Required.
    :vartype percentage: float
    :ivar correlation_id: Correlation ID for the discount.
...
class DiscountReasonRatecardUsage(_Model):
    ...
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.RATECARD_USAGE
    :ivar quantity: Usage. Required.
    :vartype quantity: str
    :ivar correlation_id: Correlation ID for the discount.
...
class Discounts(_Model):
    ...
    :ivar percentage: The percentage discount.
    :vartype percentage: ~openmeter.models.DiscountPercentage
    :ivar usage: The usage discount.
    :vartype usage: ~openmeter.models.DiscountUsage
    """
...
class DynamicPriceWithCommitments(_Model):
    ...
    :vartype type: str or ~openmeter.models.DYNAMIC
...
class EditSubscriptionAddItem(_Model):
    ...
    :ivar op: Required.
    :vartype op: str or ~openmeter.models.ADD_ITEM
    ...
    :vartype rate_card: ~openmeter.models.RateCardFlatFee or ~openmeter.models.RateCardUsageBased
    """
...
class EditSubscriptionAddPhase(_Model):
    ...
    :ivar op: Required.
    :vartype op: str or ~openmeter.models.ADD_PHASE
    :ivar phase: Required.
    :vartype phase: ~openmeter.models.SubscriptionPhaseCreate
    """
...
class EditSubscriptionRemoveItem(_Model):
    ...
    :ivar op: Required.
    :vartype op: str or ~openmeter.models.REMOVE_ITEM
    :ivar phase_key: Required.
    :vartype phase_key: str
...
class EditSubscriptionRemovePhase(_Model):
    ...
    :ivar op: Required.
    :vartype op: str or ~openmeter.models.REMOVE_PHASE
    :ivar phase_key: Required.
    :vartype phase_key: str
...
class EditSubscriptionStretchPhase(_Model):
    ...
    :ivar op: Required.
    :vartype op: str or ~openmeter.models.STRETCH_PHASE
    :ivar phase_key: Required.
    :vartype phase_key: str
...
class EditSubscriptionUnscheduleEdit(_Model):
    ...
    :ivar op: Required.
    :vartype op: str or ~openmeter.models.UNSCHEDULE_EDIT
    """
...
class EntitlementBoolean(_Model):
    ...
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.BOOLEAN
    :ivar created_at: Creation Time. Required.
    :vartype created_at: ~datetime.datetime
    :ivar updated_at: Last Update Time. Required.
    :vartype updated_at: ~datetime.datetime
    ...
    :vartype current_usage_period: ~openmeter.models.Period
    :ivar usage_period: The defined usage period of the entitlement.
    :vartype usage_period: ~openmeter.models.RecurringPeriod
    """
...
class EntitlementBooleanCreateInputs(_Model):
    ...
    :vartype usage_period: ~openmeter.models.RecurringPeriodCreateInput
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.BOOLEAN
    """
...
class EntitlementGrant(_Model):
    ...
    :vartype expiration: ~openmeter.models.ExpirationPeriod
    ...
    :vartype recurrence: ~openmeter.models.RecurringPeriod
    """
...
class EntitlementGrantCreateInput(_Model):
    ...
    :vartype recurrence: ~openmeter.models.RecurringPeriodCreateInput
    """
...
class EntitlementMetered(_Model):
    ...
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.METERED
...
class EntitlementPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.EntitlementMetered or
     ~openmeter.models.EntitlementStatic or ~openmeter.models.EntitlementBoolean]
    """
...
class EntitlementStatic(_Model):
    ...
    :ivar type: Required.
    :vartype type: str or ~openmeter.models.STATIC
...
class EntitlementV2PaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.EntitlementMeteredV2 or
     ~openmeter.models.EntitlementStaticV2 or ~openmeter.models.EntitlementBooleanV2]
    """
...
class FeaturePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.Feature]
    """
...
class FilterString(_Model):
    ...
    :vartype and_property: list[~openmeter.models.FilterString]
    :ivar or_property: Provide a list of filters to be combined with a logical OR.
    :vartype or_property: list[~openmeter.models.FilterString]
    """
...
class FilterTime(_Model):
    ...
    :ivar and_property: Provide a list of filters to be combined with a logical AND.
    :vartype and_property: list[~openmeter.models.FilterTime]
    :ivar or_property: Provide a list of filters to be combined with a logical OR.
    :vartype or_property: list[~openmeter.models.FilterTime]
    """
...
class FlatPrice(_Model):
    ...
    :ivar type: The type of the price. Required.
    :vartype type: str or ~openmeter.models.FLAT
...
class GrantBurnDownHistorySegment(_Model):
    ...
    :ivar grant_usages: Which grants were actually burnt down in the period and by what amount.
     Required.
    :vartype grant_usages: list[~openmeter.models.GrantUsageRecord]
    """
...
class GrantPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.EntitlementGrant]
    """
...
class IngestedEvent(_Model):
    ...
    :vartype event: ~openmeter.models.Event
...
class Invoice(_Model):
     ...
     * credit_note: Reflects a refund either partial or complete of the preceding document. A credit
     note effectively *extends* the previous document. Required. Known values are: "standard" and
     "credit_note".
    ...
    :vartype customer: ~openmeter.models.BillingInvoiceCustomerExtendedDetails
    ...
    :ivar preceding: Key information regarding previous invoices and potentially details as to why
     they were corrected.
    :vartype preceding: list[~openmeter.models.CreditNoteOriginalInvoiceRef]
    :ivar totals: Summary of all the invoice totals, including taxes (calculated). Required.
    :vartype totals: ~openmeter.models.InvoiceTotals
    ...
    :vartype status_details: ~openmeter.models.InvoiceStatusDetails
...
class InvoiceAvailableActions(_Model):
    ...
    :vartype advance: ~openmeter.models.InvoiceAvailableActionDetails
    :ivar approve: Approve an invoice that requires manual approval.
    :vartype approve: ~openmeter.models.InvoiceAvailableActionDetails
    :ivar delete: Delete the invoice (only non-issued invoices can be deleted).
    :vartype delete: ~openmeter.models.InvoiceAvailableActionDetails
    :ivar retry: Retry an invoice issuing step that failed.
    :vartype retry: ~openmeter.models.InvoiceAvailableActionDetails
    :ivar snapshot_quantities: Snapshot quantities for usage based line items.
    :vartype snapshot_quantities: ~openmeter.models.InvoiceAvailableActionDetails
    :ivar void: Void an already issued invoice.
    :vartype void: ~openmeter.models.InvoiceAvailableActionDetails
    :ivar invoice: Invoice a gathering invoice.
    :vartype invoice: ~openmeter.models.InvoiceAvailableActionInvoiceDetails
    """
...
class InvoiceDetailedLine(_Model):
    ...
    :ivar status: Status of the line.
     ...
     billing engine of OpenMeter. Required. Known values are: "valid", "detail", and "split".
    ...
    :ivar external_ids: External IDs of the invoice in other apps such as Stripe.
    :vartype external_ids: ~openmeter.models.InvoiceLineAppExternalIds
    :ivar subscription: Subscription are the references to the subscritpions that this line is
     related to.
    :vartype subscription: ~openmeter.models.InvoiceLineSubscriptionReference
    :ivar type: Type of the line. Required.
    :vartype type: str or ~openmeter.models.FLAT_FEE
    ...
    :vartype rate_card: ~openmeter.models.InvoiceDetailedLineRateCard
...
class InvoiceDetailedLineRateCard(_Model):
    ...
    :vartype price: ~openmeter.models.FlatPriceWithPaymentTerm
    :ivar quantity: Quantity of the item being sold.

     Default: 1.
    :vartype quantity: str
    :ivar discounts: The discounts that are applied to the line.
    :vartype discounts: ~openmeter.models.BillingDiscounts
    """
...
class InvoiceLine(_Model):
    ...
    :vartype subscription: ~openmeter.models.InvoiceLineSubscriptionReference
    :ivar type: Type of the line. Required.
    :vartype type: str or ~openmeter.models.USAGE_BASED
    ...
    :vartype price: ~openmeter.models.FlatPriceWithPaymentTerm or
     ~openmeter.models.UnitPriceWithCommitments or ~openmeter.models.TieredPriceWithCommitments or
     ~openmeter.models.DynamicPriceWithCommitments or ~openmeter.models.PackagePriceWithCommitments
    :ivar feature_key: The feature that the usage is based on.
    :vartype feature_key: str
    :ivar children: The lines detailing the item or service sold.
    :vartype children: list[~openmeter.models.InvoiceDetailedLine]
    :ivar rate_card: The rate card that is used for this line.

     The rate card captures the intent of the price and discounts for the usage-based item.
    :vartype rate_card: ~openmeter.models.InvoiceUsageBasedRateCard
...
class InvoiceLineAmountDiscount(_Model):
    ...
    :vartype reason: ~openmeter.models.DiscountReasonMaximumSpend or
     ~openmeter.models.DiscountReasonRatecardPercentage or
     ~openmeter.models.DiscountReasonRatecardUsage
...
class InvoiceLineDiscounts(_Model):
    ...
    :vartype amount: list[~openmeter.models.InvoiceLineAmountDiscount]
    :ivar usage: Usage based discounts applied to the line.
     ...
     applied.
    :vartype usage: list[~openmeter.models.InvoiceLineUsageDiscount]
    """
...
class InvoiceLineSubscriptionReference(_Model):
    ...
    :vartype subscription: ~openmeter.models.IDResource
    :ivar phase: The phase of the subscription. Required.
    :vartype phase: ~openmeter.models.IDResource
    :ivar item: The item this line is related to. Required.
    :vartype item: ~openmeter.models.IDResource
    ...
    :vartype billing_period: ~openmeter.models.Period
    """
...
class InvoiceLineTaxItem(_Model):
    ...
    :vartype config: ~openmeter.models.TaxConfig
...
class InvoicePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.Invoice]
    """
...
class InvoicePaymentTerms(_Model):
    ...
    :vartype terms: ~openmeter.models.PaymentTermInstant or ~openmeter.models.PaymentTermDueDate
    """
...
class InvoicePendingLineCreateInput(_Model):
    ...
    :vartype lines: list[~openmeter.models.InvoicePendingLineCreate]
    """
...
class InvoicePendingLineCreateResponse(_Model):
    ...
    :vartype invoice: ~openmeter.models.Invoice
...
class InvoicePendingLinesActionInput(_Model):
    ...
    :vartype filters: ~openmeter.models.InvoicePendingLinesActionFiltersInput
...
class InvoiceReplaceUpdate(_Model):
    ...
    :vartype supplier: ~openmeter.models.BillingPartyReplaceUpdate
    :ivar customer: The customer the invoice is sent to. Required.
    :vartype customer: ~openmeter.models.BillingPartyReplaceUpdate
    :ivar lines: The lines included in the invoice. Required.
    :vartype lines: list[~openmeter.models.InvoiceLineReplaceUpdate]
    :ivar workflow: The workflow settings for the invoice. Required.
    :vartype workflow: ~openmeter.models.InvoiceWorkflowReplaceUpdate
    """
...
class InvoiceSimulationInput(_Model):
    ...
    :vartype lines: list[~openmeter.models.InvoiceSimulationLine]
    """
...
class InvoiceStatusDetails(_Model):
    ...
    :vartype available_actions: ~openmeter.models.InvoiceAvailableActions
    """
...
class InvoiceWorkflowReplaceUpdate(_Model):
    ...
    :vartype workflow: ~openmeter.models.InvoiceWorkflowSettingsReplaceUpdate
    """
...
class InvoiceWorkflowSettingsReplaceUpdate(_Model):
    ...
    :vartype invoicing: ~openmeter.models.InvoiceWorkflowInvoicingSettingsReplaceUpdate
...
class ListRequestFilter(_Model):
    ...
    :ivar id:
    :vartype id: ~openmeter.models.FilterString
    :ivar source:
    :vartype source: ~openmeter.models.FilterString
    :ivar subject:
    :vartype subject: ~openmeter.models.FilterString
    :ivar customer_id:
    :vartype customer_id: ~openmeter.models.FilterIDExact
    :ivar type:
    :vartype type: ~openmeter.models.FilterString
    :ivar time:
    :vartype time: ~openmeter.models.FilterTime
    :ivar ingested_at:
    :vartype ingested_at: ~openmeter.models.FilterTime
    """
...
class MarketplaceInstallResponse(_Model):
    ...
    :vartype app: ~openmeter.models.StripeApp or ~openmeter.models.SandboxApp or
     ~openmeter.models.CustomInvoicingApp
...
class MarketplaceListing(_Model):
    ...
    :vartype capabilities: list[~openmeter.models.AppCapability]
...
class MarketplaceListingPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.MarketplaceListing]
    """
...
class MeterQueryResult(_Model):
    ...
    :vartype data: list[~openmeter.models.MeterQueryRow]
    """
...
class NotificationChannelPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.NotificationChannelWebhook]
    """
...
class NotificationChannelWebhook(_Model):
    ...
    :vartype type: str or ~openmeter.models.WEBHOOK
...
class NotificationEvent(_Model):
    ...
    :vartype rule: ~openmeter.models.NotificationRuleBalanceThreshold or
    ...
    :vartype delivery_status: list[~openmeter.models.NotificationEventDeliveryStatus]
    ...
    :vartype payload: ~openmeter.models.NotificationEventResetPayload or
     ~openmeter.models.NotificationEventBalanceThresholdPayload or
     ~openmeter.models.NotificationEventInvoiceCreatedPayload or
     ~openmeter.models.NotificationEventInvoiceUpdatedPayload
    :ivar annotations: Annotations.
    :vartype annotations: ~openmeter.models.Annotations
    """
...
class NotificationEventBalanceThresholdPayload(_Model):
    ...
    :vartype type: str or ~openmeter.models.ENTITLEMENTS_BALANCE_THRESHOLD
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~openmeter.models.NotificationEventBalanceThresholdPayloadData
    """
...
class NotificationEventBalanceThresholdPayloadData(_Model):  # pylint: disable=name-too-long
    ...
    :vartype entitlement: ~openmeter.models.EntitlementMetered
    :ivar feature: Feature. Required.
    :vartype feature: ~openmeter.models.Feature
    :ivar subject: Subject. Required.
    :vartype subject: ~openmeter.models.Subject
    :ivar value: Entitlement Value. Required.
    :vartype value: ~openmeter.models.EntitlementValue
    :ivar customer: Customer.
    :vartype customer: ~openmeter.models.Customer
    :ivar threshold: Threshold. Required.
    :vartype threshold: ~openmeter.models.NotificationRuleBalanceThresholdValue
    """
...
class NotificationEventDeliveryStatus(_Model):
    ...
    :vartype channel: ~openmeter.models.NotificationChannelMeta
    """
...
class NotificationEventInvoiceCreatedPayload(_Model):
    ...
    :vartype id: str
    :ivar type: Notification Event Type. Required.
    :vartype type: str or ~openmeter.models.INVOICE_CREATED
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~openmeter.models.Invoice
    """
...
class NotificationEventInvoiceUpdatedPayload(_Model):
    ...
    :vartype id: str
    :ivar type: Notification Event Type. Required.
    :vartype type: str or ~openmeter.models.INVOICE_UPDATED
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~openmeter.models.Invoice
...
class NotificationEventPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.NotificationEvent]
    """
...
class NotificationEventResetPayload(_Model):
    ...
    :vartype id: str
    :ivar type: Notification Event Type. Required.
    :vartype type: str or ~openmeter.models.ENTITLEMENTS_RESET
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~openmeter.models.NotificationEventEntitlementValuePayloadBase
    """
...
class NotificationRuleBalanceThreshold(_Model):
    ...
    :vartype channels: list[~openmeter.models.NotificationChannelMeta]
    :ivar thresholds: Entitlement Balance Thresholds. Required.
    :vartype thresholds: list[~openmeter.models.NotificationRuleBalanceThresholdValue]
    :ivar features: Features.
    :vartype features: list[~openmeter.models.FeatureMeta]
    """
...
class NotificationRulePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.NotificationRuleBalanceThreshold or
     ~openmeter.models.NotificationRuleEntitlementReset or
     ~openmeter.models.NotificationRuleInvoiceCreated or
     ~openmeter.models.NotificationRuleInvoiceUpdated]
    """
...
class PackagePriceWithCommitments(_Model):
    ...
    :ivar type: The type of the price. Required.
    :vartype type: str or ~openmeter.models.PACKAGE
...
class PaymentTermInstant(_Model):
    ...
    :vartype type: str or ~openmeter.models.INSTANT
    :ivar detail: Text detail of the chosen payment terms.
    :vartype detail: str
    :ivar notes: Description of the conditions for payment.
    :vartype notes: str
...
class PlanAddon(_Model):
    ...
    :vartype addon: ~openmeter.models.Addon
...
class PlanAddonPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.PlanAddon]
    """
...
class PlanSubscriptionChange(_Model):
    ...
    :vartype plan: ~openmeter.models.PlanReferenceInput
    :ivar starting_phase: The key of the phase to start the subscription in.
     If not provided, the subscription will start in the first phase of the plan.
    :vartype starting_phase: str
...
class PriceTier(_Model):
    ...
    :vartype flat_price: ~openmeter.models.FlatPrice
    :ivar unit_price: Unit price component. Required.
    :vartype unit_price: ~openmeter.models.UnitPrice
    """
...
class RateCardFlatFee(_Model):
    ...
    :vartype entitlement_template: ~openmeter.models.RateCardMeteredEntitlement or
     ~openmeter.models.RateCardStaticEntitlement or ~openmeter.models.RateCardBooleanEntitlement
    :ivar tax_config: Tax config.
    :vartype tax_config: ~openmeter.models.TaxConfig
    :ivar billing_cadence: Billing cadence. Required.
    :vartype billing_cadence: ~datetime.timedelta
    ...
    :vartype discounts: ~openmeter.models.Discounts
    """
...
class SandboxApp(_Model):
    ...
    :vartype type: str or ~openmeter.models.SANDBOX
    """
...
class SandboxCustomerAppData(_Model):
    ...
    :vartype app: ~openmeter.models.SandboxApp
    :ivar id: App ID.
    :vartype id: str
    :ivar type: App Type. Required.
    :vartype type: str or ~openmeter.models.SANDBOX
...
class StripeApp(_Model):
    ...
    :vartype type: str or ~openmeter.models.STRIPE
...
class StripeCustomerAppData(_Model):
    ...
    :vartype app: ~openmeter.models.StripeApp
    """
...
class StripeWebhookEvent(_Model):
    ...
    :vartype data: ~openmeter.models.StripeWebhookEventData
    """
...
class Subscription(_Model):
    ...
    :vartype plan: ~openmeter.models.PlanReference
    :ivar currency: Currency. Required.
    :vartype currency: str
    :ivar billing_cadence: Billing cadence. Required.
    :vartype billing_cadence: ~datetime.timedelta
...
class SubscriptionAddon(_Model):
    ...
    :vartype active_to: ~datetime.datetime
    :ivar addon: Addon. Required.
    :vartype addon: ~openmeter.models.SubscriptionAddonAddon
    ...
    :vartype timeline: list[~openmeter.models.SubscriptionAddonTimelineSegment]
    :ivar subscription_id: SubscriptionID. Required.
    :vartype subscription_id: str
    :ivar rate_cards: Rate cards. Required.
    :vartype rate_cards: list[~openmeter.models.SubscriptionAddonRateCard]
    """
...
class SubscriptionAddonCreate(_Model):
    ...
    :vartype timing: str or ~openmeter.models.SubscriptionTimingEnum or ~datetime.datetime
    :ivar addon: Addon. Required.
    :vartype addon: ~openmeter.models.SubscriptionAddonCreateAddon
    """
...
class SubscriptionAlignment(_Model):
    ...
    :vartype current_aligned_billing_period: ~openmeter.models.Period
    """
...
class SubscriptionChangeResponseBody(_Model):
    ...
    :vartype current: ~openmeter.models.Subscription
    :ivar next: The subscription it will be changed to. Required.
    :vartype next: ~openmeter.models.SubscriptionExpanded
    """
...
class SubscriptionEdit(_Model):
    ...
    :vartype customizations: list[~openmeter.models.EditSubscriptionAddItem or
     ~openmeter.models.EditSubscriptionRemoveItem or ~openmeter.models.EditSubscriptionAddPhase or
     ~openmeter.models.EditSubscriptionRemovePhase or ~openmeter.models.EditSubscriptionStretchPhase
     or ~openmeter.models.EditSubscriptionUnscheduleEdit]
...
class SubscriptionExpanded(_Model):
    ...
    :vartype alignment: ~openmeter.models.SubscriptionAlignment
    :ivar phases: The phases of the subscription. Required.
    :vartype phases: list[~openmeter.models.SubscriptionPhaseExpanded]
    """
...
class SubscriptionItem(_Model):
    ...
    :vartype included: ~openmeter.models.SubscriptionItemIncluded
    :ivar tax_config: Tax config.
    :vartype tax_config: ~openmeter.models.TaxConfig
    """
...
class SubscriptionItemIncluded(_Model):
    ...
    :vartype entitlement: ~openmeter.models.EntitlementMetered or
     ~openmeter.models.EntitlementStatic or ~openmeter.models.EntitlementBoolean
    """
...
class SubscriptionPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~openmeter.models.Subscription]
    """
...
class SubscriptionPhaseExpanded(_Model):
     ...
     * for future phases, the `items` contains only the first version of the item for each key.
     Required.
    :vartype items_property: list[~openmeter.models.SubscriptionItem]
    :ivar item_timelines: Includes all versions of the items on each key, including all edits,
     scheduled changes, etc... Required.
    :vartype item_timelines: dict[str, list[~openmeter.models.SubscriptionItem]]
    """
...
class TaxConfig(_Model):
    ...
    :vartype stripe: ~openmeter.models.StripeTaxConfig
    :ivar custom_invoicing: Custom invoicing tax config.
    :vartype custom_invoicing: ~openmeter.models.CustomInvoicingTaxConfig
    """
...
class TieredPriceWithCommitments(_Model):
    ...
    :vartype type: str or ~openmeter.models.TIERED
    ...
    :vartype tiers: list[~openmeter.models.PriceTier]
    :ivar minimum_amount: Minimum amount.
    :vartype minimum_amount: str
    :ivar maximum_amount: Maximum amount.
    :vartype maximum_amount: str
...
class UnitPrice(_Model):
    ...
    :ivar type: The type of the price. Required.
    :vartype type: str or ~openmeter.models.UNIT
...
class ValidationError(_Model):
    ...
    :vartype attributes: ~openmeter.models.Annotations
    """
...
class ValidationErrorProblemResponse(_Model):
    ...
    :vartype extensions: ~openmeter.models.CreateResponseExtensions
    """
...
class VoidInvoiceAction(_Model):
    ...
    :vartype action: ~openmeter.models.VoidInvoiceLineDiscardAction or
     ~openmeter.models.VoidInvoiceLinePendingAction
    """
...
class VoidInvoiceActionInput(_Model):
    ...
    :vartype action: ~openmeter.models.VoidInvoiceAction
    ...
    :vartype overrides: list[~openmeter.models.VoidInvoiceActionLineOverride]
    """
...
class VoidInvoiceLineDiscardAction(_Model):
    ...
    :ivar type: The action to take on the line item. Required. The line items will never be charged
     for again
    :vartype type: str or ~openmeter.models.DISCARD
    """
...
class VoidInvoiceLinePendingAction(_Model):
    ...
    :ivar type: The action to take on the line item. Required. Queue the line items into the
     ...
     now)
    :vartype type: str or ~openmeter.models.PENDING
...
class WindowedBalanceHistory(_Model):
     ...
     * The last window may be smaller than the window size and is inclusive at both ends. Required.
    :vartype windowed_history: list[~openmeter.models.BalanceHistoryWindow]
    :ivar burndown_history: Grant burndown history. Required.
    :vartype burndown_history: list[~openmeter.models.GrantBurnDownHistorySegment]
    """
