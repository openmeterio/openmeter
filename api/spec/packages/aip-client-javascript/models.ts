...
export const createStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreementPosition =
  z
    .enum(['auto', 'hidden'])
...
export const creditTransactionType = z
  ...
  .describe(
    'The type of the credit transaction. - `funded`: Credit granted and available for consumption. - `consumed`: Credit consumed by usage or fees.',
  )
...
export const createStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreement =
  z
    .object({
      position:
        createStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreementPosition.optional(),
    })
...
export const createStripeCheckoutSessionConsentCollection = z
  .object({
    payment_method_reuse_agreement:
      createStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreement.optional(),
    promotions:
      createStripeCheckoutSessionConsentCollectionPromotions.optional(),
    terms_of_service:
      createStripeCheckoutSessionConsentCollectionTermsOfService.optional(),
  })
...
export const createStripeCheckoutSessionRequestOptions = z
  .object({
    ...
    redirect_on_completion:
      createStripeCheckoutSessionRedirectOnCompletion.optional(),
...
export const createRequestNested = z
  .object({
    ...
    purchase: z
      ...
      .optional()
      .describe(
        'Purchase and payment terms of the grant. Present when a funding workflow applies (funding_method is not `none`).',
      ),
...
export const billingWorkflowCollectionSettings = z
  .object({
    alignment: billingWorkflowCollectionAlignment.optional().default({
      type: 'subscription',
    }),
    interval: z
      .string()
