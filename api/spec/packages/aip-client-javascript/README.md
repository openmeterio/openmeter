...
| `client.internal.notifications.listRules`     | `GET /openmeter/notification/rules`                                | List all notification rules.                                                                                                                                                                                                                                              |
| `client.internal.notifications.createRule`    | `POST /openmeter/notification/rules`                               | Create a notification rule.                                                                                                                                                                                                                                               |
| `client.internal.notifications.getRule`       | `GET /openmeter/notification/rules/{notificationRuleId}`           | Get a notification rule by id.                                                                                                                                                                                                                                            |
| `client.internal.notifications.updateRule`    | `PUT /openmeter/notification/rules/{notificationRuleId}`           | Update a notification rule by id.                                                                                                                                                                                                                                         |
| `client.internal.notifications.deleteRule`    | `DELETE /openmeter/notification/rules/{notificationRuleId}`        | Delete a notification rule by id.                                                                                                                                                                                                                                         |
| `client.internal.notifications.testRule`      | `POST /openmeter/notification/rules/{notificationRuleId}/test`     | Test a notification rule by generating an event with sample data and delivering it to the rule's channels. The test event is persisted and listed like any other event.                                                                                                   |
