...
import {
  createMeteringAndBillingClientContext,
  type MeteringAndBillingClientContext,
  type MeteringAndBillingClientOptions,
} from "./api/meteringAndBillingClientContext.js";
import {
...
export class MeteringAndBillingClient {
  #context: MeteringAndBillingClientContext
  constructor(
    ...
    this.#context = createMeteringAndBillingClientContext(
      endpoint,
      credential,
      options
    );
