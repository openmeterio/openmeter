...
export const listInvoicesParamsFilter = z
  .object({
    status: stringFieldFilterExact.optional(),
    customerId: ulidFieldFilter.optional(),
    issuedAt: dateTimeFieldFilter.optional(),
    servicePeriodStart: dateTimeFieldFilter.optional(),
...
export const updateInvoiceCustomer = z
  .object({
    name: z
      ...
      .max(256)
      .describe('Display name of the resource. Between 1 and 256 characters.'),
    usageAttribution: updateCustomerUsageAttribution.optional(),
    billingAddress: updateAddress.optional(),
    id: ulid,
    key: externalResourceKey.optional(),
  })
...
export const updateSupplier = z
  .object({
    name: z
      ...
      .optional()
      .describe('Legal name or representation of the party.'),
    taxId: updateBillingPartyTaxIdentity.optional(),
...
export const updateBillingWorkflowPaymentChargeAutomaticallySettingsWire = z
  .strictObject({
    collection_method: z
      .literal('charge_automatically')
      .describe('The collection method for the invoice.'),
...
export const updateBillingWorkflowPaymentSendInvoiceSettingsWire = z
  .strictObject({
    collection_method: z
      .literal('send_invoice')
      .describe('The collection method for the invoice.'),
...
export const updatePriceFreeWire = z
  .strictObject({
    type: z.literal('free').describe('The type of the price.'),
  })
  .describe('Free price.')
...
export const updatePriceUnitWire = z
  .strictObject({
    type: z.literal('unit').describe('The type of the price.'),
    amount: numericWire,
  })
...
export const updateClosedPeriodWire = z
  .strictObject({
    from: dateTimeWire,
    to: dateTimeWire,
  })
...
export const updateCustomerUsageAttributionWire = z
  .strictObject({
    subject_keys: z
      .array(usageAttributionSubjectKeyWire)
...
export const updateAddressWire = z
  .strictObject({
    country: countryCodeWire.optional(),
    postal_code: z.string().optional().describe('Postal code.'),
    state: z.string().optional().describe('State or province.'),
...
export const updateBillingWorkflowPaymentSettingsWire = z
  .discriminatedUnion('collection_method', [
    updateBillingWorkflowPaymentChargeAutomaticallySettingsWire,
    updateBillingWorkflowPaymentSendInvoiceSettingsWire,
  ])
  .describe('Payment settings for a billing workflow.')
...
export const listInvoicesParamsFilterWire = z
  .strictObject({
    status: stringFieldFilterExactWire.optional(),
    customer_id: ulidFieldFilterWire.optional(),
    issued_at: dateTimeFieldFilterWire.optional(),
    service_period_start: dateTimeFieldFilterWire.optional(),
...
export const updateBillingPartyAddressesWire = z
  .strictObject({
    billing_address: updateAddressWire,
  })
  .describe('A collection of addresses for the party.')

export const updateInvoiceCustomerWire = z
  .strictObject({
    name: z
      .string()
      .min(1)
      .max(256)
      .describe('Display name of the resource. Between 1 and 256 characters.'),
    usage_attribution: updateCustomerUsageAttributionWire.optional(),
    billing_address: updateAddressWire.optional(),
    id: ulidWire,
    key: externalResourceKeyWire.optional(),
  })
...
export const updateSupplierWire = z
  .strictObject({
    name: z
      ...
      .optional()
      .describe('Legal name or representation of the party.'),
    tax_id: updateBillingPartyTaxIdentityWire.optional(),
    addresses: updateBillingPartyAddressesWire.optional(),
    id: z.string().optional().describe('Unique identifier for the party.'),
  })
...
export const updateInvoiceStandardLineWire = z
  .strictObject({
    ...
    type: z
      .literal('standard_line')
      .describe('The type of charge this line item represents.'),
    service_period: updateClosedPeriodWire,
    rate_card: updateInvoiceLineRateCardWire,
  })
...
export const updateInvoiceStandardRequestWire = z
  .strictObject({
    description: z
      .string()
      .max(1024)
    ...
    labels: updateLabelsWire.optional(),
    supplier: updateSupplierWire,
    customer: updateInvoiceCustomerWire,
    type: z
      .literal('standard')
      .describe('Discriminator field identifying this as a standard invoice.'),
    workflow: updateInvoiceWorkflowSettingsWire,
    lines: z
      .array(updateInvoiceLineWire)
      .optional()
...
export const updateInvoiceRequestWire = z
