...
export const chargesExpand = z
  ...
  .describe(
    "Expands for customer charges. Values: - `real_time_usage`: The charge's real-time usage; it sets the `usage` and the `totals.realtime` fields. - `customer`: The complete customer entity of the charge. - `feature`: The complete feature entity of the charge. - `subscription`: The complete subscription of the charge, when present. - `realization.invoice`: The complete invoice entity of each realization, in place of the ID reference. - `realization.totals`: The `totals` of each realization run, including credit allocations. - `realization.detailed_lines`: The `detailed_lines` of each realization run.",
  )
...
export const invoiceReference = z
  .object({
    id: ulid,
  })
...
export const invoiceOrReference = z
  .union([invoice, invoiceReference])
  .describe('Invoice or reference.')
...
export const chargeRealization = z
  .object({
    ...
    invoice: invoiceOrReference.optional(),
...
export const listCustomerChargesQueryParams = z.object({
  ...
  expand: z
    ...
    .describe(
      'Expand full objects for referenced entities. See `BillingChargesExpand` for the supported values and what each one populates.',
    ),
})
...
export const invoiceReferenceWire = z
  .strictObject({
    id: ulidWire,
  })
  .describe('Invoice reference.')
...
export const invoiceOrReferenceWire = z
  .union([invoiceWire, invoiceReferenceWire])
  .describe('Invoice or reference.')
...
export const chargeRealizationWire = z
  .strictObject({
    ...
    invoice: invoiceOrReferenceWire.optional(),
