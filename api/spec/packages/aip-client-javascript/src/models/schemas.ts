...
export const invoiceCustomerUsageAttribution = z
  .object({
    subject_keys: z
      .array(z.string())
      .describe('The subject keys whose usage is attributed to this invoice.'),
  })
...
export const invoiceDetailedLineRateCard = z
  .object({
    price: price.optional(),
    payment_term: pricePaymentTerm.optional(),
  })
...
export const invoiceDetailedLine = z
  .object({
    ...
    external_ids: invoiceLineExternalIds.optional(),
    rate_card: invoiceDetailedLineRateCard.optional(),
  })
