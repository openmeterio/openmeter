...
export interface CustomerCreditGrantEndpointsClientContext extends Client {

}export interface CustomerCreditGrantEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createCustomerCreditGrantEndpointsClientContext(
