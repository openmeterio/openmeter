...
} from "./customerCreditBalanceEndpointsClientContext.js";
 ...
 *
 * @param {CustomerCreditBalanceEndpointsClientContext} client
 * @param {string} customerId
 * @param {GetOptions} [options]
 */
export async function get(
  client: CustomerCreditBalanceEndpointsClientContext,
  customerId: string,
  options?: GetOptions,
): Promise<CreditBalances | void> {
  const path = parse("/openmeter/customers/{customerId}/credits/balance{?filter*}").expand({
