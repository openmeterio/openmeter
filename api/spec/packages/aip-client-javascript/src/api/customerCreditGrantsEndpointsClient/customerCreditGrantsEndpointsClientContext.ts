...
export interface CustomerCreditGrantsEndpointsClientContext extends Client {

}export interface CustomerCreditGrantsEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createCustomerCreditGrantsEndpointsClientContext(
