...
} from "./customerCreditAdjustmentsEndpointsClientContext.js";
 ...
 *
 * @param {CustomerCreditAdjustmentsEndpointsClientContext} client
 * @param {string} customerId
 * @param {CreateRequest} creditAdjustment
 * @param {CreateOptions} [options]
 */
export async function create(
  client: CustomerCreditAdjustmentsEndpointsClientContext,
  customerId: string,
  creditAdjustment: CreateRequest,
  options?: CreateOptions,
): Promise<CreditAdjustment | void> {
  const path = parse("/openmeter/customers/{customerId}/credits/adjustments").expand({
