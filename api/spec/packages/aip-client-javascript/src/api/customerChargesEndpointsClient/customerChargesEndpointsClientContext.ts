...
export interface CustomerChargesEndpointsClientContext extends Client {

}export interface CustomerChargesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createCustomerChargesEndpointsClientContext(
