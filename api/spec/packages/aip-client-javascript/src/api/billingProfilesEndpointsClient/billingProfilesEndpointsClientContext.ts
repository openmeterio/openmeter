...
export interface BillingProfilesEndpointsClientContext extends Client {

}export interface BillingProfilesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createBillingProfilesEndpointsClientContext(
