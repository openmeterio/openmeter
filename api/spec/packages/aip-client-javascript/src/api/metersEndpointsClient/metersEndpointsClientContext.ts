...
export interface MetersEndpointsClientContext extends Client {

}export interface MetersEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createMetersEndpointsClientContext(
