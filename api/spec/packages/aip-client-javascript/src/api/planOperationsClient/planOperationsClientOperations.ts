...
import { PlanOperationsClientContext } from "./planOperationsClientContext.js";
...
async function listPlansSend(
  client: PlanOperationsClientContext,
 ...
 * Create a new plan.
 *
 * @param {PlanOperationsClientContext} client
...
export async function updatePlan(
  ...
  const path = parse("/{planId}").expand({
    planId: planId
  });
  const httpRequestOptions = {
...
export async function archivePlan(
  ...
  const path = parse("/{planId}/archive").expand({
    planId: planId
  });
  const httpRequestOptions = {
    headers: {},
...
export async function publishPlan(
  ...
  const path = parse("/{planId}/publish").expand({
    planId: planId
  });
  const httpRequestOptions = {
    headers: {},
