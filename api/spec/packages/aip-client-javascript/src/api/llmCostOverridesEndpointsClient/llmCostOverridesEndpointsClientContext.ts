...
export interface LlmCostOverridesEndpointsClientContext extends Client {

}export interface LlmCostOverridesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createLlmCostOverridesEndpointsClientContext(
