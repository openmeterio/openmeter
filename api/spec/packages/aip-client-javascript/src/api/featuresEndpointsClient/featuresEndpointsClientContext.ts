...
export interface FeaturesEndpointsClientContext extends Client {

}export interface FeaturesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createFeaturesEndpointsClientContext(
