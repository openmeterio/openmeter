...
export interface TaxCodesEndpointsClientContext extends Client {

}export interface TaxCodesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createTaxCodesEndpointsClientContext(
