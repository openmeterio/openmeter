...
export interface OrganizationDefaultTaxCodesEndpointsClientContext extends Client {

}export interface OrganizationDefaultTaxCodesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createOrganizationDefaultTaxCodesEndpointsClientContext(
