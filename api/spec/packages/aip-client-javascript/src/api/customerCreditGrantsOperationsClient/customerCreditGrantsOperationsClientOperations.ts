...
} from "./customerCreditGrantsOperationsClientContext.js";
 ...
 *
 * @param {CustomerCreditGrantsOperationsClientContext} client
 * @param {string} customerId
 * @param {CreateRequestNested} creditGrant
 * @param {CreateOptions} [options]
 */
export async function create(
  client: CustomerCreditGrantsOperationsClientContext,
  customerId: string,
