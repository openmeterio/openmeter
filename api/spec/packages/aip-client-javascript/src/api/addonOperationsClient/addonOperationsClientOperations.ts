...
} from "./addonOperationsClientContext.js";
...
async function listAddonsSend(
  client: AddonOperationsClientContext,
 ...
 * Create a new add-on.
 *
 * @param {AddonOperationsClientContext} client
...
export async function updateAddon(
  ...
  const path = parse("/{addonId}").expand({
    addonId: addonId
  });
  const httpRequestOptions = {
...
export async function archiveAddon(
  ...
  const path = parse("/{addonId}/archive").expand({
    addonId: addonId
  });
  const httpRequestOptions = {
    headers: {},
...
export async function publishAddon(
  ...
  const path = parse("/{addonId}/publish").expand({
    addonId: addonId
  });
  const httpRequestOptions = {
    headers: {},
