...
} from "./customerCreditTransactionEndpointsClientContext.js";
...
async function listSend(
  client: CustomerCreditTransactionEndpointsClientContext,
  customerId: string,
  options?: Record<string, any>,
) {
  const path = parse("/openmeter/customers/{customerId}/credits/transactions{?page*,filter*}").expand({
