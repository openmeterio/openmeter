...
export interface CustomerBillingEndpointsClientContext extends Client {

}export interface CustomerBillingEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createCustomerBillingEndpointsClientContext(
