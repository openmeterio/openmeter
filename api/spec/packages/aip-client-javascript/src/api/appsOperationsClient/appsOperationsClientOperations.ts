...
import { AppsOperationsClientContext } from "./appsOperationsClientContext.js";
...
async function listSend(
  client: AppsOperationsClientContext,
  options?: Record<string, any>,
) {
  const path = parse("/{?page*}").expand({
    ...(options?.page && {page: {
 ...
 *
 * @param {AppsOperationsClientContext} client
 * @param {string} appId
