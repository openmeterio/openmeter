...
export interface LlmCostPricesEndpointsClientContext extends Client {

}export interface LlmCostPricesEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createLlmCostPricesEndpointsClientContext(
