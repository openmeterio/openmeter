...
export interface GovernanceEndpointsClientContext extends Client {

}export interface GovernanceEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createGovernanceEndpointsClientContext(
...
): GovernanceEndpointsClientContext {
