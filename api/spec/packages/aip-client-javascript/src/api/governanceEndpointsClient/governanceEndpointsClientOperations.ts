...
} from "./governanceEndpointsClientContext.js";
 ...
 * be cached._
 *
 * @param {GovernanceEndpointsClientContext} client
 * @param {GovernanceQueryRequest} _
 * @param {QueryOptions} [options]
 */
export async function query(
  client: GovernanceEndpointsClientContext,
  _: GovernanceQueryRequest,
  options?: QueryOptions,
): Promise<GovernanceQueryResponse | void> {
  const path = parse("/openmeter/governance/query{?page*}").expand({
