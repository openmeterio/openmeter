...
} from "./llmCostPricesOperationsClientContext.js";
...
async function listPricesSend(
  client: LlmCostPricesOperationsClientContext,
  options?: Record<string, any>,
) {
  const path = parse("/{?filter*,sort,page*}").expand({
 ...
 * if any.
 *
 * @param {LlmCostPricesOperationsClientContext} client
