...
} from "./subscriptionAddonEndpointsClientContext.js";
...
async function listSend(
  client: SubscriptionAddonEndpointsClientContext,
  subscriptionId: string,
  options?: Record<string, any>,
) {
  const path = parse("/openmeter/subscriptions/{subscriptionId}/addons{?page*,sort}").expand({
