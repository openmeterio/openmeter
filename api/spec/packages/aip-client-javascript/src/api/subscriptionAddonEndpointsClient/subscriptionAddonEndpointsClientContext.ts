...
export interface SubscriptionAddonEndpointsClientContext extends Client {

}export interface SubscriptionAddonEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createSubscriptionAddonEndpointsClientContext(
...
): SubscriptionAddonEndpointsClientContext {
