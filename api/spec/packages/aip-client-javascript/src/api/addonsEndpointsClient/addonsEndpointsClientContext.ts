...
export interface AddonsEndpointsClientContext extends Client {

}export interface AddonsEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createAddonsEndpointsClientContext(
