...
} from "./subscriptionsEndpointsClientContext.js";
...
export async function create(
  client: SubscriptionsEndpointsClientContext,
  subscription: SubscriptionCreate,
  options?: CreateOptions,
): Promise<Subscription | void> {
  const path = parse("/openmeter/subscriptions").expand({});
...
async function listSend(
  ...
  const path = parse("/openmeter/subscriptions{?page*,sort,filter*}").expand({
    ...(options?.page && {page: {
...
export async function get(
  ...
  const path = parse("/openmeter/subscriptions/{subscriptionId}").expand({
 ...
 *
 * @param {SubscriptionsEndpointsClientContext} client
...
export async function cancel(
  ...
  const path = parse("/openmeter/subscriptions/{subscriptionId}/cancel").expand({
    subscriptionId: subscriptionId
  });
  const httpRequestOptions = {
...
export async function unscheduleCancelation(
  ...
  const path = parse("/openmeter/subscriptions/{subscriptionId}/unschedule-cancelation").expand({
    subscriptionId: subscriptionId
  });
  const httpRequestOptions = {
    headers: {},
...
export async function change(
  ...
  const path = parse("/openmeter/subscriptions/{subscriptionId}/change").expand({
    subscriptionId: subscriptionId
  });
  const httpRequestOptions = {
