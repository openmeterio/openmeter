...
} from "./customerEntitlementsEndpointsClientContext.js";
...
export async function list(
  client: CustomerEntitlementsEndpointsClientContext,
  customerId: string,
  options?: ListOptions,
): Promise<ListCustomerEntitlementAccessResponseData | void> {
  const path = parse("/openmeter/customers/{customerId}/entitlement-access").expand({
