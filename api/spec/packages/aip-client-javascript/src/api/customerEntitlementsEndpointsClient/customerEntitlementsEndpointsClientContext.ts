...
export interface CustomerEntitlementsEndpointsClientContext extends Client {

}export interface CustomerEntitlementsEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createCustomerEntitlementsEndpointsClientContext(
...
): CustomerEntitlementsEndpointsClientContext {
