...
export interface MetersQueryEndpointsClientContext extends Client {

}export interface MetersQueryEndpointsClientOptions extends ClientOptions {
  endpoint?: string;
}export function createMetersQueryEndpointsClientContext(
