...
} from "./featureOperationsClientContext.js";
...
async function listSend(
  client: FeatureOperationsClientContext,
 ...
 * Create a feature.
 *
 * @param {FeatureOperationsClientContext} client
...
export async function get(
  ...
  const path = parse("/{featureId}").expand({
    featureId: featureId
  });
  const httpRequestOptions = {
    headers: {},
