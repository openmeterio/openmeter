...
func (h *handler) UpsertCustomer() UpsertCustomerHandler {
	return httptransport.NewHandlerWithArgs[UpsertCustomerRequest, UpsertCustomerResponse, UpsertCustomerParams](
		...
		func(ctx context.Context, request UpsertCustomerRequest) (UpsertCustomerResponse, error) {
			...
			if updatedCustomer == nil {
				return UpsertCustomerResponse{}, fmt.Errorf("failed to update customer")
			}
