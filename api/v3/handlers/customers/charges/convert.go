...
func convertFlatFeeChargeToAPI(source flatfee.Charge) (api.BillingFlatFeeCharge, error) {
	...
	return api.BillingFlatFeeCharge{
		...
		BillingPeriod:          ConvertClosedPeriodToAPI(source.ChargeBase.Intent.BillingPeriod),
		...
		Description:            source.ChargeBase.Intent.Description,
		...
		FullServicePeriod:      ConvertClosedPeriodToAPI(source.ChargeBase.Intent.FullServicePeriod),
		Id:                     source.ChargeBase.ManagedResource.ID,
		InvoiceAt:              source.ChargeBase.Intent.InvoiceAt,
		Labels:                 ConvertMetadataToLabels(source.ChargeBase.Intent.Metadata),
		ManagedBy:              ConvertManagedByToAPI(source.ChargeBase.Intent.Intent.ManagedBy),
		Name:                   source.ChargeBase.Intent.Name,
		...
		ServicePeriod:          ConvertClosedPeriodToAPI(source.ChargeBase.Intent.ServicePeriod),
		...
		TaxConfig:              convertTaxCodeConfigToAPI(source.ChargeBase.Intent.TaxConfig),
