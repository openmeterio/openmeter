...
func fromAPIEntitlementBase(entitlementType entitlement.EntitlementType, feature api.FeatureReference, apiLabels *api.Labels, usagePeriod *api.BillingEntitlementRecurringPeriodInput, now time.Time) (entitlement.CreateEntitlementInputs, error) {
...
func fromAPIRecurringPeriodInput(p api.BillingEntitlementRecurringPeriodInput, defaultAnchor time.Time) (timeutil.Recurrence, error) {
