...
| `om.Currencies.UpdateCustomCurrency` | `PUT /openmeter/currencies/custom/{currencyId}` | Replace the presentational attributes of a custom currency. The currency's code and precision are immutable and cannot be updated. |
