...
func newConfig() *config {
	return &config{
		paginationKind:  paginationKindPage,
...
// attributes in consideration and will ignore other kinds of pagination.
//
...
// WithPagePagination sets the  request parser to only take the page
// attributes in consideration and will ignore other kinds of pagination.
func WithPagePagination() AttributesOption {
	return func(c *config) {
		c.paginationKind = paginationKindPage
	}
}
