...
// PagePaginationMeta Page pagination metadata.
type PagePaginationMeta struct {
	Page PaginationMetaPage `json:"page"`
}

// PaginationMetaPage Page pagination metadata.
...
type PagePaginationResponse[T any] struct {
	...
	Meta PagePaginationMeta `json:"meta"`
}

// NewPagePaginationResponse creates a new pagination response from an ordered list of items.
func NewOffsetPaginationResponse[T any](items []T, page PaginationMetaPage) PagePaginationResponse[T] {
