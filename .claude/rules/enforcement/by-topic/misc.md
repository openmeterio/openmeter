# Enforcement: misc (90 rules)

Topic file. Loaded on demand when an agent works on something in the `misc` area. The pre-edit hook reads `.archie/rules.json` directly — this file is for browsing/context only.
...
*source: `deep_scan`* · *scope: `openmeter/ent/db/`* · *check: `forbidden_content`*
...
*source: `deep_scan`* · *check: `required_pattern`*
...
*source: `deep_scan`* · *scope: `api/spec/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `api/spec/`* · *check: `required_pattern`*
...
*source: `deep_scan`* · *scope: `openmeter/ent/schema/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `tools/migrate/migrations/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `app/common/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `openmeter/watermill/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `.`* · *check: `file_naming`*
...
*source: `deep_scan`* · *scope: `openmeter/billing/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `cmd/server/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `openmeter/ledger/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `openmeter/notification/`* · *check: `architectural_constraint`*
...
*source: `deep_scan`* · *scope: `api/v3/`* · *check: `architectural_constraint`*
