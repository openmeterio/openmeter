...
| -------------------------- | ------------- | -------------------------------------------------------------------------------------------------- |
| *(no annotation)*          | —             | **Stable** — default state, production-ready                                                       |
...
1. **Development** — both `x-unstable` and `x-internal` applied
2. **Stabilizing** — `x-internal` only; internal consumers may rely on the shape, but the API is not yet public
