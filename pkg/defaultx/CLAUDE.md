...
> Tiny generic utility package providing nil-safe pointer dereferencing and zero-value fallback helpers. Used across domain packages to reduce nil guard boilerplate when handling optional/pointer fields.
