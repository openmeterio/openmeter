...
func (_m *Example1) assignValues(columns []string, values []any) error {
...
func (_m *Example1) Value(name string) (ent.Value, error) {
...
func (_m *Example1) Update() *Example1UpdateOne {
	return NewExample1Client(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the Example1 entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *Example1) Unwrap() *Example1 {
...
func (_m *Example1) String() string {
	...
	builder.WriteString(_m.ExampleValue1)
	builder.WriteByte(')')
