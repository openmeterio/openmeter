...
// The Example1Func type is an adapter to allow the use of ordinary
// function as Example1 mutator.
type Example1Func func(context.Context, *db.Example1Mutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f Example1Func) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.Example1Mutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *db.Example1Mutation", m)
}
